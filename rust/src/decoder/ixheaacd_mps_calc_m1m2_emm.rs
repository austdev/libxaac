extern "C" {
    ...
    fn ixheaacd_get_matrix_inversion_weights(
        iid_lf_ls_idx: WORD32,
        iid_rf_rs_idx: WORD32,
        prediction_mode: WORD32,
        c1: WORD32,
        c2: WORD32,
        weight1: *mut WORD32,
        weight2: *mut WORD32,
    ...
    fn ixheaacd_invert_matrix(
        weight1: WORD32,
        weight2: WORD32,
        h_real: *mut [WORD32; 2],
        h_imag: *mut [WORD32; 2],
        common_tab_ptr: *const ia_mps_dec_common_tables_struct,
    ) -> VOID;
}
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_calc_m1m2_emm(
    ...
    let mut dummy1: *mut WORD32 = 0 as *mut WORD32;
    let mut dummy2: *mut WORD32 = 0 as *mut WORD32;
    let mut dummy3: *mut WORD16 = 0 as *mut WORD16;
    let mut dummy4: *mut WORD16 = 0 as *mut WORD16;
    h11 = (*pstr_mps_state).mps_scratch_mem_v as *mut WORD32;
    h12 = h11
        .offset(
            ((28 as usize)
    ...
    dummy3 = ((*pstr_mps_state).mps_scratch_mem_v as *mut WORD16)
        .offset(
            ((336 as usize)
    ...
    while ps < (*pstr_mps_state).num_parameter_sets {
        ...
        while pb < (*pstr_mps_state).num_parameter_bands {
            let mut m11: WORD32 = (*p_aux_struct)
                .ttt_cpc_1[0 as core::ffi::c_int as usize][ps as usize][pb as usize]
                + ONE_IN_Q16;
            let mut m12: WORD32 = (*p_aux_struct)
                .ttt_cpc_2[0 as core::ffi::c_int as usize][ps as usize][pb as usize]
                - ONE_IN_Q15;
            let mut m21: WORD32 = (*p_aux_struct)
                .ttt_cpc_1[0 as core::ffi::c_int as usize][ps as usize][pb as usize]
                - ONE_IN_Q15;
            let mut m22: WORD32 = (*p_aux_struct)
                .ttt_cpc_2[0 as core::ffi::c_int as usize][ps as usize][pb as usize]
                + ONE_IN_Q16;
            let mut m31: WORD32 = ONE_IN_Q15
                - (*p_aux_struct)
                    .ttt_cpc_1[0 as core::ffi::c_int as usize][ps as usize][pb as usize];
            let mut m32: WORD32 = ONE_IN_Q15
                - (*p_aux_struct)
                    .ttt_cpc_2[0 as core::ffi::c_int as usize][ps as usize][pb as usize];
            ...
            (*pstr_mps_state).m1_param_imag_present = 1 as core::ffi::c_int as WORD32;
            acc = h_real[0 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
                as WORD64 * m11 as WORD64
                + h_real[1 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
                    as WORD64 * m12 as WORD64;
            acc >>= 15 as core::ffi::c_int;
            (*m1_param)
                .m1_param_real[0 as core::ffi::c_int
                as usize][0 as core::ffi::c_int as usize][ps as usize][pb as usize] = acc
                as WORD32;
            acc = h_real[0 as core::ffi::c_int as usize][1 as core::ffi::c_int as usize]
                as WORD64 * m11 as WORD64
                + h_real[1 as core::ffi::c_int as usize][1 as core::ffi::c_int as usize]
                    as WORD64 * m12 as WORD64;
            acc >>= 15 as core::ffi::c_int;
            (*m1_param)
                .m1_param_real[0 as core::ffi::c_int
                as usize][1 as core::ffi::c_int as usize][ps as usize][pb as usize] = acc
                as WORD32;
            acc = h_imag[0 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
                as WORD64 * m11 as WORD64
                + h_imag[1 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
                    as WORD64 * m12 as WORD64;
            acc >>= 15 as core::ffi::c_int;
            (*m1_param)
                ...
                as usize][0 as core::ffi::c_int as usize][ps as usize][pb as usize] = acc
                as WORD32;
            acc = h_imag[0 as core::ffi::c_int as usize][1 as core::ffi::c_int as usize]
                as WORD64 * m11 as WORD64
                + h_imag[1 as core::ffi::c_int as usize][1 as core::ffi::c_int as usize]
                    as WORD64 * m12 as WORD64;
            acc >>= 15 as core::ffi::c_int;
            (*m1_param)
                .m1_param_imag[0 as core::ffi::c_int
                ...
                as WORD32;
            acc = h_real[0 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
                as WORD64 * m21 as WORD64
                + h_real[1 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
                    as WORD64 * m22 as WORD64;
            acc >>= 15 as core::ffi::c_int;
            (*m1_param)
            ...
            (*m1_param)
                ...
                as WORD32;
            acc = h_real[0 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
                as WORD64 * m31 as WORD64
                + h_real[1 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
                    as WORD64 * m32 as WORD64;
            acc >>= 15 as core::ffi::c_int;
            (*m1_param)
            ...
            (*m1_param)
                .m1_param_real[2 as core::ffi::c_int
                as usize][2 as core::ffi::c_int as usize][ps as usize][pb as usize] = -(32768
                as core::ffi::c_int) as WORD32;
            (*m1_param)
                .m1_param_imag[0 as core::ffi::c_int
                as usize][2 as core::ffi::c_int as usize][ps as usize][pb as usize] = 0
                as core::ffi::c_int as WORD32;
            (*m1_param)
                .m1_param_imag[1 as core::ffi::c_int
                as usize][2 as core::ffi::c_int as usize][ps as usize][pb as usize] = 0
        ...
        while pb < (*pstr_mps_state).num_parameter_bands {
            (*m2_param)
                ...
                as usize][ps as usize][pb as usize] = *h12.offset(pb as isize);
            (*m2_param)
                .m2_decor_real[1 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h22.offset(pb as isize);
            (*m2_param)
        ...
        while pb < (*pstr_mps_state).num_parameter_bands {
            (*m2_param)
                ...
                as usize][ps as usize][pb as usize] = *h11.offset(pb as isize);
            (*m2_param)
                .m2_resid_real[1 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h21.offset(pb as isize);
            (*m2_param)
                .m2_resid_real[2 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h21.offset(pb as isize);
            (*m2_param)
                .m2_resid_real[3 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = 32768 as core::ffi::c_int
                as WORD32;
            pb += 1;
        }
        ps += 1;
