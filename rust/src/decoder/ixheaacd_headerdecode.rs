extern "C" {
    ...
    fn ixheaacd_conf_default(pstr_usac_conf: *mut ia_usac_config_struct) -> VOID;
    fn ixheaacd_config(
        bit_buff: *mut ia_bit_buf_struct,
        pstr_usac_conf: *mut ia_usac_config_struct,
        chan: *mut UINT32,
        ec_flag: WORD32,
    ) -> WORD32;
    fn ixheaacd_adts_crc_open(ptr_adts_crc_info: *mut ia_adts_crc_info_struct) -> VOID;
    ...
    fn ixheaacd_mps_create(
        self_0: *mut ia_mps_dec_state_struct,
        bs_frame_len: WORD32,
        residual_coding: WORD32,
        usac_mps_config: *mut ia_usac_dec_mps_config_struct,
    ) -> WORD32;
    fn memset(
    ...
    fn ixheaacd_ld_spatial_specific_config(
        config: *mut ia_usac_dec_mps_config_struct,
        it_bit_buff: *mut ia_bit_buf_struct,
    ) -> IA_ERRORCODE;
    static ixheaacd_sampl_freq_idx_table: [WORD32; 17];
}
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ia_adif_header_struct {
    pub bit_stream_type: WORD32,
    pub prog_config_present: WORD32,
    pub str_prog_config: ia_program_config_struct,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const CRC_ADTS_HEADER_LEN: core::ffi::c_int = 56 as core::ffi::c_int;
pub const ER_OBJECT_START: core::ffi::c_int = 17 as core::ffi::c_int;
pub const FRAME_SIZE: core::ffi::c_int = 1024 as core::ffi::c_int;
pub const FRAME_SIZE_SMALL: core::ffi::c_int = 960 as core::ffi::c_int;
...
pub const IA_XHEAAC_DEC_INIT_FATAL_STREAM_CHAN_GT_MAX: core::ffi::c_uint = 0xffff9002
    as core::ffi::c_uint;
pub const IA_XHEAAC_DEC_INIT_FATAL_AUDIOOBJECTTYPE_NOT_SUPPORTED: core::ffi::c_uint = 0xffff9003
    as core::ffi::c_uint;
...
pub const IA_ENHAACPLUS_DEC_INP_BUF_SIZE: core::ffi::c_int = 6144 as core::ffi::c_int
    / 8 as core::ffi::c_int;
pub const ELDEXT_SAOC: core::ffi::c_int = 1;
pub const ELDEXT_TERM: core::ffi::c_int = 0 as core::ffi::c_int;
pub const ELDEXT_LDSAC: core::ffi::c_int = 2;
pub const AAC_LC_PROFILE: core::ffi::c_int = 2 as core::ffi::c_int;
pub const ADTS_HEADER_LENGTH: core::ffi::c_int = 7 as core::ffi::c_int;
#[inline]
unsafe extern "C" fn ixheaacd_aac_bytealign(
    mut it_bit_buff: *mut ia_bit_buf_struct,
) -> VOID {
    let mut num_bit: WORD16 = 0;
    num_bit = ((*it_bit_buff).bit_pos as core::ffi::c_int + 1 as core::ffi::c_int)
        as WORD16;
    if num_bit as core::ffi::c_int != 8 as core::ffi::c_int {
        (*it_bit_buff).bit_pos = 7 as core::ffi::c_int as WORD32;
        (*it_bit_buff).cnt_bits -= num_bit as core::ffi::c_int;
        (*it_bit_buff).ptr_read_next = ((*it_bit_buff).ptr_read_next)
            .offset(1 as core::ffi::c_int as isize);
    }
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_read_pce_channel_info(
    mut ch: WORD32,
    mut ptr_is_cpe: *mut WORD8,
    mut ptr_tag_select: *mut WORD8,
    mut it_bit_buff: *mut ia_bit_buf_struct,
) -> WORD32 {
    let mut num_ch: WORD32 = 0 as WORD32;
    let mut i: WORD32 = 0;
    let mut tmp: WORD32 = 0;
    i = 0 as core::ffi::c_int as WORD32;
    while i < ch {
        tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 5 as WORD);
        *ptr_is_cpe.offset(i as isize) = ((tmp as core::ffi::c_int
            & 0x10 as core::ffi::c_int) >> 4 as core::ffi::c_int) as WORD8;
        if *ptr_is_cpe.offset(i as isize) != 0 {
            num_ch += 2 as core::ffi::c_int;
        } else {
            num_ch += 1;
        }
        *ptr_tag_select.offset(i as isize) = (tmp as core::ffi::c_int
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_read_pce_mixdown_data(
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut mix_down_present: WORD32,
    mut mix_down_element_no: WORD32,
) -> VOID {
    let mut mix_down_flag: WORD32 = ixheaacd_read_bits_buf(
        it_bit_buff as *mut ia_bit_buf_struct,
        mix_down_present as WORD,
    );
    if mix_down_flag == 1 as core::ffi::c_int {
        ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            mix_down_element_no as WORD,
        );
    }
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_skip_bits(
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut bits: WORD32,
    mut num_element: WORD32,
) -> VOID {
    let mut i: WORD32 = 0;
    i = 0 as core::ffi::c_int as WORD32;
    while i < num_element {
        ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, bits as WORD);
        i += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_read_prog_config_element(
    mut ptr_config_element: *mut ia_program_config_struct,
    mut it_bit_buff: *mut ia_bit_buf_struct,
) -> WORD32 {
    let mut i: WORD32 = 0;
    let mut tmp: WORD32 = 0;
    let mut count: WORD = 0 as WORD;
    let mut num_ch: WORD = 0 as WORD;
    tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 6 as WORD);
    (*ptr_config_element).element_instance_tag = (tmp >> 2 as core::ffi::c_int) as WORD8;
    (*ptr_config_element).object_type = (tmp as core::ffi::c_int
        & 0x3 as core::ffi::c_int) as WORD32;
    if (*ptr_config_element).object_type as core::ffi::c_int + 1 as core::ffi::c_int
        != 2 as core::ffi::c_int
        && (*ptr_config_element).object_type as core::ffi::c_int + 1 as core::ffi::c_int
            != 4 as core::ffi::c_int
    {
        return IA_XHEAAC_DEC_INIT_FATAL_DEC_INIT_FAIL as WORD32;
    }
    (*ptr_config_element).samp_freq_index = ixheaacd_read_bits_buf(
        it_bit_buff as *mut ia_bit_buf_struct,
        4 as WORD,
    );
    if (*ptr_config_element).samp_freq_index > 11 as core::ffi::c_int {
        return IA_XHEAAC_DEC_EXE_NONFATAL_DECODE_FRAME_ERROR;
    }
    tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 21 as WORD);
    (*ptr_config_element).num_front_channel_elements = tmp >> 17 as core::ffi::c_int;
    count += (*ptr_config_element).num_front_channel_elements as core::ffi::c_int;
    (*ptr_config_element).num_side_channel_elements = ((tmp as core::ffi::c_int
        & 0x1e000 as core::ffi::c_int) >> 13 as core::ffi::c_int) as WORD32;
    count += (*ptr_config_element).num_side_channel_elements as core::ffi::c_int;
    (*ptr_config_element).num_back_channel_elements = ((tmp as core::ffi::c_int
        & 0x1e00 as core::ffi::c_int) >> 9 as core::ffi::c_int) as WORD32;
    count += (*ptr_config_element).num_back_channel_elements as core::ffi::c_int;
    (*ptr_config_element).num_lfe_channel_elements = ((tmp as core::ffi::c_int
        & 0x180 as core::ffi::c_int) >> 7 as core::ffi::c_int) as WORD32;
    count += (*ptr_config_element).num_lfe_channel_elements as core::ffi::c_int;
    (*ptr_config_element).num_assoc_data_elements = ((tmp as core::ffi::c_int
        & 0x70 as core::ffi::c_int) >> 4 as core::ffi::c_int) as WORD32;
    (*ptr_config_element).num_valid_cc_elements = (tmp as core::ffi::c_int
        & 0xf as core::ffi::c_int) as WORD32;
    count += (*ptr_config_element).num_valid_cc_elements as core::ffi::c_int;
    if count > MAX_BS_ELEMENT {
        return IA_XHEAAC_DEC_INIT_FATAL_STREAM_CHAN_GT_MAX as WORD32;
    }
    ixheaacd_read_pce_mixdown_data(it_bit_buff, 1 as WORD32, 4 as WORD32);
    ixheaacd_read_pce_mixdown_data(it_bit_buff, 1 as WORD32, 4 as WORD32);
    ixheaacd_read_pce_mixdown_data(it_bit_buff, 1 as WORD32, 3 as WORD32);
    num_ch
        += ixheaacd_read_pce_channel_info(
            (*ptr_config_element).num_front_channel_elements,
            ((*ptr_config_element).front_element_is_cpe).as_mut_ptr(),
            ((*ptr_config_element).front_element_tag_select).as_mut_ptr(),
            it_bit_buff,
        ) as core::ffi::c_int;
    num_ch
        += ixheaacd_read_pce_channel_info(
            (*ptr_config_element).num_side_channel_elements,
            ((*ptr_config_element).side_element_is_cpe).as_mut_ptr(),
            ((*ptr_config_element).side_element_tag_select).as_mut_ptr(),
            it_bit_buff,
        ) as core::ffi::c_int;
    num_ch
        += ixheaacd_read_pce_channel_info(
            (*ptr_config_element).num_back_channel_elements,
            ((*ptr_config_element).back_element_is_cpe).as_mut_ptr(),
            ((*ptr_config_element).back_element_tag_select).as_mut_ptr(),
            it_bit_buff,
        ) as core::ffi::c_int;
    num_ch += (*ptr_config_element).num_lfe_channel_elements as core::ffi::c_int;
    i = 0 as core::ffi::c_int as WORD32;
    while i < (*ptr_config_element).num_lfe_channel_elements {
        (*ptr_config_element).lfe_element_tag_select[i as usize] = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            4 as WORD,
        ) as WORD8;
        i += 1;
    }
    (*ptr_config_element).channels = num_ch as WORD32;
    i = 0 as core::ffi::c_int as WORD32;
    while i < (*ptr_config_element).num_assoc_data_elements {
        ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 4 as WORD);
        i += 1;
    }
    ixheaacd_skip_bits(
        it_bit_buff,
        5 as WORD32,
        (*ptr_config_element).num_valid_cc_elements,
    );
    let mut bits_to_read: WORD32 = (*ptr_config_element).alignment_bits;
    if bits_to_read <= (*it_bit_buff).bit_pos {
        bits_to_read = (*it_bit_buff).bit_pos - bits_to_read;
    } else {
        bits_to_read = 8 as WORD32 - bits_to_read + (*it_bit_buff).bit_pos;
    }
    tmp = ixheaacd_read_bits_buf(
        it_bit_buff as *mut ia_bit_buf_struct,
        bits_to_read as WORD,
    );
    tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 8 as WORD);
    ixheaacd_skip_bits(it_bit_buff, 8 as WORD32, tmp);
    return 0 as WORD32;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_decode_pce(
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut ui_pce_found_in_hdr: *mut UWORD32,
    mut ptr_prog_config: *mut ia_program_config_struct,
) -> WORD {
    let mut error_code: WORD32 = 0 as WORD32;
    if *ui_pce_found_in_hdr == 1 as UWORD32 || *ui_pce_found_in_hdr == 3 as UWORD32 {
        let mut ptr_config_element: ia_program_config_struct = {
            let mut init = ia_program_config_struct {
                element_instance_tag: 0 as WORD8,
                object_type: 0,
                samp_freq_index: 0,
                ...
                front_element_is_cpe: [0; 16],
                front_element_tag_select: [0; 16],
                side_element_is_cpe: [0; 16],
                side_element_tag_select: [0; 16],
                back_element_is_cpe: [0; 16],
                back_element_tag_select: [0; 16],
                lfe_element_tag_select: [0; 16],
                channels: 0,
                alignment_bits: 0,
            };
            init
        ...
        error_code = ixheaacd_read_prog_config_element(
            &mut ptr_config_element,
            it_bit_buff,
        );
        *ui_pce_found_in_hdr = 3 as UWORD32;
    } else {
        error_code = ixheaacd_read_prog_config_element(ptr_prog_config, it_bit_buff);
        *ui_pce_found_in_hdr = 2 as UWORD32;
    }
    return error_code as WORD;
}
#[inline]
unsafe extern "C" fn ixheaacd_get_adif_header(
    mut adif: *mut ia_adif_header_struct,
    mut it_bit_buff: *mut ia_bit_buf_struct,
) -> WORD32 {
    let mut i: WORD32 = 0;
    let mut ret_val: WORD32 = 0 as WORD32;
    let mut tmp: WORD32 = 0;
    ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 16 as WORD);
    tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 17 as WORD);
    if tmp as core::ffi::c_int & 0x1 as core::ffi::c_int != 0 {
        ixheaacd_skip_bits(it_bit_buff, 8 as WORD32, 9 as WORD32);
    }
    tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 3 as WORD);
    (*adif).bit_stream_type = (tmp as core::ffi::c_int & 0x1 as core::ffi::c_int)
        as WORD32;
    ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 23 as WORD);
    tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 4 as WORD);
    i = 0 as core::ffi::c_int as WORD32;
    while i <= tmp {
        if (*adif).bit_stream_type == 0 as core::ffi::c_int {
            ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 20 as WORD);
        }
        (*adif).prog_config_present = 1 as core::ffi::c_int as WORD32;
        (*adif).str_prog_config.alignment_bits = 7 as core::ffi::c_int as WORD32;
        ret_val = ixheaacd_read_prog_config_element(
            &mut (*adif).str_prog_config,
            it_bit_buff,
        );
        if ret_val != 0 {
            return ret_val;
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_find_syncword(
    mut adts: *mut ia_adts_header_struct,
    mut it_bit_buff: *mut ia_bit_buf_struct,
) -> WORD32 {
    (*adts).sync_word = ixheaacd_read_bits_buf(
        it_bit_buff as *mut ia_bit_buf_struct,
        12 as WORD,
    ) as WORD16;
    if (*adts).sync_word as core::ffi::c_int == 0xfff as core::ffi::c_int {
        return 0 as WORD32;
    }
    loop {
        ixheaacd_read_bidirection(it_bit_buff as *mut ia_bit_buf_struct, -(4 as WORD32));
        if (*it_bit_buff).cnt_bits < 12 as core::ffi::c_int {
            return IA_XHEAAC_DEC_INIT_FATAL_DEC_INIT_FAIL as WORD32;
        }
        (*adts).sync_word = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_adtsframe(
    mut adts: *mut ia_adts_header_struct,
    mut it_bit_buff: *mut ia_bit_buf_struct,
) -> WORD32 {
    let mut tmp: WORD32 = 0;
    let mut err: IA_ERRORCODE = IA_NO_ERROR;
    let mut crc_reg: WORD32 = 0;
    let mut ptr_adts_crc_info: *mut ia_adts_crc_info_struct = (*it_bit_buff)
        .pstr_adts_crc_info;
    (*ptr_adts_crc_info).crc_active = 1 as UWORD8;
    (*ptr_adts_crc_info).no_reg = 0 as UWORD16;
    ixheaacd_read_bidirection(it_bit_buff as *mut ia_bit_buf_struct, -(12 as WORD32));
    crc_reg = ixheaacd_adts_crc_start_reg(
        ptr_adts_crc_info,
        it_bit_buff as *mut ia_bit_buf_struct,
        CRC_ADTS_HEADER_LEN,
    );
    err = ixheaacd_find_syncword(adts, it_bit_buff) as IA_ERRORCODE;
    if err != 0 {
        return err as WORD32;
    }
    tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 10 as WORD);
    (*adts).id = ((tmp as core::ffi::c_int & 0x200 as core::ffi::c_int)
        >> 9 as core::ffi::c_int) as WORD32;
    (*adts).layer = ((tmp as core::ffi::c_int & 0x180 as core::ffi::c_int)
        >> 7 as core::ffi::c_int) as WORD32;
    (*adts).protection_absent = ((tmp as core::ffi::c_int & 0x40 as core::ffi::c_int)
        >> 6 as core::ffi::c_int) as WORD32;
    (*adts).profile = ((tmp as core::ffi::c_int & 0x30 as core::ffi::c_int)
        >> 4 as core::ffi::c_int) as WORD32;
    (*adts).profile += 1;
    (*adts).samp_freq_index = (tmp as core::ffi::c_int & 0xf as core::ffi::c_int)
        as WORD32;
    if (*adts).profile != AAC_LC_PROFILE
        || (*adts).samp_freq_index > 11 as core::ffi::c_int
    {
        return IA_XHEAAC_DEC_INIT_FATAL_DEC_INIT_FAIL as WORD32;
    }
    tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 21 as WORD);
    (*adts).channel_configuration = (tmp as core::ffi::c_int
        & 0xe0000 as core::ffi::c_int) >> 17 as core::ffi::c_int;
    (*adts).aac_frame_length = (tmp as core::ffi::c_int & 0x1fff as core::ffi::c_int)
        as WORD16;
    tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 13 as WORD);
    (*adts).no_raw_data_blocks = (tmp as core::ffi::c_int & 0x3 as core::ffi::c_int)
        as WORD32;
    ...
    if (*adts).protection_absent == 0 as core::ffi::c_int {
        ixheaacd_skip_bits(it_bit_buff, 16 as WORD32, (*adts).no_raw_data_blocks);
        (*adts).crc_check = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            16 as WORD,
        );
        (*ptr_adts_crc_info).crc_active = 1 as UWORD8;
        (*ptr_adts_crc_info).file_value = (*adts).crc_check as UWORD16;
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_get_samp_rate(
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut pstr_samp_rate_info: *mut ia_sampling_rate_info_struct,
    mut pstr_audio_specific_config: *mut ia_audio_specific_config_struct,
) -> WORD32 {
    let mut index: WORD32 = 0;
    let mut sampling_rate: WORD32 = 0;
    index = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 4 as WORD);
    (*pstr_audio_specific_config).samp_frequency_index = index as UINT32;
    if index == 0xf as core::ffi::c_int {
        sampling_rate = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            24 as WORD,
        );
        if (*pstr_audio_specific_config).audio_object_type
            != AOT_USAC as core::ffi::c_int as UINT32
        {
            if sampling_rate < 9391 as core::ffi::c_int {
                sampling_rate = 8000 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 9391 as core::ffi::c_int
                && sampling_rate < 11502 as core::ffi::c_int
            {
                sampling_rate = 11025 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 11502 as core::ffi::c_int
                && sampling_rate < 13856 as core::ffi::c_int
            {
                sampling_rate = 12000 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 13856 as core::ffi::c_int
                && sampling_rate < 18783 as core::ffi::c_int
            {
                sampling_rate = 16000 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 18783 as core::ffi::c_int
                && sampling_rate < 23004 as core::ffi::c_int
            {
                sampling_rate = 22050 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 23004 as core::ffi::c_int
                && sampling_rate < 27713 as core::ffi::c_int
            {
                sampling_rate = 24000 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 27713 as core::ffi::c_int
                && sampling_rate < 37566 as core::ffi::c_int
            {
                sampling_rate = 32000 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 37566 as core::ffi::c_int
                && sampling_rate < 46009 as core::ffi::c_int
            {
                sampling_rate = 44100 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 46009 as core::ffi::c_int
                && sampling_rate < 55426 as core::ffi::c_int
            {
                sampling_rate = 48000 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 55426 as core::ffi::c_int
                && sampling_rate < 75132 as core::ffi::c_int
            {
                sampling_rate = 64000 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 75132 as core::ffi::c_int
                && sampling_rate < 92017 as core::ffi::c_int
            {
                sampling_rate = 88200 as core::ffi::c_int as WORD32;
            } else if sampling_rate >= 92017 as core::ffi::c_int {
                sampling_rate = 96000 as core::ffi::c_int as WORD32;
            }
        }
        return sampling_rate;
    } else if index > 12 as core::ffi::c_int && index < 15 as core::ffi::c_int {
        return -(1 as WORD32)
    } else {
        return (*pstr_samp_rate_info.offset(index as isize)).sampling_frequency
    };
}
unsafe extern "C" fn ixheaacd_get_ld_sbr_header(
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut sbr_header_data: *mut ia_sbr_header_data_struct,
) -> core::ffi::c_int {
    let mut header_extra_1: WORD32 = 0;
    let mut header_extra_2: WORD32 = 0;
    let mut tmp: UWORD32 = 0;
    let mut bit_cnt: UWORD32 = 0 as UWORD32;
    tmp = ixheaacd_read_bits_buf(it_bit_buff, 16 as WORD) as UWORD32;
    bit_cnt = bit_cnt.wrapping_add(16 as UWORD32);
    (*sbr_header_data).amp_res = ((tmp & 0x8000 as UWORD32) >> 15 as core::ffi::c_int)
        as WORD16;
    (*sbr_header_data).start_freq = ((tmp & 0x7800 as UWORD32) >> 11 as core::ffi::c_int)
        as WORD16;
    (*sbr_header_data).stop_freq = ((tmp & 0x780 as UWORD32) >> 7 as core::ffi::c_int)
        as WORD16;
    (*sbr_header_data).xover_band = ((tmp & 0x70 as UWORD32) >> 4 as core::ffi::c_int)
        as WORD16;
    header_extra_1 = ((tmp & 0x2 as UWORD32) >> 1 as core::ffi::c_int) as WORD32;
    header_extra_2 = (tmp & 0x1 as UWORD32) as WORD32;
    if header_extra_1 != 0 {
        (*sbr_header_data).freq_scale = ixheaacd_read_bits_buf(it_bit_buff, 2 as WORD)
            as WORD16;
        (*sbr_header_data).alter_scale = ixheaacd_read_bits_buf(it_bit_buff, 1 as WORD)
            as WORD16;
        (*sbr_header_data).noise_bands = ixheaacd_read_bits_buf(it_bit_buff, 2 as WORD)
            as WORD16;
    } else {
        (*sbr_header_data).freq_scale = 2 as WORD16;
        (*sbr_header_data).alter_scale = 1 as WORD16;
        (*sbr_header_data).noise_bands = 2 as WORD16;
    }
    if header_extra_2 != 0 {
        (*sbr_header_data).limiter_bands = ixheaacd_read_bits_buf(it_bit_buff, 2 as WORD)
            as WORD16;
        (*sbr_header_data).limiter_gains = ixheaacd_read_bits_buf(it_bit_buff, 2 as WORD)
            as WORD16;
        (*sbr_header_data).interpol_freq = ixheaacd_read_bits_buf(it_bit_buff, 1 as WORD)
            as WORD16;
        (*sbr_header_data).smoothing_mode = ixheaacd_read_bits_buf(
            it_bit_buff,
            1 as WORD,
        ) as WORD16;
    } else {
        (*sbr_header_data).limiter_bands = 2 as WORD16;
        (*sbr_header_data).limiter_gains = 2 as WORD16;
        (*sbr_header_data).interpol_freq = 1 as WORD16;
        (*sbr_header_data).smoothing_mode = 1 as WORD16;
    }
    return bit_cnt as core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_eld_sbr_header(
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut channels: WORD32,
    mut pstr_sbr_config: *mut ia_sbr_header_data_struct,
) -> WORD32 {
    let mut num_sbr_header: core::ffi::c_int = 0;
    let mut el: core::ffi::c_int = 0;
    let mut bit_cnt: core::ffi::c_int = 0 as core::ffi::c_int;
    match channels {
        1 | 2 => {
            num_sbr_header = 1 as core::ffi::c_int;
        }
        3 => {
            num_sbr_header = 2 as core::ffi::c_int;
        }
        4 | 5 | 6 => {
            num_sbr_header = 3 as core::ffi::c_int;
        }
        7 => {
            num_sbr_header = 4 as core::ffi::c_int;
        }
        _ => {
            num_sbr_header = 0 as core::ffi::c_int;
        }
    }
    el = 0 as core::ffi::c_int;
    while el < num_sbr_header {
        bit_cnt = ixheaacd_get_ld_sbr_header(it_bit_buff, pstr_sbr_config);
        el += 1;
    }
    return bit_cnt as WORD32;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_ga_hdr_dec(
    mut aac_state_struct: *mut ia_aac_dec_state_struct,
    mut header_len: WORD32,
    mut bytes_consumed: *mut WORD32,
    mut pstr_samp_rate_info: *mut ia_sampling_rate_info_struct,
    mut it_bit_buff: *mut ia_bit_buf_struct,
) -> WORD32 {
    let mut tmp: WORD32 = 0;
    let mut cnt_bits: WORD32 = (*it_bit_buff).cnt_bits;
    let mut aot_init: UWORD32 = 0;
    let mut tmp_aot: UWORD32 = 0;
    let mut pstr_audio_specific_config: *mut ia_audio_specific_config_struct = 0
        as *mut ia_audio_specific_config_struct;
    memset(
        (*aac_state_struct).ia_audio_specific_config as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ::core::mem::size_of::<ia_audio_specific_config_struct>() as size_t,
    );
    memset(
        &mut (*aac_state_struct).eld_specific_config
    ...
    pstr_audio_specific_config = (*aac_state_struct).ia_audio_specific_config
        as *mut ia_audio_specific_config_struct;
    (*(*aac_state_struct).p_config).str_prog_config.alignment_bits = (*it_bit_buff)
        .bit_pos;
    aot_init = (*aac_state_struct).audio_object_type as UWORD32;
    (*aac_state_struct).frame_length = FRAME_SIZE as WORD32;
    tmp_aot = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 5 as WORD)
        as UWORD32;
    if tmp_aot == 31 as UWORD32 {
        tmp = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 6 as WORD);
        tmp_aot = (32 as WORD32 + tmp) as UWORD32;
    }
    if (*aac_state_struct).header_dec_done != 0 || (*aac_state_struct).ui_init_done != 0
    {
        if tmp_aot != aot_init && tmp_aot != AOT_SBR as core::ffi::c_int as UWORD32
            && tmp_aot != AOT_PS as core::ffi::c_int as UWORD32
        {
            return IA_FATAL_ERROR as WORD32;
        }
    }
    (*aac_state_struct).audio_object_type = tmp_aot as AUDIO_OBJECT_TYPE;
    (*pstr_audio_specific_config).audio_object_type = (*aac_state_struct)
        .audio_object_type as UINT32;
    tmp = ixheaacd_get_samp_rate(
        it_bit_buff,
        pstr_samp_rate_info,
        pstr_audio_specific_config,
    );
    (*pstr_audio_specific_config).sampling_frequency = tmp as UINT32;
    if tmp == -(1 as core::ffi::c_int) {
        *bytes_consumed = 1 as core::ffi::c_int as WORD32;
        return IA_XHEAAC_DEC_INIT_FATAL_DEC_INIT_FAIL as WORD32;
    } else {
        (*aac_state_struct).sampling_rate = tmp as UWORD32;
    }
    (*(*aac_state_struct).p_config).ui_samp_freq = tmp as UWORD32;
    (*aac_state_struct).ch_config = ixheaacd_read_bits_buf(
        it_bit_buff as *mut ia_bit_buf_struct,
        4 as WORD,
    ) as UWORD32;
    if (*aac_state_struct).audio_object_type as core::ffi::c_uint
        == AOT_USAC as core::ffi::c_int as core::ffi::c_uint
        && ((*aac_state_struct).ch_config >= 3 as UWORD32
            && (*aac_state_struct).ch_config != 8 as UWORD32)
    {
        return IA_XHEAAC_DEC_INIT_FATAL_DEC_INIT_FAIL as WORD32;
    }
    (*pstr_audio_specific_config).channel_configuration = (*aac_state_struct).ch_config
        as UINT32;
    if (*aac_state_struct).audio_object_type as core::ffi::c_uint
        == AOT_SBR as core::ffi::c_int as core::ffi::c_uint
        || (*aac_state_struct).audio_object_type as core::ffi::c_uint
            == AOT_PS as core::ffi::c_int as core::ffi::c_uint
    {
        ...
        (*aac_state_struct).sbr_present_flag = 1 as core::ffi::c_int as WORD32;
        if tmp == -(1 as core::ffi::c_int) {
            *bytes_consumed = 1 as core::ffi::c_int as WORD32;
            return IA_XHEAAC_DEC_INIT_FATAL_DEC_INIT_FAIL as WORD32;
        } else {
            (*aac_state_struct).extension_samp_rate = tmp as UWORD32;
        }
        (*aac_state_struct).audio_object_type = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            5 as WORD,
        ) as AUDIO_OBJECT_TYPE;
    }
    if (*aac_state_struct).header_dec_done != 0 || (*aac_state_struct).ui_init_done != 0
    {
        if (*aac_state_struct).audio_object_type as core::ffi::c_uint != aot_init {
            return IA_FATAL_ERROR as WORD32;
        }
    }
    if ((*aac_state_struct).audio_object_type as core::ffi::c_uint
        >= AOT_AAC_MAIN as core::ffi::c_int as core::ffi::c_uint
        && (*aac_state_struct).audio_object_type as core::ffi::c_uint
            <= AOT_AAC_LTP as core::ffi::c_int as core::ffi::c_uint
        || (*aac_state_struct).audio_object_type as core::ffi::c_uint
            == AOT_AAC_SCAL as core::ffi::c_int as core::ffi::c_uint
        || (*aac_state_struct).audio_object_type as core::ffi::c_uint
            == AOT_TWIN_VQ as core::ffi::c_int as core::ffi::c_uint
        || (*aac_state_struct).audio_object_type as core::ffi::c_uint
            == AOT_ER_AAC_LD as core::ffi::c_int as core::ffi::c_uint
        || (*aac_state_struct).audio_object_type as core::ffi::c_uint
            == AOT_ER_AAC_ELD as core::ffi::c_int as core::ffi::c_uint
        || (*aac_state_struct).audio_object_type as core::ffi::c_uint
            == AOT_ER_AAC_SCAL as core::ffi::c_int as core::ffi::c_uint
        || (*aac_state_struct).audio_object_type as core::ffi::c_uint
            == AOT_ER_AAC_LC as core::ffi::c_int as core::ffi::c_uint)
        && (*aac_state_struct).audio_object_type as core::ffi::c_uint
            != AOT_USAC as core::ffi::c_int as core::ffi::c_uint
    {
        (*aac_state_struct).usac_flag = 0 as core::ffi::c_int as FLAG;
        (*aac_state_struct).frame_len_flag = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            1 as WORD,
        );
        if (*aac_state_struct).audio_object_type as core::ffi::c_uint
            != AOT_ER_AAC_ELD as core::ffi::c_int as core::ffi::c_uint
        {
            (*aac_state_struct).depends_on_core_coder = ixheaacd_read_bits_buf(
                it_bit_buff as *mut ia_bit_buf_struct,
                1 as WORD,
            );
            (*aac_state_struct).extension_flag = ixheaacd_read_bits_buf(
                it_bit_buff as *mut ia_bit_buf_struct,
                1 as WORD,
            );
            if (*aac_state_struct).ch_config == 0 as UWORD32 {
                let mut error_code: WORD32 = 0;
                error_code = ixheaacd_read_prog_config_element(
                    &mut (*(*aac_state_struct).p_config).str_prog_config,
                    it_bit_buff,
                );
                ...
                (*(*aac_state_struct).p_config).ui_pce_found_in_hdr = 1 as UWORD32;
            }
        }
        if (*aac_state_struct).audio_object_type as core::ffi::c_uint
            == AOT_ER_AAC_ELD as core::ffi::c_int as core::ffi::c_uint
                ...
                == AOT_ER_AAC_SCAL as core::ffi::c_int as core::ffi::c_uint
        {
            ...
            (*aac_state_struct).eld_specific_config.aac_spect_data_resil_flag = 0
                as core::ffi::c_int as WORD32;
            (*aac_state_struct).eld_specific_config.ep_config = 0 as core::ffi::c_int
                as WORD32;
            if (*aac_state_struct).extension_flag == 1 as core::ffi::c_int
                || (*aac_state_struct).audio_object_type as core::ffi::c_uint
                    == AOT_ER_AAC_ELD as core::ffi::c_int as core::ffi::c_uint
            {
                if (*aac_state_struct).audio_object_type as core::ffi::c_uint
                ...
                {
                    (*aac_state_struct).eld_specific_config.aac_sect_data_resil_flag = ixheaacd_read_bits_buf(
                        it_bit_buff as *mut ia_bit_buf_struct,
                        1 as WORD,
                    );
                    (*aac_state_struct).eld_specific_config.aac_sf_data_resil_flag = ixheaacd_read_bits_buf(
                        it_bit_buff as *mut ia_bit_buf_struct,
                        1 as WORD,
                    );
                    (*aac_state_struct).eld_specific_config.aac_spect_data_resil_flag = ixheaacd_read_bits_buf(
                        it_bit_buff as *mut ia_bit_buf_struct,
                        1 as WORD,
                    );
                    if (*aac_state_struct).audio_object_type as core::ffi::c_uint
                        == AOT_ER_AAC_LD as core::ffi::c_int as core::ffi::c_uint
                    {
                        (*aac_state_struct).eld_specific_config.ep_config = ixheaacd_read_bits_buf(
                            it_bit_buff as *mut ia_bit_buf_struct,
                            2 as WORD,
                        );
                    }
                    if (*aac_state_struct).audio_object_type as core::ffi::c_uint
                        == AOT_ER_AAC_ELD as core::ffi::c_int as core::ffi::c_uint
                    {
                        (*aac_state_struct).eld_specific_config.ld_sbr_flag_present = ixheaacd_read_bits_buf(
                            it_bit_buff as *mut ia_bit_buf_struct,
                            1 as WORD,
                        );
                    }
    ...
    if (*pstr_audio_specific_config).audio_object_type
        == AOT_USAC as core::ffi::c_int as UINT32
    {
        (*pstr_audio_specific_config).sbr_present_flag = 0 as UINT32;
        (*pstr_audio_specific_config).ext_audio_object_type = 0 as UINT32;
        let mut tmp_0: size_t = 0xf as size_t;
        let mut i: UWORD32 = 0;
        let mut err: WORD32 = 0 as WORD32;
        (*aac_state_struct).usac_flag = 1 as core::ffi::c_int as FLAG;
        ixheaacd_conf_default(&mut (*pstr_audio_specific_config).str_usac_config);
        err = ixheaacd_config(
            it_bit_buff as *mut ia_bit_buf_struct,
            &mut (*pstr_audio_specific_config).str_usac_config,
            &mut (*pstr_audio_specific_config).channel_configuration,
            (*aac_state_struct).ec_enable,
        );
        if err != 0 as core::ffi::c_int {
            return err;
        }
        (*pstr_audio_specific_config).sampling_frequency = (*pstr_audio_specific_config)
            .str_usac_config
            .usac_sampling_frequency;
        if (*pstr_audio_specific_config).audio_object_type
            == AOT_USAC as core::ffi::c_int as UINT32
        {
            (*pstr_audio_specific_config).sbr_present_flag = 1 as UINT32;
            (*pstr_audio_specific_config).ext_audio_object_type = AOT_SBR
                as core::ffi::c_int as UINT32;
            (*pstr_audio_specific_config).ext_sampling_frequency = (*pstr_audio_specific_config)
                .sampling_frequency;
            (*pstr_audio_specific_config).ext_samp_frequency_index = (*pstr_audio_specific_config)
                .samp_frequency_index;
            i = 0 as UWORD32;
            while (i as usize)
                < (::core::mem::size_of::<[WORD32; 17]>() as usize)
                    .wrapping_div(::core::mem::size_of::<WORD32>() as usize)
            {
                if ixheaacd_sampl_freq_idx_table[i as usize]
            ...
            (*pstr_audio_specific_config).samp_frequency_index = tmp_0 as UINT32;
        } else {
            (*pstr_audio_specific_config).sbr_present_flag = 0 as UINT32;
        }
        if (*aac_state_struct).bs_format != LOAS_BSFORMAT {
            ...
            if (*it_bit_buff).ptr_read_next as size_t
                == (*it_bit_buff).ptr_bit_buf_base as size_t
            {
                *bytes_consumed = (*it_bit_buff).size >> 3 as core::ffi::c_int;
            } else {
                *bytes_consumed = ((((*it_bit_buff).ptr_read_next as size_t)
                    .wrapping_sub((*it_bit_buff).ptr_bit_buf_base as size_t)
                    << 3 as core::ffi::c_int)
                    .wrapping_add(7 as size_t)
                    .wrapping_sub((*it_bit_buff).bit_pos as size_t)
                    .wrapping_add(7 as size_t) >> 3 as core::ffi::c_int) as WORD32;
            }
        }
        return 0 as WORD32;
    }
    (*aac_state_struct).frame_length = FRAME_SIZE as WORD32;
    if (*aac_state_struct).frame_len_flag != 0 {
        (*aac_state_struct).frame_length = FRAME_SIZE_SMALL as WORD32;
    }
    if (*aac_state_struct).extension_flag != 0 {
        (*aac_state_struct).extension_flag_3 = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            1 as WORD,
        );
    }
    if (*aac_state_struct).audio_object_type as core::ffi::c_uint
        == AOT_ER_AAC_LD as core::ffi::c_int as core::ffi::c_uint
    {
        (*aac_state_struct).frame_length >>= 1 as core::ffi::c_int;
    }
    if (*aac_state_struct).audio_object_type as core::ffi::c_uint
        == AOT_ER_AAC_ELD as core::ffi::c_int as core::ffi::c_uint
    {
        (*aac_state_struct).frame_length >>= 1 as core::ffi::c_int;
        if (*aac_state_struct).eld_specific_config.ld_sbr_flag_present != 0 {
            (*aac_state_struct).eld_specific_config.ld_sbr_samp_rate = ixheaacd_read_bits_buf(
                it_bit_buff as *mut ia_bit_buf_struct,
                1 as WORD,
            );
            (*aac_state_struct).eld_specific_config.ld_sbr_crc_flag = ixheaacd_read_bits_buf(
                it_bit_buff as *mut ia_bit_buf_struct,
                1 as WORD,
            );
            ixheaacd_eld_sbr_header(
                it_bit_buff as *mut ia_bit_buf_struct,
                (*aac_state_struct).ch_config as WORD32,
                &mut (*aac_state_struct).str_sbr_config,
            );
            (*aac_state_struct).dwnsmp_signal = ((*aac_state_struct)
                .eld_specific_config
                .ld_sbr_samp_rate == 0) as core::ffi::c_int as WORD32;
        }
        let mut len: UWORD16 = 0;
        let mut eld_ext_type: UWORD16 = 0;
        let mut err_0: WORD32 = 0;
        let mut cnt: UWORD16 = 0;
        if ixheaacd_show_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 4 as WORD)
            != ELDEXT_TERM
        {
            eld_ext_type = ixheaacd_read_bits_buf(
                it_bit_buff as *mut ia_bit_buf_struct,
                4 as WORD,
            ) as UWORD16;
            if eld_ext_type as core::ffi::c_int != ELDEXT_TERM {
                len = ixheaacd_read_bits_buf(
                    it_bit_buff as *mut ia_bit_buf_struct,
                    4 as WORD,
                ) as UWORD16;
                if len as core::ffi::c_int == 15 as core::ffi::c_int {
                    len = (len as core::ffi::c_int
                        + ixheaacd_read_bits_buf(
                            it_bit_buff as *mut ia_bit_buf_struct,
                            8 as WORD,
                ...
                if len as core::ffi::c_int
                    == 15 as core::ffi::c_int + 255 as core::ffi::c_int
                {
                    len = (len as core::ffi::c_int
                        + ixheaacd_read_bits_buf(
                            it_bit_buff as *mut ia_bit_buf_struct,
                ...
                match eld_ext_type as core::ffi::c_int {
                    ELDEXT_SAOC => {}
                    ELDEXT_LDSAC => {
                        (*aac_state_struct).ldmps_present = 1 as core::ffi::c_int
                            as WORD32;
                        (*aac_state_struct)
                            .mps_dec_handle
                            .ldmps_config
                            .ldmps_present_flag = 1 as UINT32;
                        (*aac_state_struct).mps_dec_handle.object_type = (*aac_state_struct)
                            .audio_object_type as WORD32;
                        (*aac_state_struct).mps_dec_handle.ec_flag = (*aac_state_struct)
                            .ec_enable as WORD8;
                        err_0 = ixheaacd_ld_spatial_specific_config(
                            &mut (*aac_state_struct).mps_dec_handle.ldmps_config,
                            it_bit_buff as *mut ia_bit_buf_struct,
                        ) as WORD32;
                        if err_0 != 0 {
                            return err_0;
                        ...
                        if ixheaacd_mps_create(
                            &mut (*aac_state_struct).mps_dec_handle,
                            (*aac_state_struct)
                                .mps_dec_handle
                                .ldmps_config
                                .bs_frame_length as WORD32,
                            0 as WORD32,
                            &mut (*aac_state_struct).mps_dec_handle.ldmps_config,
                        ) != 0
                        {
                    ...
                    _ => {
                        cnt = 0 as UWORD16;
                        while (cnt as core::ffi::c_int) < len as core::ffi::c_int {
                            ixheaacd_read_bits_buf(
                                it_bit_buff as *mut ia_bit_buf_struct,
                                8 as WORD,
                            );
        ...
        if !((*aac_state_struct).ldmps_present == 1 as core::ffi::c_int
            && !((*it_bit_buff).cnt_bits >= 1 as core::ffi::c_int))
        {
            ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 1 as WORD);
        }
    }
    if !((*aac_state_struct).ldmps_present == 1 as core::ffi::c_int
        && !((*it_bit_buff).cnt_bits > 0 as core::ffi::c_int))
    {
        if (*aac_state_struct).audio_object_type as core::ffi::c_uint
            ...
            || (*aac_state_struct).audio_object_type as core::ffi::c_uint
                == AOT_ER_AAC_SCAL as core::ffi::c_int as core::ffi::c_uint
        {
            let mut ep_config: WORD32 = ixheaacd_read_bits_buf(
                it_bit_buff as *mut ia_bit_buf_struct,
                2 as WORD,
            );
            ep_config == 2 as core::ffi::c_int || ep_config == 3 as core::ffi::c_int;
            if ep_config == 3 as core::ffi::c_int {
                let mut direct_map: WORD32 = ixheaacd_read_bits_buf(
                    it_bit_buff as *mut ia_bit_buf_struct,
                    1 as WORD,
                );
                direct_map == 0;
        ...
        tmp = header_len * 8 as WORD32 - (*it_bit_buff).cnt_bits;
        if (*aac_state_struct).audio_object_type as core::ffi::c_uint
            != AOT_SBR as core::ffi::c_int as core::ffi::c_uint
            && (*it_bit_buff).cnt_bits >= 16 as core::ffi::c_int
        {
            ...
            if tmp == 0x2b7 as core::ffi::c_int {
                tmp = ixheaacd_read_bits_buf(
                    it_bit_buff as *mut ia_bit_buf_struct,
                    5 as WORD,
                );
                if tmp == AOT_SBR as core::ffi::c_int {
                    let mut sbr_present_flag: WORD32 = ixheaacd_read_bits_buf(
                        it_bit_buff as *mut ia_bit_buf_struct,
                        1 as WORD,
                    );
                    if sbr_present_flag != 0 {
                        ...
                        if (*it_bit_buff).cnt_bits >= 12 as core::ffi::c_int {
                            ...
                            if tmp == 0x548 as core::ffi::c_int {
                                tmp = ixheaacd_read_bits_buf(
                                    it_bit_buff as *mut ia_bit_buf_struct,
                                    1 as WORD,
                                );
    ...
    {
        *bytes_consumed = 1 as core::ffi::c_int as WORD32;
        return IA_XHEAAC_DEC_INIT_FATAL_AUDIOOBJECTTYPE_NOT_SUPPORTED as WORD32;
    } else {
        if (*aac_state_struct).bs_format == LOAS_BSFORMAT {
            *bytes_consumed = cnt_bits - (*it_bit_buff).cnt_bits
                >> 3 as core::ffi::c_int;
            if (*it_bit_buff).bit_pos < 7 as core::ffi::c_int {
                *bytes_consumed += 1 as core::ffi::c_int;
            }
        } else {
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_check_if_adts(
    mut adts: *mut ia_adts_header_struct,
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut usr_max_ch: WORD32,
) -> WORD32 {
    let mut max_frm_len_per_ch: WORD32 = 0;
    let mut result: WORD32 = 0 as WORD32;
    result = ixheaacd_adtsframe(adts, it_bit_buff);
    max_frm_len_per_ch = ixheaac_mult32(
        768 as WORD32,
        (*adts).no_raw_data_blocks + 1 as WORD32,
    );
    if (*adts).channel_configuration != 0 as core::ffi::c_int {
        max_frm_len_per_ch = ixheaac_mult32(
            max_frm_len_per_ch,
    ...
    return (result != 0 as core::ffi::c_int
        || ((*adts).aac_frame_length as core::ffi::c_int) < 8 as core::ffi::c_int
        || (*adts).layer != 0 as core::ffi::c_int || (*adts).profile != AAC_LC_PROFILE)
        as core::ffi::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_latm_header_decode(
    mut aac_state_struct: *mut ia_aac_dec_state_struct,
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut bytes_consumed: *mut WORD32,
    mut pstr_samp_rate_info: *mut ia_sampling_rate_info_struct,
    ...
    let mut result: IA_ERRORCODE = 0;
    let mut next_sync: WORD32 = 0;
    let mut audio_mux_len_bytes_last: WORD32 = 0;
    let mut audio_mux_len_bits_last: WORD32 = 0;
    let mut sync_status: WORD32 = (*aac_state_struct).sync_status;
    let mut bit_count: WORD32 = (*aac_state_struct).bit_count;
    let mut cnt_bits: WORD32 = (*it_bit_buff).cnt_bits;
    *bytes_consumed = 0 as core::ffi::c_int as WORD32;
    (*aac_state_struct).bs_format = LOAS_BSFORMAT as WORD32;
    if sync_status == 0 as core::ffi::c_int {
        loop {
            sync = ixheaacd_read_bits_buf(
                it_bit_buff as *mut ia_bit_buf_struct,
                11 as WORD,
            );
            bit_count += 11 as core::ffi::c_int;
            ...
            bit_count += 13 as core::ffi::c_int;
            audio_mux_len_bits_last = audio_mux_len_bytes_last << 3 as core::ffi::c_int;
            if (*it_bit_buff).cnt_bits
                >= audio_mux_len_bits_last as core::ffi::c_int + 11 as core::ffi::c_int
            {
                ixheaacd_read_bidirection(
                    it_bit_buff as *mut ia_bit_buf_struct,
                    audio_mux_len_bits_last,
                );
                bit_count += audio_mux_len_bits_last;
                next_sync = ixheaacd_read_bits_buf(
                    it_bit_buff as *mut ia_bit_buf_struct,
                    11 as WORD,
                );
                bit_count += 11 as core::ffi::c_int;
                if next_sync == 0x2b7 as core::ffi::c_int {
                    ixheaacd_read_bidirection(
                        it_bit_buff as *mut ia_bit_buf_struct,
                        -(11 as WORD32 + audio_mux_len_bits_last + 13 as WORD32
                            + 11 as WORD32),
                    );
                    bit_count
                        -= 11 as core::ffi::c_int
                            + audio_mux_len_bits_last as core::ffi::c_int
                            + 13 as core::ffi::c_int + 11 as core::ffi::c_int;
                    break;
                } else {
                    ixheaacd_read_bidirection(
                        it_bit_buff as *mut ia_bit_buf_struct,
                        -(audio_mux_len_bits_last + 24 as WORD32 + 11 as WORD32
                            - 1 as WORD32),
                    );
                    bit_count
                        -= audio_mux_len_bits_last as core::ffi::c_int
                            + 24 as core::ffi::c_int + 11 as core::ffi::c_int
                            - 1 as core::ffi::c_int;
                }
            } else if (*it_bit_buff).cnt_bits != audio_mux_len_bits_last {
                ixheaacd_read_bidirection(
                    it_bit_buff as *mut ia_bit_buf_struct,
                    -(13 as WORD32 + 11 as WORD32),
                );
                bit_count -= 13 as core::ffi::c_int + 11 as core::ffi::c_int;
                *bytes_consumed = ((cnt_bits as core::ffi::c_int
                    - (*it_bit_buff).cnt_bits as core::ffi::c_int)
                    / 8 as core::ffi::c_int) as WORD32;
        ...
        let mut audio_mux_len_bytes_last_0: WORD32 = 0;
        let mut use_same_stream_mux: WORD32 = 0;
        sync = ixheaacd_read_bits_buf(it_bit_buff as *mut ia_bit_buf_struct, 11 as WORD);
        bit_count += 11 as core::ffi::c_int;
        ...
        audio_mux_len_bytes_last_0 = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            13 as WORD,
        );
        bit_count += 13 as core::ffi::c_int;
        use_same_stream_mux = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            1 as WORD,
        );
        bit_count += 1 as core::ffi::c_int;
        if use_same_stream_mux == 0 {
            ...
            bit_count -= 25 as core::ffi::c_int;
            sync_status = 1 as core::ffi::c_int as WORD32;
        ...
        *bytes_consumed = ((cnt_bits as core::ffi::c_int
            - (*it_bit_buff).cnt_bits as core::ffi::c_int) / 8 as core::ffi::c_int)
            as WORD32;
        let mut latm_struct_element: ixheaacd_latm_struct = ixheaacd_latm_struct {
            use_same_stream_mux: 0,
            audio_mux_version: 0,
            ...
            crc_check_sum: 0,
            frame_length: 0,
            layer_info: [[ixheaacd_latm_layer_info {
                frame_len_type: 0,
                buffer_fullness: 0,
                frame_len_bits: 0,
                asc: ixheaacd_latm_specs {
                    aot: AOT_NULL_OBJECT,
        ...
        let mut sync_0: WORD32 = 0;
        memset(
            &mut latm_struct_element as *mut ixheaacd_latm_struct
                as *mut core::ffi::c_void,
            0 as core::ffi::c_int,
            ::core::mem::size_of::<ixheaacd_latm_struct>() as size_t,
        );
        sync_0 = ixheaacd_read_bits_buf(
            it_bit_buff as *mut ia_bit_buf_struct,
            11 as WORD,
        );
        if sync_0 == 0x2b7 as core::ffi::c_int {
            result = ixheaacd_latm_audio_mux_element(
                it_bit_buff,
                &mut latm_struct_element,
                aac_state_struct,
                pstr_samp_rate_info,
            ) as IA_ERRORCODE;
            if result != 0 as core::ffi::c_int {
                sync_status = 0 as core::ffi::c_int as WORD32;
                (*aac_state_struct).sync_status = sync_status;
                *bytes_consumed += 1 as core::ffi::c_int;
                return result;
            }
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_aac_headerdecode(
    mut p_obj_exhaacplus_dec: *mut ia_exhaacplus_dec_api_struct,
    mut buffer: *mut UWORD8,
    mut bytes_consumed: *mut WORD32,
    mut pstr_huffmann_tables: *const ia_aac_dec_huffman_tables_struct,
) -> WORD32 {
    let mut it_bit_buff: ia_bit_buf_struct = {
    ...
    let mut handle_bit_buff: *mut ia_bit_buf_struct = 0 as *mut ia_bit_buf_struct;
    let mut adif: ia_adif_header_struct = {
        let mut init = ia_adif_header_struct {
            bit_stream_type: 0 as WORD32,
            prog_config_present: 0,
            str_prog_config: ia_program_config_struct {
    ...
    let mut result: WORD32 = 0;
    let mut header_len: WORD32 = 0;
    let mut sync: WORD32 = 0 as WORD32;
    let mut disable_sync: WORD32 = (*p_obj_exhaacplus_dec).aac_config.ui_disable_sync
        as WORD32;
    let mut is_ga_header: WORD32 = (*p_obj_exhaacplus_dec).aac_config.ui_mp4_flag
        as WORD32;
    let mut loas_present: WORD32 = (*p_obj_exhaacplus_dec).aac_config.loas_present;
    let mut aac_state_struct: *mut ia_aac_dec_state_struct = *((*p_obj_exhaacplus_dec)
        .pp_mem_aac)
        .offset(IA_ENHAACPLUS_DEC_PERSIST_IDX as isize) as *mut ia_aac_dec_state_struct;
    let mut usr_max_ch: WORD32 = (*(*aac_state_struct).p_config).ui_max_channels
        as WORD32;
    let mut pstr_samp_rate_info: *mut ia_sampling_rate_info_struct = &*((*pstr_huffmann_tables)
        .str_sample_rate_info)
        .as_ptr()
        .offset(0 as core::ffi::c_int as isize) as *const ia_sampling_rate_info_struct
        as *mut ia_sampling_rate_info_struct;
    if buffer.is_null() {
        return IA_XHEAAC_DEC_INIT_FATAL_DEC_INIT_FAIL as WORD32;
    }
    header_len = (*aac_state_struct).ui_in_bytes as WORD32;
    handle_bit_buff = ixheaacd_create_bit_buf(
        &mut it_bit_buff,
        buffer,
        header_len as WORD16 as WORD32,
    ) as *mut ia_bit_buf_struct;
    (*handle_bit_buff).cnt_bits += header_len << 3 as core::ffi::c_int;
    (*handle_bit_buff).xaac_jmp_buf = &mut (*aac_state_struct).xaac_jmp_buf;
    if is_ga_header == 1 as core::ffi::c_int {
        return ixheaacd_ga_hdr_dec(
            aac_state_struct,
            header_len,
            bytes_consumed,
            pstr_samp_rate_info,
    ...
    } else if loas_present != 0 {
        return ixheaacd_latm_header_decode(
            aac_state_struct,
            &mut it_bit_buff,
            bytes_consumed,
            pstr_samp_rate_info,
        ...
        let mut header_found: WORD32 = 0 as WORD32;
        let mut bytes_taken: WORD32 = -(1 as WORD32);
        let mut prev_offset: WORD32 = 0 as WORD32;
        let mut run_once: WORD32 = 1 as WORD32;
        if disable_sync == 0 as core::ffi::c_int {
            run_once = 0 as core::ffi::c_int as WORD32;
        }
        let mut current_block_68: u64;
        loop {
            bytes_taken += 1;
            buffer = buffer.offset((bytes_taken - prev_offset) as isize);
            prev_offset = bytes_taken;
            handle_bit_buff = ixheaacd_create_bit_buf(
                &mut it_bit_buff,
                buffer,
                (header_len - bytes_taken) as WORD16 as WORD32,
            ) as *mut ia_bit_buf_struct;
            (*handle_bit_buff).cnt_bits
                += (8 as WORD32 * (header_len - bytes_taken)) as core::ffi::c_int;
            (*handle_bit_buff).pstr_adts_crc_info = &mut (*handle_bit_buff)
                .str_adts_crc_info;
            ixheaacd_adts_crc_open((*handle_bit_buff).pstr_adts_crc_info);
            (*aac_state_struct).ldmps_present = 0 as core::ffi::c_int as WORD32;
            (*aac_state_struct).latm_initialized = 0 as core::ffi::c_int as WORD32;
            memset(
                &mut (*aac_state_struct).mps_dec_handle as *mut ia_mps_dec_state_struct
                    as *mut core::ffi::c_void,
                0 as core::ffi::c_int,
                ::core::mem::size_of::<ia_mps_dec_state_struct>() as size_t,
            );
            memset(
                &mut (*aac_state_struct).eld_specific_config
                    as *mut ia_eld_specific_config_struct as *mut core::ffi::c_void,
            ...
            if *buffer.offset(0 as core::ffi::c_int as isize) as core::ffi::c_int
                == 'A' as i32
                && *buffer.offset(1 as core::ffi::c_int as isize) as core::ffi::c_int
                    == 'D' as i32
                && *buffer.offset(2 as core::ffi::c_int as isize) as core::ffi::c_int
                    == 'I' as i32
                && *buffer.offset(3 as core::ffi::c_int as isize) as core::ffi::c_int
                    == 'F' as i32
            {
                adif.prog_config_present = 0 as core::ffi::c_int as WORD32;
                result = ixheaacd_get_adif_header(&mut adif, handle_bit_buff);
                if result == 0 as core::ffi::c_int {
                    if adif.prog_config_present == 1 as core::ffi::c_int {
                        (*(*aac_state_struct).p_config).ui_pce_found_in_hdr = 1
                            as UWORD32;
                        (*(*aac_state_struct).p_config).str_prog_config = adif
                            .str_prog_config;
                    }
                    (*aac_state_struct).s_adif_hdr_present = 1 as WORD16;
                    (*aac_state_struct).audio_object_type = adif
                        .str_prog_config
                        .object_type as AUDIO_OBJECT_TYPE;
                    (*aac_state_struct).sampling_rate = (*pstr_samp_rate_info
                        .offset(adif.str_prog_config.samp_freq_index as isize))
                        .sampling_frequency as UWORD32;
                    (*aac_state_struct).ch_config = adif.str_prog_config.channels
                        as UWORD32;
                    bytes_taken
                        += (*handle_bit_buff).size - (*handle_bit_buff).cnt_bits
                            >> 3 as core::ffi::c_int;
                    header_found = 1 as core::ffi::c_int as WORD32;
                    (*aac_state_struct).frame_length = FRAME_SIZE as WORD32;
                    if (*aac_state_struct).audio_object_type as core::ffi::c_uint
                        == AOT_ER_AAC_LD as core::ffi::c_int as core::ffi::c_uint
                    {
                ...
                sync = ixheaacd_read_bits_buf(&mut it_bit_buff, 12 as WORD);
                if sync == 0xfff as core::ffi::c_int {
                    result = ixheaacd_check_if_adts(
                        &mut adts,
                        handle_bit_buff,
                        usr_max_ch,
                    );
                    if !(result != 0 as core::ffi::c_int) {
                        if adts.aac_frame_length as core::ffi::c_int + ADTS_HEADER_LENGTH
                            < header_len - bytes_taken
                        {
                            let mut adts_loc: ia_adts_header_struct = {
                                let mut init = ia_adts_header_struct {
                                    sync_word: 0 as WORD16,
                                    id: 0,
                                    layer: 0,
                            ...
                            ixheaacd_create_init_bit_buf(
                                &mut it_bit_buff,
                                buffer
                                    .offset(adts.aac_frame_length as core::ffi::c_int as isize),
                                (header_len as core::ffi::c_int
                                    - bytes_taken as core::ffi::c_int
                                    - adts.aac_frame_length as core::ffi::c_int) as WORD16
                                    as WORD32,
                            );
                            handle_bit_buff = &mut it_bit_buff;
                            adts_loc.sync_word = ixheaacd_read_bits_buf(
                                handle_bit_buff as *mut ia_bit_buf_struct,
                                12 as WORD,
                            ) as WORD16;
                            if adts_loc.sync_word as core::ffi::c_int
                                != 0xfff as core::ffi::c_int
                            {
                                current_block_68 = 1054647088692577877;
                            } else {
                                result = ixheaacd_check_if_adts(
                                    &mut adts_loc,
                                    handle_bit_buff,
                                ...
                                if result != 0 as core::ffi::c_int
                                    ...
                                    || adts.channel_configuration
                                        != adts_loc.channel_configuration
                                {
                                    current_block_68 = 1054647088692577877;
                                } else {
                                    current_block_68 = 12381812505308290051;
                                }
                            }
                        } else {
                            current_block_68 = 12381812505308290051;
                        ...
                        match current_block_68 {
                            1054647088692577877 => {}
                            _ => {
                                let mut obj_type: WORD32 = 0;
                                obj_type = adts.profile;
                                (*aac_state_struct).audio_object_type = obj_type
                                    as AUDIO_OBJECT_TYPE;
                                (*aac_state_struct).sampling_rate = (*pstr_samp_rate_info
                                    .offset(adts.samp_freq_index as isize))
                                    .sampling_frequency as UWORD32;
                                (*aac_state_struct).ch_config = adts.channel_configuration
                                    as UWORD32;
                                (*aac_state_struct).s_adts_hdr_present = 1 as WORD16;
                                header_found = 1 as core::ffi::c_int as WORD32;
                                (*aac_state_struct).bs_format = ADTS_BSFORMAT as WORD32;
                                (*aac_state_struct).frame_length = FRAME_SIZE as WORD32;
                                if (*aac_state_struct).audio_object_type
                                    as core::ffi::c_uint
                                    == AOT_ER_AAC_LD as core::ffi::c_int as core::ffi::c_uint
                                {
                                    (*aac_state_struct).frame_length >>= 1 as core::ffi::c_int;
                ...
                } else if 0x2b7 as core::ffi::c_int == sync >> 1 as core::ffi::c_int {
                    ixheaacd_read_bidirection(&mut it_bit_buff, -(12 as WORD32));
                    result = ixheaacd_latm_header_decode(
                        aac_state_struct,
                        &mut it_bit_buff,
                        bytes_consumed,
                        pstr_samp_rate_info,
                    ...
                    if result != 0 as core::ffi::c_int {
                        if result == IA_XHEAAC_DEC_EXE_NONFATAL_INSUFFICIENT_INPUT_BYTES
                            || result < 0 as core::ffi::c_int
                        {
                            ...
                            *bytes_consumed = bytes_taken;
                            ...
                            bytes_taken += *bytes_consumed - 1 as core::ffi::c_int;
                        }
                    } else {
                        header_found = 1 as core::ffi::c_int as WORD32;
                        (*aac_state_struct).bs_format = LOAS_BSFORMAT as WORD32;
            ...
            if !(header_found == 0 as core::ffi::c_int
                && (bytes_taken as core::ffi::c_int + 1 as core::ffi::c_int)
                    < header_len as core::ffi::c_int - 68 as core::ffi::c_int
                && run_once != 1 as core::ffi::c_int)
            {
                break;
            }
        }
        if header_found == 0 as core::ffi::c_int && disable_sync == 1 as core::ffi::c_int
        {
            let mut err_code: WORD32 = 0;
            ixheaacd_read_bidirection(&mut it_bit_buff, -(12 as WORD32));
            err_code = ixheaacd_ga_hdr_dec(
                aac_state_struct,
                header_len,
                bytes_consumed,
                pstr_samp_rate_info,
        ...
        match (*aac_state_struct).audio_object_type as core::ffi::c_uint {
            1 | 2 | 3 | 4 | 6 | 7 | 23 | 39 | 17 | 42 => {}
            _ => return IA_XHEAAC_DEC_INIT_FATAL_AUDIOOBJECTTYPE_NOT_SUPPORTED as WORD32,
        }
        if (*aac_state_struct).audio_object_type as core::ffi::c_uint
            != AOT_USAC as core::ffi::c_int as core::ffi::c_uint
        {
        ...
        *bytes_consumed = bytes_taken;
        if (*handle_bit_buff).cnt_bits < 0 as core::ffi::c_int
            && (*handle_bit_buff).size
                < usr_max_ch as core::ffi::c_int
                    * (IA_ENHAACPLUS_DEC_INP_BUF_SIZE << 3 as core::ffi::c_int)
        {
            return IA_XHEAAC_DEC_EXE_NONFATAL_INSUFFICIENT_INPUT_BYTES as WORD16
                as WORD32;
        }
        if header_found == 0 as core::ffi::c_int {
            *bytes_consumed = (bytes_taken as core::ffi::c_int + 1 as core::ffi::c_int)
                as WORD32;
            return IA_XHEAAC_DEC_INIT_NONFATAL_HEADER_NOT_AT_START;
        } else {
            return 0 as WORD32
