extern "C" {
    ...
    static ia_ec_fade_factors_fix: [WORD32; 9];
    fn ixheaacd_lt_update_state(
        lt_pred_stat: *mut WORD16,
        time: *mut core::ffi::c_void,
        overlap: *mut WORD32,
        frame_len: WORD32,
        object_type: WORD32,
        stride: WORD32,
        window_sequence: WORD16,
        p_window_next: *mut WORD16,
        slot_element: WORD,
    ) -> VOID;
    fn ixheaacd_ics_read(
        it_bit_buff: *mut ia_bit_buf_struct,
        ptr_ics_info: *mut ia_ics_info_struct,
        num_swb_window: *mut WORD8,
        object_type: WORD32,
        common_window: WORD32,
        frame_size: WORD32,
    ) -> WORD16;
    fn ixheaacd_ltp_decode(
        it_bit_buff: *mut ia_bit_buf_struct,
        ptr_ics_info: *mut ia_ics_info_struct,
        object_type: WORD32,
        frame_size: WORD32,
    ...
    fn ixheaacd_aac_ec_init(pstr_ec_state: *mut ia_ec_state_str) -> VOID;
    fn ixheaacd_aac_apply_ec(
        pstr_ec_state: *mut ia_ec_state_str,
        pstr_aac_dec_channel_info: *mut ia_aac_dec_channel_info_struct,
        pstr_samp_rate_info: *const ia_usac_samp_rate_info,
        num_samples: WORD32,
        pstr_ics_info: *mut ia_ics_info_struct,
        frame_status: WORD32,
    ) -> VOID;
    fn ixheaacd_drc_map_channels(
        drc_dec: *mut ia_drc_dec_struct,
        num_ch: WORD32,
        frame_size: WORD32,
    ) -> WORD32;
    fn ixheaacd_drc_apply(
        pstr_drc_dec: *mut ia_drc_dec_struct,
        ptr_spectral_coef: *mut WORD32,
        win_seq: WORD32,
        channel: WORD32,
        frame_size: WORD32,
        esbr_flag: WORD32,
    ...
    fn ixheaacd_imdct_process(
        ptr_aac_dec_overlap_info: *mut ia_aac_dec_overlap_info,
        ptr_spec_coeff: *mut WORD32,
        ptr_ics_info: *mut ia_ics_info_struct,
        out_samples: *mut core::ffi::c_void,
        ch_fac: WORD16,
        scratch: *mut WORD32,
        ptr_aac_tables: *mut ia_aac_dec_tables_struct,
        object_type: WORD32,
        ld_mps_present: WORD32,
        slot_element: WORD,
    ) -> VOID;
    fn ixheaacd_channel_pair_process(
        ...
        in_data: *mut WORD32,
        out_data: *mut WORD32,
        self_ptr: *mut core::ffi::c_void,
    ) -> IA_ERRORCODE;
    fn ixheaacd_read_data_stream_element(
        it_bit_buff: *mut ia_bit_buf_struct,
        byte_align_bits: *mut WORD32,
        drc_handle: *mut ia_drc_dec_struct,
    ) -> VOID;
    fn ixheaacd_check_for_sbr_payload(
        it_bit_buff: *mut ia_bit_buf_struct,
        pstr_stream_sbr: *mut ia_aac_dec_sbr_bitstream_struct,
        prev_element: WORD16,
        pstr_drc_dec: *mut ia_drc_dec_struct,
        object_type: WORD32,
        adtsheader: WORD32,
        cnt_bits: WORD32,
        ld_sbr_crc_flag: WORD32,
    ...
    fn ixheaacd_read_ms_data(
        it_bit_buff: *mut ia_bit_buf_struct,
        ptr_aac_dec_ch_info: *mut ia_aac_dec_channel_info_struct,
    ) -> VOID;
    fn ixheaacd_individual_ch_stream(
        it_bit_buff: *mut ia_bit_buf_struct,
        aac_dec_handle: *mut ia_aac_decoder_struct,
        num_ch: WORD32,
        frame_size: WORD32,
        total_channels: WORD32,
        object_type: WORD32,
    ...
    fn ixheaacd_decode_pce(
        it_bit_buff: *mut ia_bit_buf_struct,
        ui_pce_found_in_hdr: *mut UWORD32,
        pce_t: *mut ia_program_config_struct,
    ) -> WORD;
    fn ixheaacd_dec_coupling_channel_element(
        it_bit_buf: *mut ia_bit_buf_struct,
        aac_handle: *mut ia_aac_decoder_struct,
        sample_rate_idx: WORD32,
        ptr_aac_tables: *mut ia_aac_dec_tables_struct,
        common_tables_ptr: *mut ixheaacd_misc_tables,
        element_index_order: *mut WORD,
        ind_channel_info: *mut ia_enhaacplus_dec_ind_cc,
        total_channels: WORD32,
        frame_size: WORD32,
        audio_object_type: WORD32,
        eld_specific_config: ia_eld_specific_config_struct,
    ...
    fn ixheaacd_ld_mps_frame_parsing(
        self_0: *mut ia_mps_dec_state_struct,
        it_bit_buff: *mut ia_bit_buf_struct,
    ) -> IA_ERRORCODE;
    fn ixheaacd_huff_code_reorder_tbl_init(
...
pub const CRC_ADTS_RAW_DATA_BLK_LEN: core::ffi::c_int = 192 as core::ffi::c_int;
...
pub const PNS_BAND_FLAGS_SIZE: core::ffi::c_int = 16 as core::ffi::c_int;
...
pub const EXT_FILL_DATA: core::ffi::c_int = 1;
pub const EXT_FIL: core::ffi::c_int = 0;
pub const EXT_DATA_LENGTH: core::ffi::c_int = 3;
pub const EXT_LDSAC_DATA: core::ffi::c_int = 9;
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_aacdec_decodeframe(
    mut p_obj_exhaacplus_dec: *mut ia_exhaacplus_dec_api_struct,
    mut aac_scratch_ptrs: *mut ia_aac_dec_scratch_struct,
    mut time_data_tmp: *mut core::ffi::c_void,
    mut frame_status: FLAG,
    mut type_0: *mut WORD,
    mut ch_idx: *mut WORD,
    mut init_flag: WORD,
    mut channel: WORD,
    mut element_index_order: *mut WORD,
    mut skip_full_decode: WORD,
    mut ch_fac: WORD,
    mut slot_element: WORD,
    mut max_channels: WORD,
    mut total_channels: WORD32,
    mut frame_length: WORD32,
    mut frame_size: WORD32,
    mut pstr_drc_dec: *mut ia_drc_dec_struct,
    mut object_type: WORD32,
    mut ch_config: WORD32,
    mut eld_specific_config: ia_eld_specific_config_struct,
    mut adtsheader: WORD16,
    mut drc_dummy: *mut ia_drc_dec_struct,
    mut ldmps_present: WORD32,
    mut slot_pos: *mut UWORD8,
    mut mps_buffer: *mut UWORD8,
    mut mps_header: *mut WORD32,
    mut mps_bytes: *mut WORD32,
    mut is_init: WORD32,
    mut first_frame: WORD32,
) -> WORD32 {
    let mut pstr_aac_dec_ch_info: *mut ia_aac_dec_channel_info_struct = 0
        as *mut ia_aac_dec_channel_info_struct;
    let mut ptr_ics_info: *mut ia_ics_info_struct = 0 as *mut ia_ics_info_struct;
    let mut current_block: u64;
    let mut ch: WORD = 0;
    let mut ele_type: WORD = 0;
    let mut p_state_enhaacplus_dec: *mut ia_aac_dec_state_struct = 0
        as *mut ia_aac_dec_state_struct;
    let mut aac_dec_handle: *mut ia_aac_decoder_struct = 0 as *mut ia_aac_decoder_struct;
    let mut it_bit_buff: *mut ia_bit_buf_struct = 0 as *mut ia_bit_buf_struct;
    let mut latm_element: *mut ixheaacd_latm_struct = 0 as *mut ixheaacd_latm_struct;
    let mut error_code: WORD = frame_status;
    let mut previous_element: WORD = 0;
    let mut prev_data_ele_present: WORD = 0 as WORD;
    let mut new_element: WORD = 0;
    let mut num_ch: WORD32 = 0 as WORD32;
    let mut crc_reg: WORD32 = 0 as WORD32;
    let mut ptr_adts_crc_info: *mut ia_adts_crc_info_struct = 0
        as *mut ia_adts_crc_info_struct;
    let mut cnt_bits: WORD32 = 0 as WORD32;
    let mut eld_sbr_flag: WORD32 = eld_specific_config.ld_sbr_flag_present;
    let mut ld_sbr_crc_flag: WORD32 = eld_specific_config.ld_sbr_crc_flag;
    let mut aac_spect_data_resil_flag: WORD32 = eld_specific_config
        .aac_spect_data_resil_flag;
    let mut ele_ch: WORD32 = 0 as WORD32;
    let mut ptr_aac_sfb_code_book_data: [*mut ia_aac_sfb_code_book_struct; 2] = [0
        as *mut ia_aac_sfb_code_book_struct; 2];
    let mut ptr_pns_stereo_data: *mut ia_pns_stereo_data_struct = 0
        as *mut ia_pns_stereo_data_struct;
    let mut work_buffer_core: *mut WORD32 = (*aac_scratch_ptrs).base_scr_8k
        as *mut WORD32;
    let mut work_buffer_1: *mut WORD32 = (*aac_scratch_ptrs)
        .extra_scr_4k[0 as core::ffi::c_int as usize] as *mut WORD32;
    let mut work_buffer_2: *mut WORD32 = (*aac_scratch_ptrs)
        .extra_scr_4k[2 as core::ffi::c_int as usize] as *mut WORD32;
    p_state_enhaacplus_dec = (*p_obj_exhaacplus_dec).p_state_aac;
    let mut time_data: *mut WORD32 = time_data_tmp as *mut WORD32;
    aac_dec_handle = (*p_state_enhaacplus_dec).pstr_aac_dec_info[*ch_idx as usize];
    it_bit_buff = (*p_state_enhaacplus_dec).ptr_bit_stream;
    (*p_obj_exhaacplus_dec).aac_config.str_prog_config.alignment_bits = (*it_bit_buff)
        .bit_pos;
    ptr_adts_crc_info = (*it_bit_buff).pstr_adts_crc_info;
    latm_element = &mut (*p_state_enhaacplus_dec).latm_struct_element;
    ptr_pns_stereo_data = &mut *work_buffer_1
        .offset(
            (2 as usize)
                .wrapping_mul(
                    (::core::mem::size_of::<ia_aac_dec_channel_info_struct>() as usize)
                        .wrapping_add(::core::mem::size_of::<WORD32>() as usize)
        ...
        ) as *mut WORD32 as *mut ia_pns_stereo_data_struct;
    (*aac_dec_handle).frame_status = 1 as core::ffi::c_int as FLAG;
    ch = 0 as core::ffi::c_int as WORD;
    while ch < channel {
        let mut pstr_imdct_tables: *const ia_aac_dec_imdct_tables_struct = 0
            as *const ia_aac_dec_imdct_tables_struct;
        (*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize] = &mut *work_buffer_1
            .offset(
                (ch as usize)
                    .wrapping_mul(
            ...
            ) as *mut WORD32 as *mut ia_aac_dec_channel_info_struct;
        ptr_aac_sfb_code_book_data[ch as usize] = &mut *work_buffer_1
            .offset(
                (2 as usize)
                    .wrapping_mul(
                        (::core::mem::size_of::<ia_aac_dec_channel_info_struct>()
            ...
            ) as *mut WORD32 as *mut ia_aac_sfb_code_book_struct;
        (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).ptr_scale_factor = ((*ptr_aac_sfb_code_book_data[ch
            as usize])
            .scale_factor)
            .as_mut_ptr();
        (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).ptr_code_book = ((*ptr_aac_sfb_code_book_data[ch
            as usize])
            .code_book)
            .as_mut_ptr();
        (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).ptr_spec_coeff = &mut *work_buffer_core
            .offset((ch as core::ffi::c_int * MAX_BINS_LONG) as isize) as *mut WORD32;
        if object_type == AOT_ER_AAC_ELD as core::ffi::c_int {
            (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).ptr_spec_coeff = &mut *work_buffer_core
                .offset(
                    (2 as core::ffi::c_int * ch as core::ffi::c_int * MAX_BINS_LONG)
                        as isize,
                ) as *mut WORD32;
        }
        (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).pstr_stereo_info = &mut (*ptr_pns_stereo_data)
            .str_stereo_info;
        (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).pstr_pns_corr_info = &mut (*ptr_pns_stereo_data)
            .str_pns_corr_info;
        (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).pstr_pns_rand_vec_data = (*aac_dec_handle)
            .pstr_pns_rand_vec_data;
        pstr_imdct_tables = (*(*aac_dec_handle).pstr_aac_tables).pstr_imdct_tables;
        if 960 as core::ffi::c_int != frame_length {
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_long_window[0 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_long_window_sine)
                .as_ptr();
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_short_window[0 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_short_window_sine)
                .as_ptr();
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_long_window[1 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_long_window_kbd)
                .as_ptr();
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_short_window[1 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_short_window_kbd)
                .as_ptr();
            (*(*aac_dec_handle).ptr_aac_dec_static_channel_info[ch as usize])
                .ptr_long_window[0 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_long_window_sine)
                .as_ptr();
            (*(*aac_dec_handle).ptr_aac_dec_static_channel_info[ch as usize])
            ...
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_long_window[0 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_long_window_sine_960)
                .as_ptr();
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_short_window[0 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_short_window_sine_120)
                .as_ptr();
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_long_window[1 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_long_window_kbd_960)
                .as_ptr();
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_short_window[1 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_short_window_kbd_120)
                .as_ptr();
            (*(*aac_dec_handle).ptr_aac_dec_static_channel_info[ch as usize])
                .ptr_long_window[0 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                .only_long_window_sine_960)
        ...
        if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0
            && frame_status == 0 as core::ffi::c_int
        {
            memset(
                &mut (**((*aac_dec_handle).pstr_aac_dec_ch_info)
                    .as_mut_ptr()
                    .offset(ch as isize))
                    .str_ics_info as *mut ia_ics_info_struct as *mut core::ffi::c_void,
                0 as core::ffi::c_int,
                ::core::mem::size_of::<ia_ics_info_struct>() as size_t,
            );
        }
        (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize])
            .str_ics_info
            .frame_length = frame_length as WORD16;
        if object_type == AOT_ER_AAC_ELD as core::ffi::c_int
            || object_type == AOT_ER_AAC_LD as core::ffi::c_int
            || object_type == AOT_AAC_LTP as core::ffi::c_int
        {
            if 512 as core::ffi::c_int == (*aac_dec_handle).samples_per_frame {
                if object_type != AOT_ER_AAC_ELD as core::ffi::c_int {
                    (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                        .ptr_long_window[1 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                        .low_overlap_win)
                        .as_ptr() as *mut WORD16;
                    (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                        .ptr_long_window[0 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                        .window_sine_512)
                        .as_ptr() as *mut WORD16;
            ...
            } else if 480 as core::ffi::c_int == (*aac_dec_handle).samples_per_frame {
                if object_type != AOT_ER_AAC_ELD as core::ffi::c_int {
                    (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                        .ptr_long_window[1 as core::ffi::c_int as usize] = ((*pstr_imdct_tables)
                        .low_overlap_win_480)
        ...
        if object_type == AOT_ER_AAC_LD as core::ffi::c_int
            || object_type == AOT_AAC_LTP as core::ffi::c_int
        {
            if (*aac_dec_handle).samples_per_frame <= 512 as core::ffi::c_int {
                (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize])
                    .str_ics_info
                    .ltp2
                    .lag = (*(*aac_dec_handle)
                    .ptr_aac_dec_static_channel_info[ch as usize])
                    .ltp_lag_1;
                (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize])
                    .str_ics_info
                    .ltp
            ...
            (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).ltp_buf = (*(*aac_dec_handle)
                .ptr_aac_dec_static_channel_info[ch as usize])
                .ltp_buf;
            (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).ltp_lag = (*(*aac_dec_handle)
                .ptr_aac_dec_static_channel_info[ch as usize])
                .ltp_lag_1;
        }
        (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).scratch_buf_ptr = work_buffer_2;
        if object_type == AOT_ER_AAC_ELD as core::ffi::c_int {
            (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).pulse_scratch = (*aac_scratch_ptrs)
                .extra_scr_4k[3 as core::ffi::c_int as usize] as *mut WORD32;
        }
        ch += 1;
    }
    if channel == 2 as core::ffi::c_int {
        if (*(*aac_dec_handle).pstr_aac_dec_ch_info[1 as core::ffi::c_int as usize])
            .ptr_spec_coeff
            == (*aac_scratch_ptrs).extra_scr_4k[0 as core::ffi::c_int as usize]
                as *mut WORD32
        {
            (*(*aac_dec_handle).pstr_aac_dec_ch_info[1 as core::ffi::c_int as usize])
                .ptr_spec_coeff = (*(*aac_dec_handle)
    ...
    ch = 0 as core::ffi::c_int as WORD;
    while ch < channel {
        let mut ptr_pns_info: *mut ia_pns_info_struct = &mut (**((*aac_dec_handle)
            .pstr_aac_dec_ch_info)
            .as_mut_ptr()
            .offset(ch as isize))
            .str_pns_info;
        memset(
            ptr_pns_info as *mut core::ffi::c_void,
            0 as core::ffi::c_int,
            ::core::mem::size_of::<ia_pns_info_struct>() as size_t,
        );
        ch += 1;
    }
    if channel > 0 as core::ffi::c_int {
        let mut ptr_corr_info: *mut ia_pns_correlation_info_struct = (*(*aac_dec_handle)
            .pstr_aac_dec_ch_info[0 as core::ffi::c_int as usize])
            .pstr_pns_corr_info;
        memset(
            ((*ptr_corr_info).correlated).as_mut_ptr() as *mut core::ffi::c_void,
            0 as core::ffi::c_int,
            (::core::mem::size_of::<UWORD8>() as size_t)
                .wrapping_mul(PNS_BAND_FLAGS_SIZE as size_t),
        );
    }
    ch = 0 as core::ffi::c_int as WORD;
    while ch < channel {
        memset(
            &mut (**((*aac_dec_handle).pstr_aac_dec_ch_info)
                .as_mut_ptr()
                .offset(ch as isize))
                .str_hcr_info as *mut ia_hcr_info_struct as *mut core::ffi::c_void,
            0 as core::ffi::c_int,
            ::core::mem::size_of::<ia_hcr_info_struct>() as size_t,
        );
    ...
    while ch < channel {
        if object_type == AOT_ER_AAC_ELD as core::ffi::c_int
            || object_type == AOT_ER_AAC_LD as core::ffi::c_int
        {
            (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).granule_len = (*aac_dec_handle)
                .samples_per_frame;
        }
        if object_type == AOT_ER_AAC_LC as core::ffi::c_int {
            (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize]).granule_len = ((*aac_dec_handle)
                .samples_per_frame as core::ffi::c_int / 8 as core::ffi::c_int)
                as WORD32;
        }
        ch += 1;
    }
    previous_element = ID_END as core::ffi::c_int as WORD;
    (*(*aac_dec_handle).pstr_sbr_bitstream).no_elements = 0 as WORD16;
    new_element = 0 as core::ffi::c_int as WORD;
    ele_type = *type_0;
    ...
    if err == 0 && frame_status != 0 {
        ...
        {
            while ele_type != ID_END as core::ffi::c_int
                && (*aac_dec_handle).frame_status != 0
            {
                ele_type = ixheaacd_read_bits_buf(it_bit_buff, 3 as WORD);
                ixheaacd_read_bidirection(it_bit_buff, -(3 as WORD32));
                if (*it_bit_buff).cnt_bits < 3 as core::ffi::c_int {
                    ...
                    if ele_type == ID_FIL as core::ffi::c_int
                        || ele_type == ID_DSE as core::ffi::c_int
                        || new_element == 0 as core::ffi::c_int
                    {
                        ele_type = ixheaacd_read_bits_buf(it_bit_buff, 3 as WORD);
                        new_element = 1 as core::ffi::c_int as WORD;
                    } else if ele_type != ID_END as core::ffi::c_int {
                        ele_type = -(1 as core::ffi::c_int) as WORD;
                        break;
                    } else {
                        ele_type = ixheaacd_read_bits_buf(it_bit_buff, 3 as WORD);
                    }
                    if (*it_bit_buff).cnt_bits < 0 as core::ffi::c_int {
                        (*aac_dec_handle).frame_status = 0 as core::ffi::c_int as FLAG;
                    }
                    match ele_type {
                        0 | 1 | 3 => {
                            if (*aac_dec_handle).frame_status != 0 {
                                pstr_aac_dec_ch_info = (*aac_dec_handle)
                                    .pstr_aac_dec_ch_info[LEFT as usize];
                                ptr_ics_info = &mut (*pstr_aac_dec_ch_info).str_ics_info;
                                ele_ch = 1 as core::ffi::c_int as WORD32;
                                if ele_type == ID_CPE as core::ffi::c_int {
                                    ele_ch = 2 as core::ffi::c_int as WORD32;
                                } else {
                                    ele_ch = 1 as core::ffi::c_int as WORD32;
                                }
                                prev_data_ele_present = 1 as core::ffi::c_int as WORD;
                                if (*ptr_adts_crc_info).crc_active as core::ffi::c_int
                                    == 1 as core::ffi::c_int
                                    && ((*ptr_adts_crc_info).no_reg as core::ffi::c_int)
                                        < 7 as core::ffi::c_int
                                {
                                ...
                                (*pstr_aac_dec_ch_info).element_instance_tag = ixheaacd_read_bits_buf(
                                    it_bit_buff,
                                    4 as WORD,
                                ) as WORD16;
                                *element_index_order.offset(*ch_idx as isize) = (*pstr_aac_dec_ch_info)
                                    .element_instance_tag as WORD;
                                (*pstr_aac_dec_ch_info).common_window = 0 as WORD16;
                                (*ptr_ics_info).num_swb_window = 0 as WORD16;
                                (*ptr_ics_info).sampling_rate_index = (*aac_dec_handle)
                                    .sampling_rate_index;
                                if object_type == AOT_ER_AAC_LD as core::ffi::c_int
                                    || object_type == AOT_AAC_LTP as core::ffi::c_int
                                {
                                    (*ptr_ics_info).ltp.data_present = 0 as UWORD8;
                                    (*ptr_ics_info).ltp2.data_present = 0 as UWORD8;
                                    (*ptr_ics_info).predictor_data_present = 0 as WORD16;
                                }
                                if ele_ch > 1 as core::ffi::c_int {
                                    (*(*aac_dec_handle).pstr_aac_dec_ch_info[RIGHT as usize])
                                        .str_ics_info
                                        .num_swb_window = 0 as WORD16;
                                    (*(*aac_dec_handle).pstr_aac_dec_ch_info[RIGHT as usize])
                                        .str_ics_info
                                        .sampling_rate_index = (*aac_dec_handle)
                                        .sampling_rate_index;
                                    (*pstr_aac_dec_ch_info).common_window = ixheaacd_read_bits_buf(
                                        it_bit_buff,
                                        1 as WORD,
                                    ) as WORD16;
                                    if (*pstr_aac_dec_ch_info).common_window != 0 {
                                        error_code = ixheaacd_ics_read(
                                            it_bit_buff,
                                            ptr_ics_info,
                                            ((*aac_dec_handle).num_swb_window).as_mut_ptr(),
                                            object_type,
                                            (*pstr_aac_dec_ch_info).common_window as WORD32,
                                            (*aac_dec_handle).samples_per_frame,
                                        ) as WORD;
                                        if error_code != 0 {
                                            (*(*aac_dec_handle).pstr_aac_dec_ch_info[RIGHT as usize])
                                                .str_ics_info = (*(*aac_dec_handle)
                                                .pstr_aac_dec_ch_info[LEFT as usize])
                                                .str_ics_info;
                                            if (*it_bit_buff).cnt_bits < 0 as core::ffi::c_int {
                                                error_code = IA_XHEAAC_DEC_EXE_NONFATAL_INSUFFICIENT_INPUT_BYTES
                                            ...
                                            current_block = 18018599048255390786;
                                        } else {
                                            (*(*aac_dec_handle).pstr_aac_dec_ch_info[RIGHT as usize])
                                                .str_ics_info = (*pstr_aac_dec_ch_info).str_ics_info;
                                    ...
                                    _ => {
                                        ...
                                        if error_code != 0 {
                                            if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0
                                                && is_init == 0
                                            {
                                                (*aac_dec_handle).frame_status = 0 as core::ffi::c_int
                                                    as FLAG;
                                            } else {
                        ...
                        2 => {
                            if max_channels > 2 as core::ffi::c_int {
                                prev_data_ele_present = 1 as core::ffi::c_int as WORD;
                                error_code = ixheaacd_dec_coupling_channel_element(
                                    it_bit_buff,
                                    aac_dec_handle,
                                    (*aac_dec_handle).sampling_rate_index as WORD32,
                                    (*aac_dec_handle).pstr_aac_tables,
                                    (*aac_dec_handle).pstr_common_tables,
                                    &mut *element_index_order.offset(*ch_idx as isize),
                                    (*aac_dec_handle).p_ind_channel_info
                                        as *mut ia_enhaacplus_dec_ind_cc,
                                    total_channels,
                                    frame_length,
                                    object_type,
                                    eld_specific_config,
                                ...
                                num_ch = (num_ch as core::ffi::c_int
                                ...
                                if error_code != 0 {
                                    ...
                                    error_code = ixheaacd_channel_pair_process(
                                        ((*aac_dec_handle).pstr_aac_dec_ch_info).as_mut_ptr(),
                                        1 as WORD32,
                                        (*aac_dec_handle).pstr_aac_tables,
                                        total_channels,
                                        object_type,
                                        ...
                                        (*aac_scratch_ptrs).in_data,
                                        (*aac_scratch_ptrs).out_data,
                                        aac_dec_handle as *mut core::ffi::c_void,
                                    ) as WORD;
                                    if error_code != 0 {
                                        if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0
                                            && is_init == 0
                                ...
                                error_code = IA_XHEAAC_DEC_EXE_FATAL_UNIMPLEMENTED_CCE
                                    as WORD32 as WORD;
                            }
                            if (*it_bit_buff).cnt_bits < 0 as core::ffi::c_int {
                                error_code = IA_XHEAAC_DEC_EXE_NONFATAL_INSUFFICIENT_INPUT_BYTES
                        ...
                        4 | 5 | 6 => {
                            ...
                            if ele_type != ID_FIL as core::ffi::c_int
                                && (*ptr_adts_crc_info).crc_active as core::ffi::c_int
                                    == 1 as core::ffi::c_int
                                && ((*ptr_adts_crc_info).no_reg as core::ffi::c_int)
                                    < 7 as core::ffi::c_int
                            {
                            ...
                            if ele_type == ID_DSE as core::ffi::c_int {
                                ixheaacd_read_data_stream_element(
                                    it_bit_buff,
                                    &mut (*aac_dec_handle).byte_align_bits,
                                    (*(*p_obj_exhaacplus_dec).p_state_aac).pstr_drc_dec,
                                );
                                current_block = 16517180880614114163;
                            } else if ele_type == ID_PCE as core::ffi::c_int {
                                error_code = ixheaacd_decode_pce(
                                    it_bit_buff as *mut ia_bit_buf_struct,
                                    &mut (*p_obj_exhaacplus_dec).aac_config.ui_pce_found_in_hdr,
                                    &mut (*p_obj_exhaacplus_dec).aac_config.str_prog_config,
                                );
                                if error_code != 0 as core::ffi::c_int {
                                    if (*it_bit_buff).cnt_bits < 0 as core::ffi::c_int {
                                        ...
                                        } else if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal
                                            != 0 && is_init == 0
                                        {
                                            (*aac_dec_handle).frame_status = 0 as core::ffi::c_int
                                                as FLAG;
                                ...
                                if ele_type == ID_FIL as core::ffi::c_int {
                                    let mut bits_decoded: WORD32 = 0 as WORD32;
                                    if object_type == AOT_ER_AAC_ELD as core::ffi::c_int {
                                        bits_decoded = (*it_bit_buff).size
                                            - (*it_bit_buff).cnt_bits;
                                        cnt_bits = frame_size * 8 as WORD32 - bits_decoded;
                                        if adtsheader as core::ffi::c_int == 1 as core::ffi::c_int {
                                    ...
                                    if ixheaacd_check_for_sbr_payload(
                                        it_bit_buff,
                                        (*aac_dec_handle).pstr_sbr_bitstream,
                                        previous_element as WORD16,
                                        pstr_drc_dec,
                                        object_type,
                                        adtsheader as WORD32,
                                        cnt_bits,
                                        ld_sbr_crc_flag,
                                        drc_dummy,
                                        mps_buffer,
                            ...
                            match current_block {
                                ...
                                _ => {
                                    if (*it_bit_buff).cnt_bits < 0 as core::ffi::c_int {
                                        ...
                                        if flag != 0 {
                                            if prev_data_ele_present == 0 as core::ffi::c_int {
                                                new_element = 0 as core::ffi::c_int as WORD;
                                            }
                                        }
                                        if ele_type != ID_FIL as core::ffi::c_int
                                        ...
                                        if ele_type == ID_PCE as core::ffi::c_int {
                                            if (*ptr_adts_crc_info)
                                                .str_crc_reg_data[crc_reg as usize]
                                                .bit_buf_cnt != 0
                                            {
                                                (*ptr_adts_crc_info)
                                                    .str_crc_reg_data[crc_reg as usize]
                                                    .max_bits = (*ptr_adts_crc_info)
                                                    .str_crc_reg_data[crc_reg as usize]
                                                    .bit_buf_cnt;
                                            }
                                        }
                        ...
                        7 => {
                            error_code = 0 as core::ffi::c_int as WORD;
                            current_block = 2756754640271984560;
                        }
                        _ => {
                            current_block = 2756754640271984560;
                    ...
                    match current_block {
                        18018599048255390786 => {
                            if error_code != 0 {
                                (*aac_dec_handle).frame_status = 0 as core::ffi::c_int
                                    as FLAG;
                                if ele_type >= ID_SCE as core::ffi::c_int
                    ...
                    if init_flag != 0 {
                            ...
                            && ele_type <= ID_LFE as core::ffi::c_int
                        {
                            (*p_obj_exhaacplus_dec)
                                .aac_config
                                .element_type[*ch_idx as usize] = ele_type as WORD32;
                        }
                    }
                }
            }
            ...
            if (*aac_dec_handle).frame_status != 0 {
                let mut pstr_aac_dec_ch_info_0: *mut ia_aac_dec_channel_info_struct = (*aac_dec_handle)
                    .pstr_aac_dec_ch_info[LEFT as usize];
                let mut ptr_ics_info_0: *mut ia_ics_info_struct = &mut (*pstr_aac_dec_ch_info_0)
                    .str_ics_info;
                if ch_config == 2 as core::ffi::c_int {
                    ele_ch = 2 as core::ffi::c_int as WORD32;
                    ele_type = 1 as core::ffi::c_int as WORD;
                } else {
                    ele_ch = 1 as core::ffi::c_int as WORD32;
                    ele_type = 0 as core::ffi::c_int as WORD;
                }
                prev_data_ele_present = 1 as core::ffi::c_int as WORD;
                if (*ptr_adts_crc_info).crc_active as core::ffi::c_int
                    == 1 as core::ffi::c_int
                ...
                if object_type != AOT_ER_AAC_ELD as core::ffi::c_int {
                    (*pstr_aac_dec_ch_info_0).element_instance_tag = ixheaacd_read_bits_buf(
                        it_bit_buff,
                        4 as WORD,
                    ) as WORD16;
                }
                *element_index_order.offset(*ch_idx as isize) = (*pstr_aac_dec_ch_info_0)
                    .element_instance_tag as WORD;
                (*pstr_aac_dec_ch_info_0).common_window = 0 as WORD16;
                (*ptr_ics_info_0).num_swb_window = 0 as WORD16;
                (*ptr_ics_info_0).sampling_rate_index = (*aac_dec_handle)
                    .sampling_rate_index;
                if object_type == AOT_ER_AAC_LD as core::ffi::c_int {
                    (*ptr_ics_info_0).ltp.data_present = 0 as UWORD8;
                    (*ptr_ics_info_0).ltp2.data_present = 0 as UWORD8;
                    (*ptr_ics_info_0).predictor_data_present = 0 as WORD16;
                }
                if ele_ch > 1 as core::ffi::c_int {
                    (*(*aac_dec_handle).pstr_aac_dec_ch_info[RIGHT as usize])
                        .str_ics_info
                    ...
                    (*(*aac_dec_handle).pstr_aac_dec_ch_info[RIGHT as usize])
                        .str_ics_info
                        .sampling_rate_index = (*aac_dec_handle).sampling_rate_index;
                    if object_type != 39 as core::ffi::c_int {
                        (*pstr_aac_dec_ch_info_0).common_window = ixheaacd_read_bits_buf(
                            it_bit_buff,
                            1 as WORD,
                        ) as WORD16;
                    } else {
                        (*pstr_aac_dec_ch_info_0).common_window = 1 as WORD16;
                    }
                    if (*pstr_aac_dec_ch_info_0).common_window != 0 {
                        error_code = ixheaacd_ics_read(
                            it_bit_buff,
                            ptr_ics_info_0,
                            ((*aac_dec_handle).num_swb_window).as_mut_ptr(),
                            object_type,
                            (*pstr_aac_dec_ch_info_0).common_window as WORD32,
                            (*aac_dec_handle).samples_per_frame,
                        ) as WORD;
                        if error_code != 0 {
                            (*(*aac_dec_handle).pstr_aac_dec_ch_info[RIGHT as usize])
                            ...
                            current_block = 6697744929136176737;
                        } else {
                            (*(*aac_dec_handle).pstr_aac_dec_ch_info[RIGHT as usize])
                                .str_ics_info = (*pstr_aac_dec_ch_info_0).str_ics_info;
                            ixheaacd_read_ms_data(it_bit_buff, pstr_aac_dec_ch_info_0);
                            if object_type == AOT_ER_AAC_LD as core::ffi::c_int {
                                ...
                                if temp != 0 as core::ffi::c_int {
                                        ...
                                        && is_init == 0
                                    {
                                        ...
                                        return temp as WORD32
                                    }
                                }
                            }
                            current_block = 7861468292440400254;
                        }
                    } else {
                        current_block = 7861468292440400254;
                    }
            ...
            match current_block {
                10878888195156817878 => {
                    (*p_obj_exhaacplus_dec).aac_config.element_type[*ch_idx as usize] = (ele_ch
                        as core::ffi::c_int - 1 as core::ffi::c_int) as WORD32;
                }
                _ => {}
            }
            if object_type == AOT_ER_AAC_LC as core::ffi::c_int || eld_sbr_flag == 0 {
                let mut cnt_bits_0: WORD32 = 0;
                cnt_bits_0 = (*it_bit_buff).cnt_bits;
                (*(*p_obj_exhaacplus_dec).p_state_aac)
                    .mps_dec_handle
                    .ldmps_config
                    .no_ldsbr_present = 1 as core::ffi::c_int as WORD32;
                if cnt_bits_0 >= 8 as core::ffi::c_int {
                ...
                if (*it_bit_buff).cnt_bits != 0 {
                    let mut alignment: WORD32 = (*it_bit_buff).bit_pos & 0x7 as WORD32;
                    (*it_bit_buff).cnt_bits = ((*it_bit_buff).cnt_bits
                        as core::ffi::c_int + alignment as core::ffi::c_int
                ...
                || eld_sbr_flag == 0
            {
                let mut bits_decoded_0: WORD32 = 0;
                let mut cnt_bits_1: WORD32 = 0;
                bits_decoded_0 = (*it_bit_buff).size - (*it_bit_buff).cnt_bits;
                cnt_bits_1 = frame_size * 8 as WORD32 - bits_decoded_0;
                if object_type == AOT_ER_AAC_LC as core::ffi::c_int {
                    cnt_bits_1 = (*it_bit_buff).cnt_bits;
                }
                (*(*p_obj_exhaacplus_dec).p_state_aac)
                    .mps_dec_handle
                    .ldmps_config
                    .no_ldsbr_present = 1 as core::ffi::c_int as WORD32;
                if cnt_bits_1 >= 8 as core::ffi::c_int {
                    error_code = ixheaacd_extension_payload(
                        it_bit_buff,
                        &mut cnt_bits_1,
                        &mut (*(*p_obj_exhaacplus_dec).p_state_aac).mps_dec_handle,
                ...
                if (object_type == AOT_ER_AAC_ELD as core::ffi::c_int
                    || object_type == AOT_ER_AAC_LD as core::ffi::c_int)
                    && (*p_obj_exhaacplus_dec).aac_config.ld_decoder
                        != 1 as core::ffi::c_int
                {
                    if (*it_bit_buff).cnt_bits != 0 {
                        let mut alignment_0: WORD32 = (*it_bit_buff).bit_pos
                            & 0x7 as WORD32;
                        (*it_bit_buff).cnt_bits = ((*it_bit_buff).cnt_bits
                            as core::ffi::c_int + alignment_0 as core::ffi::c_int
                            & 7 as core::ffi::c_int) as WORD32;
                        (*it_bit_buff).bit_pos = 7 as core::ffi::c_int as WORD32;
                        (*it_bit_buff).ptr_read_next = ((*it_bit_buff).ptr_read_next)
                            .offset(1);
                    }
                } else if (*it_bit_buff).bit_pos != 7 as core::ffi::c_int {
                    let mut alignment_1: WORD32 = (*it_bit_buff).bit_pos & 0x7 as WORD32;
                    (*it_bit_buff).cnt_bits
                        -= alignment_1 as core::ffi::c_int + 1 as core::ffi::c_int;
                    (*it_bit_buff).bit_pos
                        += (7 as WORD32 - alignment_1) as core::ffi::c_int;
                    (*it_bit_buff).ptr_read_next = ((*it_bit_buff).ptr_read_next)
                        .offset(1);
                }
            } else {
                let mut bits_decoded_1: WORD32 = 0;
                let mut cnt_bits_2: WORD32 = 0;
                bits_decoded_1 = (*it_bit_buff).size - (*it_bit_buff).cnt_bits;
                cnt_bits_2 = frame_size * 8 as WORD32 - bits_decoded_1;
                if adtsheader as core::ffi::c_int == 1 as core::ffi::c_int {
                    if cnt_bits_2 > (*it_bit_buff).cnt_bits {
                        if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0
                            && is_init == 0
                        {
                            (*aac_dec_handle).frame_status = 0 as core::ffi::c_int
                ...
                ixheaacd_check_for_sbr_payload(
                    it_bit_buff,
                    (*aac_dec_handle).pstr_sbr_bitstream,
                    (ch_config as core::ffi::c_int - 1 as core::ffi::c_int) as WORD16,
                    pstr_drc_dec,
                    object_type,
                    adtsheader as WORD32,
                    cnt_bits_2,
    ...
    if (err != 0 || (*aac_dec_handle).frame_status == 0 as core::ffi::c_int
        || frame_status == 0 as core::ffi::c_int) && is_init == 0
    {
        if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0 {
            (*aac_dec_handle).frame_status = 0 as core::ffi::c_int as FLAG;
            error_code = 0 as core::ffi::c_int as WORD;
            num_ch = channel as WORD32;
            ele_type = ID_END as core::ffi::c_int as WORD;
            (*p_obj_exhaacplus_dec).aac_config.frame_status = 0 as core::ffi::c_int
                as WORD32;
            (*it_bit_buff).cnt_bits = 0 as core::ffi::c_int as WORD32;
            (*aac_dec_handle).byte_align_bits = 0 as core::ffi::c_int as WORD32;
        } else {
            return err
        }
    }
    if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0
        && (*aac_dec_handle).conceal_count == 0 as core::ffi::c_int
    {
        ch = 0 as core::ffi::c_int as WORD;
        while ch < channel {
            ixheaacd_aac_ec_init(
                &mut (**((*aac_dec_handle).ptr_aac_dec_static_channel_info)
                    .as_mut_ptr()
                    .offset(ch as isize))
                    .str_ec_state,
            );
    ...
    if ele_type == ID_END as core::ffi::c_int
        && (*p_state_enhaacplus_dec).bs_format == LOAS_BSFORMAT
    {
        let mut tmp: WORD32 = 0;
        tmp = (*latm_element)
            .layer_info[0 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
            .frame_len_bits as WORD32
        ...
        if (*latm_element).other_data_present != 0 {
            let mut count_bits: WORD32 = (*latm_element).other_data_length as WORD32;
    ...
    if object_type == AOT_ER_AAC_LD as core::ffi::c_int {
        ...
        while ch < channel {
            (*(*aac_dec_handle).ptr_aac_dec_static_channel_info[ch as usize])
                .ltp_lag_1 = (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize])
                .str_ics_info
                .ltp2
                .lag;
            (*(*aac_dec_handle).ptr_aac_dec_static_channel_info[ch as usize])
                .ltp_lag_2 = (*(*aac_dec_handle).pstr_aac_dec_ch_info[ch as usize])
                .str_ics_info
                .ltp
                .lag;
            ch += 1;
    ...
    (*aac_dec_handle).frame_status = ((*aac_dec_handle).frame_status != 0
        && frame_status != 0) as core::ffi::c_int as FLAG;
    (*aac_dec_handle).channels = num_ch as WORD16;
    if error_code == 0 as core::ffi::c_int {
        if skip_full_decode == 0 as core::ffi::c_int
            || skip_full_decode == 1 as core::ffi::c_int && error_code != 0
        {
            let mut str_ics_info: [ia_ics_info_struct; 2] = [ia_ics_info_struct {
                window_shape: 0,
                window_sequence: 0,
                max_sfb: 0,
                num_swb_window: 0,
            ...
            let mut spec_coef: [*mut WORD32; 2] = [0 as *mut WORD32; 2];
            let mut scratch: [*mut WORD32; 2] = [0 as *mut WORD32; 2];
            ch = 0 as core::ffi::c_int as WORD;
            while ch < channel {
                str_ics_info[ch as usize] = (*(*aac_dec_handle)
                    .pstr_aac_dec_ch_info[ch as usize])
                    .str_ics_info;
                spec_coef[ch as usize] = (*(*aac_dec_handle)
                    .pstr_aac_dec_ch_info[ch as usize])
                    .ptr_spec_coeff;
                ch += 1;
            }
            scratch[0 as core::ffi::c_int as usize] = (*aac_scratch_ptrs)
                .extra_scr_4k[2 as core::ffi::c_int as usize] as *mut WORD32;
            scratch[1 as core::ffi::c_int as usize] = (*aac_scratch_ptrs)
                .extra_scr_4k[1 as core::ffi::c_int as usize] as *mut WORD32;
            error_code = ixheaacd_drc_map_channels(
                pstr_drc_dec,
                (*aac_dec_handle).channels as WORD32,
                (*(*aac_dec_handle).pstr_aac_dec_ch_info[0 as core::ffi::c_int as usize])
                    .str_ics_info
                    .frame_length as WORD32,
            ) as WORD;
            if error_code != 0 {
                if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0 && is_init == 0
                {
                    error_code = 0 as core::ffi::c_int as WORD;
                    (*aac_dec_handle).frame_status = 0 as core::ffi::c_int as FLAG;
                } else {
            ...
            ch = 0 as core::ffi::c_int as WORD;
            while ch < (*aac_dec_handle).channels as core::ffi::c_int {
                let mut overlap1: *mut WORD32 = (*(*aac_dec_handle)
                    .ptr_aac_dec_static_channel_info[ch as usize])
                    .overlap_add_data
                    .ptr_overlap_buf;
                let mut ptr_long_window_next: *const WORD16 = (*(*aac_dec_handle)
                    .ptr_aac_dec_static_channel_info[ch as usize])
                    .ptr_long_window[str_ics_info[ch as usize].window_shape
                    as core::ffi::c_int as usize];
                let mut ptr_short_window_next: *const WORD16 = (*(*aac_dec_handle)
                    .ptr_aac_dec_static_channel_info[ch as usize])
                    .ptr_short_window[str_ics_info[ch as usize].window_shape
                    as core::ffi::c_int as usize];
                if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0 {
                    let mut pstr_aac_dec_channel_info: *mut ia_aac_dec_channel_info_struct = (*aac_dec_handle)
                        .pstr_aac_dec_ch_info[ch as usize];
                    let mut pstr_aac_dec_static_channel_info: *mut ia_aac_dec_channel_info = (*aac_dec_handle)
                        .ptr_aac_dec_static_channel_info[ch as usize];
                    let mut ppstr_aac_dec_channel_info: *mut *mut ia_aac_dec_channel_info_struct = &mut pstr_aac_dec_channel_info;
                    let mut ppstr_aac_dec_static_channel_info: *mut *mut ia_aac_dec_channel_info = &mut pstr_aac_dec_static_channel_info;
                    let mut pstr_audio_specific_config: *mut ia_audio_specific_config_struct = 0
                        as *mut ia_audio_specific_config_struct;
                    pstr_audio_specific_config = (*p_state_enhaacplus_dec)
                        .ia_audio_specific_config
                        as *mut ia_audio_specific_config_struct;
                    if str_ics_info[ch as usize].max_sfb as core::ffi::c_int
                        > str_ics_info[ch as usize].num_swb_window as core::ffi::c_int
                    {
                        (*aac_dec_handle).frame_status = 0 as core::ffi::c_int as FLAG;
                    }
                    ixheaacd_aac_apply_ec(
                        &mut (**ppstr_aac_dec_static_channel_info).str_ec_state,
                        *ppstr_aac_dec_channel_info,
                        &*ixheaacd_samp_rate_info
                            .as_ptr()
                            .offset(
                                (*pstr_audio_specific_config).samp_frequency_index as isize,
                            ),
                        (*aac_dec_handle).samples_per_frame,
                        &mut *str_ics_info.as_mut_ptr().offset(ch as isize),
                        (*aac_dec_handle).frame_status as WORD32,
                    );
                    (*aac_dec_handle).conceal_count = ((*aac_dec_handle).conceal_count
                        as core::ffi::c_int + 1 as core::ffi::c_int) as WORD32;
                    if (*aac_dec_handle).frame_status != 0 {
                        (*aac_dec_handle).sbr_num_elements = (*(*aac_dec_handle)
                            .pstr_sbr_bitstream)
                            .no_elements;
                    } else {
                        (*(*aac_dec_handle).pstr_sbr_bitstream).no_elements = (*aac_dec_handle)
                            .sbr_num_elements;
                    }
                    if first_frame == 1 as core::ffi::c_int {
                        skip_full_decode = 1 as core::ffi::c_int as WORD;
                    } else {
                        skip_full_decode = 0 as core::ffi::c_int as WORD;
                    }
                }
                if (*pstr_drc_dec).drc_on != 0 {
                    ixheaacd_drc_apply(
                        pstr_drc_dec,
                        spec_coef[ch as usize],
                        str_ics_info[ch as usize].window_sequence as WORD32,
                        ch as WORD32,
                        str_ics_info[ch as usize].frame_length as WORD32,
                ...
                if skip_full_decode == 0 as core::ffi::c_int {
                    ixheaacd_imdct_process(
                        ...
                        spec_coef[ch as usize],
                        &mut *str_ics_info.as_mut_ptr().offset(ch as isize),
                        time_data.offset(slot_element as isize)
                    ...
                    if !slot_pos.is_null() {
                        *slot_pos = slot_element as UWORD8;
                    }
                    if (*(*p_obj_exhaacplus_dec).p_state_aac).qshift_cnt
                        as core::ffi::c_int > 15 as core::ffi::c_int
                    {
                        return IA_FATAL_ERROR as WORD32;
                    }
                    let fresh0 = (*(*p_obj_exhaacplus_dec).p_state_aac).qshift_cnt;
                    (*(*p_obj_exhaacplus_dec).p_state_aac).qshift_cnt = ((*(*p_obj_exhaacplus_dec)
                        .p_state_aac)
                        .qshift_cnt)
                        .wrapping_add(1);
                    (*(*p_obj_exhaacplus_dec).p_state_aac).qshift_adj[fresh0 as usize] = str_ics_info[ch
                            as usize]
                        .qshift_adj;
                    (*(*aac_dec_handle).ptr_aac_dec_static_channel_info[ch as usize])
                        .overlap_add_data
                        .win_shape = str_ics_info[ch as usize].window_shape;
                    (*(*aac_dec_handle).ptr_aac_dec_static_channel_info[ch as usize])
                        .overlap_add_data
                        .win_seq = str_ics_info[ch as usize].window_sequence;
                    if object_type == AOT_ER_AAC_LD as core::ffi::c_int
                        || object_type == AOT_AAC_LTP as core::ffi::c_int
                    {
                        if str_ics_info[ch as usize].window_sequence as core::ffi::c_int
                            == ONLY_LONG_SEQUENCE
                            || str_ics_info[ch as usize].window_sequence
                                as core::ffi::c_int == LONG_STOP_SEQUENCE
                        {
                            ixheaacd_lt_update_state(
                                ...
                                (*aac_dec_handle).samples_per_frame,
                                object_type,
                                ch_fac as WORD16 as WORD32,
                                str_ics_info[ch as usize].window_sequence,
                                ptr_long_window_next as *mut WORD16,
                                slot_element,
                            );
                        } else {
                            ixheaacd_lt_update_state(
                                ...
                                ch_fac as WORD16 as WORD32,
                                str_ics_info[ch as usize].window_sequence,
                                ptr_short_window_next as *mut WORD16,
                                slot_element,
                            );
                        }
                    }
                    if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0 {
                        let mut pstr_aac_dec_static_channel_info_0: *mut ia_aac_dec_channel_info = (*aac_dec_handle)
                            .ptr_aac_dec_static_channel_info[ch as usize];
                        let mut pstr_ec_state: *mut ia_ec_state_str = &mut (*pstr_aac_dec_static_channel_info_0)
                            .str_ec_state;
                        let mut k: WORD32 = 0;
                        if (*pstr_ec_state).fade_idx < MAX_FADE_FRAMES {
                            let mut fade_fac: WORD32 = ia_ec_fade_factors_fix[(*pstr_ec_state)
                                .fade_idx as usize];
                            k = 0 as core::ffi::c_int as WORD32;
                            while k
                                < str_ics_info[ch as usize].frame_length as core::ffi::c_int
                            {
                                *time_data.offset(k as isize) = ixheaac_mul32_sh(
                                    *time_data.offset(k as isize),
                                    fade_fac,
                                    30 as WORD8,
                                );
                                k += 1;
                            ...
                            memset(
                                ...
                                0 as core::ffi::c_int,
                                (str_ics_info[ch as usize].frame_length as size_t)
    ...
    if ele_type == ID_END as core::ffi::c_int {
        if (*p_obj_exhaacplus_dec).aac_config.ui_err_conceal != 0 {
            if err != 0 && is_init == 0 {
                ...
                ixheaacd_byte_align(it_bit_buff, &mut (*aac_dec_handle).byte_align_bits);
                if (*p_state_enhaacplus_dec).bs_format == LOAS_BSFORMAT {
                    ixheaacd_byte_align(
                        it_bit_buff,
                        &mut (*it_bit_buff).audio_mux_align,
                    );
                }
            }
        } else {
            ixheaacd_byte_align(it_bit_buff, &mut (*aac_dec_handle).byte_align_bits);
            if (*p_state_enhaacplus_dec).bs_format == LOAS_BSFORMAT {
                ixheaacd_byte_align(it_bit_buff, &mut (*it_bit_buff).audio_mux_align);
            }
        }
    }
    *type_0 = ele_type;
    (*aac_dec_handle).block_number = ixheaac_add32(
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_extension_payload(
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut cnt: *mut WORD32,
    mut self_0: *mut ia_mps_dec_state_struct,
) -> WORD32 {
    let mut extension_type: WORD16 = 0;
    let mut len: WORD32 = 0;
    let mut add_len: WORD32 = 0;
    let mut i: WORD32 = 0;
    let mut fill_nibble: WORD32 = 0;
    let mut err: WORD32 = 0 as WORD32;
    extension_type = ixheaacd_read_bits_buf(it_bit_buff, 4 as WORD) as WORD16;
    match extension_type as core::ffi::c_int {
        EXT_FILL_DATA => {
            fill_nibble = ixheaacd_read_bits_buf(it_bit_buff, 4 as WORD);
            if fill_nibble == 0 as core::ffi::c_int {
                i = 0 as core::ffi::c_int as WORD32;
                while i < (*cnt >> 3 as core::ffi::c_int) - 1 as core::ffi::c_int {
                    if (*it_bit_buff).cnt_bits >= 8 as core::ffi::c_int {
                ...
                err = -(1 as core::ffi::c_int) as WORD32;
            }
            *cnt = (*it_bit_buff).cnt_bits;
        }
        EXT_DATA_LENGTH => {
            len = ixheaacd_read_bits_buf(it_bit_buff, 4 as WORD);
            if len == 15 as core::ffi::c_int {
                add_len = ixheaacd_read_bits_buf(it_bit_buff, 8 as WORD);
                len += add_len;
                if add_len == 255 as core::ffi::c_int {
                    len += ixheaacd_read_bits_buf(it_bit_buff, 16 as WORD);
                }
            }
            len <<= 3 as core::ffi::c_int;
            ixheaacd_extension_payload(it_bit_buff, cnt, self_0);
        }
        EXT_LDSAC_DATA => {
            ...
            if (*self_0).ldmps_config.ldmps_present_flag == 1 as UINT32 {
                err = ixheaacd_ld_mps_frame_parsing(self_0, it_bit_buff) as WORD32;
                if err != 0 {
                    return err;
                }
            }
        ...
        EXT_FIL | _ => {
            i = 0 as core::ffi::c_int as WORD32;
            while i < *cnt - 4 as core::ffi::c_int {
                ixheaacd_skip_bits_buf(it_bit_buff, 1 as WORD);
                i += 1;
            }
            *cnt = (*it_bit_buff).cnt_bits;
        }
