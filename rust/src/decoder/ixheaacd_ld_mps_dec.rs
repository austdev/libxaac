extern "C" {
    ...
    fn ixheaacd_mps_qmf_hyb_analysis(self_0: *mut ia_mps_dec_state_struct) -> VOID;
    fn ixheaacd_mps_create_w(self_0: *mut ia_mps_dec_state_struct) -> VOID;
}
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_ld_qmf_analysis(
    mut self_0: *mut ia_mps_dec_state_struct,
    mut output_buf: *mut WORD16,
) -> WORD32 {
    let mut p_arr_qmf_buf_real: [*mut WORD32; 76] = [0 as *mut WORD32; 76];
    let mut p_arr_qmf_buf_imag: *mut *mut WORD32 = &mut *p_arr_qmf_buf_real
        .as_mut_ptr()
        .offset(MAX_ENV_COLS as isize) as *mut *mut WORD32;
    let mut temp_arr: [WORD32; 4096] = [0; 4096];
    let mut ptr: *mut WORD32 = &mut *temp_arr
        .as_mut_ptr()
        .offset(0 as core::ffi::c_int as isize) as *mut WORD32;
    let mut in_gain_n_q8_fac: core::ffi::c_float = (*self_0).input_gain
        as core::ffi::c_float * 0.00390625f32;
    let mut i: core::ffi::c_int = 0;
    let mut ts: WORD32 = 0;
    ts = 2 as core::ffi::c_int as WORD32;
    while ts < (*self_0).time_slots as core::ffi::c_int + 2 as core::ffi::c_int {
        p_arr_qmf_buf_real[ts as usize] = ptr;
        ptr = ptr.offset(NO_SYNTHESIS_CHANNELS as isize);
        let ref mut fresh0 = *p_arr_qmf_buf_imag.offset(ts as isize);
        *fresh0 = ptr;
        ptr = ptr.offset(NO_SYNTHESIS_CHANNELS as isize);
        ts += 1;
    }
    (*self_0).str_mps_qmf_bank.num_time_slots = (*self_0).time_slots as WORD16;
    (*self_0).str_mps_qmf_bank.no_channels = (*self_0).qmf_band_count;
    ixheaacd_cplx_anal_qmffilt_32(
        output_buf as *mut WORD32,
        (*self_0).str_sbr_scale_fact,
        &mut *p_arr_qmf_buf_real.as_mut_ptr().offset(0 as core::ffi::c_int as isize),
        &mut *p_arr_qmf_buf_imag.offset(0 as core::ffi::c_int as isize),
        &mut (*self_0).str_mps_qmf_bank,
        (*self_0).qmf_dec_tables_ptr,
        2 as WORD,
        0 as WORD32,
    );
    ...
    while ts < (*self_0).time_slots {
        ...
        while i < (*self_0).qmf_band_count {
            (*self_0)
                .qmf_in[0 as core::ffi::c_int as usize][ts as usize][i as usize]
                .re = (*(p_arr_qmf_buf_real[(ts as core::ffi::c_int
                + 2 as core::ffi::c_int) as usize])
                .offset(i as isize) as core::ffi::c_float * in_gain_n_q8_fac) as FLOAT32;
            (*self_0)
                .qmf_in[0 as core::ffi::c_int as usize][ts as usize][i as usize]
                .im = (*(*p_arr_qmf_buf_imag
                .offset((ts as core::ffi::c_int + 2 as core::ffi::c_int) as isize))
                .offset(i as isize) as core::ffi::c_float * in_gain_n_q8_fac) as FLOAT32;
            i += 1;
        }
        ts += 1;
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_ld_mps_apply(
    mut p_obj_exhaacplus_dec: *mut ia_exhaacplus_dec_api_struct,
    mut output_buf: *mut WORD16,
) -> WORD32 {
    let mut aac_handle: *mut ia_aac_dec_state_struct = (*p_obj_exhaacplus_dec)
        .p_state_aac;
    let mut mps_handle: *mut ia_mps_dec_state_struct = &mut (*aac_handle).mps_dec_handle;
    let mut err: WORD32 = 0 as WORD32;
    let mut ts: WORD32 = 0;
    let mut i: WORD32 = 0;
    let mut pstr_dec_data: *mut ia_dec_data_struct = (*aac_handle).pstr_dec_data
        as *mut ia_dec_data_struct;
    let mut pstr_usac_data: *mut ia_usac_data_struct = &mut (*pstr_dec_data)
        .str_usac_data;
    (*mps_handle).hyb_band_count[0 as core::ffi::c_int as usize] = (*mps_handle)
        .hyb_band_count_max;
    (*mps_handle).hyb_band_count[1 as core::ffi::c_int as usize] = (*mps_handle)
        .hyb_band_count_max;
    err = ixheaacd_mps_frame_decode(mps_handle) as WORD32;
    if err != IA_NO_ERROR {
        return err;
    }
    if (*aac_handle).mps_dec_handle.num_parameter_sets_prev <= 0 as core::ffi::c_int {
        return IA_FATAL_ERROR as WORD32;
    }
    if (*mps_handle).ldmps_config.bs_tree_config == 7 as UINT32 {
        ixheaacd_pre_and_mix_matrix_calculation(&mut (*aac_handle).mps_dec_handle);
        ixheaacd_mps_pre_matrix_mix_matrix_smoothing(&mut (*aac_handle).mps_dec_handle);
    }
    (*mps_handle).output_buffer = ((*pstr_usac_data).time_sample_vector).as_mut_ptr()
        as *mut [FLOAT32; 4096];
    if (*mps_handle).ldmps_config.no_ldsbr_present != 0 {
        ixheaacd_ld_qmf_analysis(mps_handle, output_buf);
    } else {
        ts = 0 as core::ffi::c_int as WORD32;
        while ts < (*mps_handle).time_slots {
            let mut qmf_re: *mut FLOAT32 = ((*(*(*(*p_obj_exhaacplus_dec).p_state_aac)
                .str_sbr_dec_info[0 as core::ffi::c_int as usize])
                .pstr_sbr_channel[0 as core::ffi::c_int as usize])
                .str_sbr_dec
                .mps_qmf_buf_real[(ts as core::ffi::c_int + 2 as core::ffi::c_int)
                as usize])
                .as_mut_ptr();
            let mut qmf_im: *mut FLOAT32 = ((*(*(*(*p_obj_exhaacplus_dec).p_state_aac)
                .str_sbr_dec_info[0 as core::ffi::c_int as usize])
                .pstr_sbr_channel[0 as core::ffi::c_int as usize])
                .str_sbr_dec
                .mps_qmf_buf_imag[(ts as core::ffi::c_int + 2 as core::ffi::c_int)
                as usize])
                .as_mut_ptr();
            i = 0 as core::ffi::c_int as WORD32;
            while i < (*mps_handle).qmf_band_count {
                (*mps_handle)
                    .qmf_in[0 as core::ffi::c_int as usize][ts as usize][i as usize]
                    .re = *qmf_re.offset(i as isize) * (*mps_handle).input_gain;
                (*mps_handle)
                    .qmf_in[0 as core::ffi::c_int as usize][ts as usize][i as usize]
                    .im = *qmf_im.offset(i as isize) * (*mps_handle).input_gain;
                i += 1;
            }
            ts += 1;
        }
    ...
    (*mps_handle).bs_high_rate_mode = 1 as core::ffi::c_int as WORD32;
    ixheaacd_mps_apply_pre_matrix(mps_handle);
    ixheaacd_mps_create_w(mps_handle);
    if (*mps_handle).res_bands | (*mps_handle).pre_mix_req == 0
        && (*(*mps_handle).config).bs_phase_coding == 0 as UINT32
    {
        ixheaacd_mps_apply_mix_matrix_type1(mps_handle);
    } else if (*mps_handle).pre_mix_req != 0 {
        ixheaacd_mps_apply_mix_matrix_type2(mps_handle);
    } else {
        ixheaacd_mps_apply_mix_matrix_type3(mps_handle);
    }
    if (*mps_handle).ldmps_config.bs_temp_shape_config == 2 as UINT32 {
        ixheaacd_mps_time_env_shaping(mps_handle);
    }
    err = ixheaacd_mps_temp_process(mps_handle);
    (*mps_handle).pre_mix_req = 0 as core::ffi::c_int as WORD32;
    if err != 0 {
        return err;
    }
    return err;
