extern "C" {
    ...
    fn ixheaacd_calc_m1m2_emm(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_5151(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_5152(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_51s1(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_51s2(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_5227(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_5251(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_7271(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_7272(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_7571(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_calc_m1m2_7572(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
}
...
pub const POINT_THREE_THREE_Q15: core::ffi::c_int = 10813 as core::ffi::c_int;
pub const PBXPS: core::ffi::c_int = 224 as core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_buffer_m1(
    ...
    let mut persistent_mem: *mut ia_mps_persistent_mem = &mut (*pstr_mps_state)
        .mps_persistent_mem;
    ...
    let mut m1_param_real: *mut WORD32 = 0 as *mut WORD32;
    let mut m1_param_imag: *mut WORD32 = 0 as *mut WORD32;
    let mut p_m1_param_real: *mut WORD32 = 0 as *mut WORD32;
    let mut p_m1_param_re: *mut WORD32 = 0 as *mut WORD32;
    let mut num_parameter_bands: WORD32 = (*pstr_mps_state).num_parameter_bands;
    let mut num_v_channels: WORD32 = (*pstr_mps_state).num_v_channels;
    ...
    let mut num_parameter_sets_prev: WORD32 = 0;
    ...
    if m1_param_imag_present != 0 {
        let mut p_m1_param_imag: *mut WORD32 = &mut *(*(*(*((*m1_param).m1_param_imag)
            .as_mut_ptr()
        ...
        p_m1_param_real = &mut *(*(*(*((*m1_param).m1_param_real)
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize))
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize))
        ...
        while row < num_v_channels {
            let mut p_m1_param_im: *mut WORD32 = p_m1_param_imag;
            p_m1_param_re = p_m1_param_real;
            col = 0 as core::ffi::c_int as WORD32;
            while col < num_x_channels {
                m1_param_real = p_m1_param_re
                    .offset(
                        ((num_parameter_sets_prev as core::ffi::c_int
                            - 1 as core::ffi::c_int) * MAX_PARAMETER_BANDS) as isize,
                    );
                m1_param_imag = p_m1_param_im
                    .offset(
                        ((num_parameter_sets_prev as core::ffi::c_int
                            - 1 as core::ffi::c_int) * MAX_PARAMETER_BANDS) as isize,
                    );
                ...
                while pb < num_parameter_bands {
                    let fresh0 = m1_param_real;
                    m1_param_real = m1_param_real.offset(1);
                    let fresh1 = m1_param_real_prev;
                    m1_param_real_prev = m1_param_real_prev.offset(1);
                    *fresh1 = *fresh0;
                    let fresh2 = m1_param_imag;
                    m1_param_imag = m1_param_imag.offset(1);
                    let fresh3 = m1_param_imag_prev;
                    m1_param_imag_prev = m1_param_imag_prev.offset(1);
                    *fresh3 = *fresh2;
                    pb += 1;
                }
                p_m1_param_re = p_m1_param_re.offset(PBXPS as isize);
                p_m1_param_im = p_m1_param_im.offset(PBXPS as isize);
                col += 1;
            }
            p_m1_param_real = p_m1_param_real
                .offset((MAX_INPUT_CHANNELS_MPS * PBXPS) as isize);
            p_m1_param_imag = p_m1_param_imag
                .offset((MAX_INPUT_CHANNELS_MPS * PBXPS) as isize);
            row += 1;
        }
    } else {
        ...
        while row < num_v_channels {
            ...
            while col < num_x_channels {
                ...
                pb = 0 as core::ffi::c_int as WORD32;
                while pb < num_parameter_bands {
                    let fresh4 = m1_param_real;
                    m1_param_real = m1_param_real.offset(1);
                    let fresh5 = m1_param_real_prev;
                    m1_param_real_prev = m1_param_real_prev.offset(1);
                    *fresh5 = *fresh4;
                    pb += 1;
                }
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_buffer_m2(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    ...
    let mut row: WORD32 = 0;
    let mut col: WORD32 = 0;
    let mut col_counter: WORD32 = num_direct_signals
        + (*pstr_mps_state).num_decor_signals;
    let mut persistent_mem: *mut ia_mps_persistent_mem = &mut (*pstr_mps_state)
        .mps_persistent_mem;
    let mut m2_param: *mut ia_mps_dec_m2_param_struct = (*(*pstr_mps_state).aux_struct)
        .m2_param;
    ...
    let mut m2_decor_real: *mut WORD32 = 0 as *mut WORD32;
    let mut m2_decor_imag: *mut WORD32 = 0 as *mut WORD32;
    let mut m2_resid_real: *mut WORD32 = 0 as *mut WORD32;
    let mut m2_resid_imag: *mut WORD32 = 0 as *mut WORD32;
    let mut idx: WORD32 = -(1 as WORD32);
    let mut resid_col_counter: WORD32 = 0;
    let mut num_parameter_bands: WORD32 = (*pstr_mps_state).num_parameter_bands;
    let mut num_output_channels: WORD32 = (*pstr_mps_state).num_output_channels;
    let mut num_parameter_sets_prev: WORD32 = (*pstr_mps_state).num_parameter_sets_prev;
    if (*pstr_mps_state).residual_coding != 0 {
        resid_col_counter = col_counter;
    } else {
        resid_col_counter = num_direct_signals;
    }
    if (*pstr_mps_state).m2_param_imag_present != 0 {
        row = 0 as core::ffi::c_int as WORD32;
        while row < num_output_channels {
            col = num_direct_signals;
            while col < col_counter {
                if (*pstr_mps_state).m2_param_present[row as usize][col as usize]
                    & 1 as core::ffi::c_int != 0
                {
                    idx += 1;
                    m2_decor_real = &mut *(*(*((*m2_param).m2_decor_real)
                        .as_mut_ptr()
                        .offset(idx as isize))
                        .as_mut_ptr()
                        .offset(
                    ...
                    pb = 0 as core::ffi::c_int as WORD32;
                    while pb < num_parameter_bands {
                        let fresh6 = m2_decor_real;
                        m2_decor_real = m2_decor_real.offset(1);
                        let fresh7 = m2_decor_real_prev;
                        m2_decor_real_prev = m2_decor_real_prev.offset(1);
                        *fresh7 = *fresh6;
                        pb += 1;
                    }
                    m2_decor_imag = &mut *(*(*((*m2_param).m2_decor_imag)
                        .as_mut_ptr()
                        .offset(idx as isize))
                        .as_mut_ptr()
                        .offset(
                    ...
                    pb = 0 as core::ffi::c_int as WORD32;
                    while pb < num_parameter_bands {
                        let fresh8 = m2_decor_imag;
                        m2_decor_imag = m2_decor_imag.offset(1);
                        let fresh9 = m2_decor_imag_prev;
        ...
        while row < num_output_channels {
            ...
            while col < resid_col_counter {
                ...
                {
                    idx += 1;
                    m2_resid_real = &mut *(*(*((*m2_param).m2_resid_real)
                        .as_mut_ptr()
                        .offset(idx as isize))
                        .as_mut_ptr()
                        .offset(
                    ...
                    pb = 0 as core::ffi::c_int as WORD32;
                    while pb < num_parameter_bands {
                        let fresh10 = m2_resid_real;
                        m2_resid_real = m2_resid_real.offset(1);
                        let fresh11 = m2_resid_real_prev;
                        m2_resid_real_prev = m2_resid_real_prev.offset(1);
                        *fresh11 = *fresh10;
                        pb += 1;
                    }
                    m2_resid_imag = &mut *(*(*((*m2_param).m2_resid_imag)
                        .as_mut_ptr()
                        .offset(idx as isize))
                        .as_mut_ptr()
                        .offset(
                    ...
                    pb = 0 as core::ffi::c_int as WORD32;
                    while pb < num_parameter_bands {
                        let fresh12 = m2_resid_imag;
                        m2_resid_imag = m2_resid_imag.offset(1);
                        let fresh13 = m2_resid_imag_prev;
        ...
        while row < num_output_channels {
            ...
            while col < col_counter {
                    ...
                    & 1 as core::ffi::c_int != 0
                {
                    ...
                    pb = 0 as core::ffi::c_int as WORD32;
                    while pb < num_parameter_bands {
                        let fresh14 = m2_decor_real;
                        m2_decor_real = m2_decor_real.offset(1);
                        let fresh15 = m2_decor_real_prev;
                        m2_decor_real_prev = m2_decor_real_prev.offset(1);
                        *fresh15 = *fresh14;
                        pb += 1;
                    }
        ...
        while row < num_output_channels {
            ...
            while col < resid_col_counter {
                    ...
                    & 2 as core::ffi::c_int != 0
                {
                    ...
                    pb = 0 as core::ffi::c_int as WORD32;
                    while pb < num_parameter_bands {
                        let fresh16 = m2_resid_real;
                        m2_resid_real = m2_resid_real.offset(1);
                        let fresh17 = m2_resid_real_prev;
                        m2_resid_real_prev = m2_resid_real_prev.offset(1);
                        *fresh17 = *fresh16;
                        pb += 1;
                    }
...
unsafe extern "C" fn ixheaacd_update_alpha(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    ...
    let mut arbdmx_alpha: *mut WORD32 = ((*p_aux_struct).arbdmx_alpha).as_mut_ptr();
    let mut n_ch_in: WORD32 = (*pstr_mps_state).num_input_channels;
    let mut ch: WORD32 = 0;
    ch = 0 as core::ffi::c_int as WORD32;
    while ch < n_ch_in {
        let fresh18 = arbdmx_alpha_prev;
        arbdmx_alpha_prev = arbdmx_alpha_prev.offset(1);
        *fresh18 = *arbdmx_alpha.offset(ch as isize);
        if (*pstr_mps_state).arbitrary_downmix == 2 as core::ffi::c_int {
            alpha = *arbdmx_alpha.offset(ch as isize);
            if (*p_aux_struct).arbdmx_residual_abs[ch as usize] != 0 {
                alpha -= POINT_THREE_THREE_Q15;
                if alpha < 0 as core::ffi::c_int {
                    alpha = 0 as core::ffi::c_int as WORD32;
                }
            } else {
                alpha += POINT_THREE_THREE_Q15;
                if alpha > ONE_IN_Q15 {
                    alpha = ONE_IN_Q15 as WORD32;
                }
            }
        } else {
            alpha = ONE_IN_Q15 as WORD32;
        }
        *arbdmx_alpha.offset(ch as isize) = alpha;
        ch += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_calc_m1m2(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut up_mix_type: WORD32 = (*pstr_mps_state).up_mix_type;
    let mut binaural_quality: WORD32 = (*pstr_mps_state).binaural_quality;
    if (*pstr_mps_state).arbitrary_downmix != 0 as core::ffi::c_int {
        ixheaacd_update_alpha(pstr_mps_state);
    }
    match (*pstr_mps_state).tree_config {
        0 => {
        ...
        2 => {
            if up_mix_type == 1 as core::ffi::c_int {
                ...
                if binaural_quality == 1 as core::ffi::c_int {
