extern "C" {
    ...
    fn ixheaacd_param_2_umx_ps_core_tables(
        cld: *mut WORD32,
        icc: *mut WORD32,
        num_ott_bands: WORD32,
        res_bands: WORD32,
        h11: *mut WORD32,
        h12: *mut WORD32,
        h21: *mut WORD32,
        ...
        c_l: *mut WORD16,
        c_r: *mut WORD16,
        ixheaacd_mps_dec_m1_m2_tables: *const ia_mps_dec_m1_m2_tables_struct,
    ) -> VOID;
    fn ixheaacd_quantize_icc(
        v: WORD32,
        ixheaacd_mps_dec_bitdec_tables: *mut ia_mps_dec_bitdec_tables_struct,
    ) -> WORD32;
    fn ixheaacd_quantize_cld(
        v: WORD32,
        ixheaacd_mps_dec_bitdec_tables: *mut ia_mps_dec_bitdec_tables_struct,
    ) -> WORD32;
}
...
pub const MINUS_POINT_NINE_NINE_Q15: core::ffi::c_int = -(32440 as core::ffi::c_int);
...
pub const ABS_THR: core::ffi::c_int = 1 as core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_calc_m1m2_51s1(
    ...
    let mut ps: WORD32 = 0;
    let mut pb: WORD32 = 0;
    let mut iid: *mut WORD32 = 0 as *mut WORD32;
    let mut icc: *mut WORD32 = 0 as *mut WORD32;
    let mut h11: *mut WORD32 = 0 as *mut WORD32;
    let mut h12: *mut WORD32 = 0 as *mut WORD32;
    let mut h21: *mut WORD32 = 0 as *mut WORD32;
    let mut h22: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res: *mut WORD32 = 0 as *mut WORD32;
    let mut c_l: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r: *mut WORD16 = 0 as *mut WORD16;
    ...
    iid = (*pstr_mps_state).mps_scratch_mem_v as *mut WORD32;
    icc = iid
        .offset(
            ((28 as usize)
    ...
    c_l = ((*pstr_mps_state).mps_scratch_mem_v as *mut WORD16)
        .offset(
            ((448 as usize)
    ...
    while ps < num_parameter_sets {
        ...
        while pb < num_parameter_bands {
            let mut p_l_fs: WORD32 = 0;
            let mut p_r_fs: WORD32 = 0;
            let mut p_l_c: WORD32 = 0;
            let mut p_r_c: WORD32 = 0;
            let mut p_l_s: WORD32 = 0;
            let mut p_r_s: WORD32 = 0;
            let mut p_l_f: WORD32 = 0;
            let mut p_r_f: WORD32 = 0;
            let mut left_f: WORD32 = 0;
            let mut right_f: WORD32 = 0;
            let mut center: WORD32 = 0;
            let mut left_s: WORD32 = 0;
            let mut right_s: WORD32 = 0;
            let mut left: WORD32 = 0;
            let mut right: WORD32 = 0;
            ...
            p_l_f = (*(*pstr_mps_state).ia_mps_dec_mps_table.m1_m2_table_ptr)
                .cld_tab_1[((*p_cur_bs)
                .ott_cld_idx[3 as core::ffi::c_int as usize][ps as usize][pb as usize]
                + 15 as core::ffi::c_int) as usize];
            p_r_f = (*(*pstr_mps_state).ia_mps_dec_mps_table.m1_m2_table_ptr)
                .cld_tab_1[(15 as WORD32
                - (*p_cur_bs)
                    .ott_cld_idx[3 as core::ffi::c_int
                    as usize][ps as usize][pb as usize]) as usize];
            left_f = ixheaacd_mps_mult32_shr_15(
                ixheaacd_mps_mult32_shr_15(p_l_fs, p_l_c),
                p_l_f,
            );
            right_f = ixheaacd_mps_mult32_shr_15(
                ixheaacd_mps_mult32_shr_15(p_l_fs, p_l_c),
                p_r_f,
            );
            ...
            temp_1 = ixheaacd_mps_mult32_shr_15(
                temp_1,
                (*p_aux_struct)
                    .ott_icc[3 as core::ffi::c_int as usize][ps as usize][pb as usize],
            );
            ...
            qtemp1 = 15 as WORD16;
            *iid.offset(pb as isize) = 10 as WORD32 * ixheaacd_mps_log10(temp_1, qtemp1)
                >> 1 as core::ffi::c_int;
            temp_1 = ixheaacd_mps_mult32_shr_15(left, right);
            qtemp1 = 15 as WORD16;
            temp_1 = ixheaacd_mps_add32(temp_1, ABS_THR, &mut qtemp1, 30 as WORD16);
            temp_1 = ixheaacd_mps_sqrt(temp_1, &mut qtemp1, sqrt_tab);
            temp_2 = ixheaacd_mps_div_32(cross, temp_1, &mut qtemp2);
            qtemp2 = (qtemp2 as core::ffi::c_int + 15 as core::ffi::c_int
                - qtemp1 as core::ffi::c_int) as WORD16;
            *icc.offset(pb as isize) = ixheaacd_mps_convert_to_qn(
                temp_2,
                qtemp2,
                15 as WORD16,
            );
            if *icc.offset(pb as isize) > ONE_IN_Q15 {
                *icc.offset(pb as isize) = ONE_IN_Q15 as WORD32;
            } else if *icc.offset(pb as isize) < MINUS_POINT_NINE_NINE_Q15 {
                *icc.offset(pb as isize) = MINUS_POINT_NINE_NINE_Q15 as WORD32;
            }
            *iid.offset(pb as isize) = ixheaacd_quantize_cld(
                *iid.offset(pb as isize),
                (*pstr_mps_state).ia_mps_dec_mps_table.bitdec_table_ptr,
            );
            *icc.offset(pb as isize) = ixheaacd_quantize_icc(
                *icc.offset(pb as isize),
                (*pstr_mps_state).ia_mps_dec_mps_table.bitdec_table_ptr,
            );
            pb += 1;
        }
        ...
        memcpy(
            ((*m2_param).m2_decor_real[1 as core::ffi::c_int as usize][ps as usize])
                .as_mut_ptr() as *mut core::ffi::c_void,
            h22 as *const core::ffi::c_void,
            (num_parameter_bands as size_t)
                .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
        );
        memcpy(
            ((*m2_param).m2_resid_real[0 as core::ffi::c_int as usize][ps as usize])
                .as_mut_ptr() as *mut core::ffi::c_void,
            h11 as *const core::ffi::c_void,
            (num_parameter_bands as size_t)
                .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
        );
        memcpy(
            ((*m2_param).m2_resid_real[1 as core::ffi::c_int as usize][ps as usize])
                .as_mut_ptr() as *mut core::ffi::c_void,
            h21 as *const core::ffi::c_void,
            (num_parameter_bands as size_t)
                .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
        );
        ps += 1;
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_calc_m1m2_51s2(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut p_aux_struct: *mut ia_mps_dec_auxilary_struct = (*pstr_mps_state).aux_struct;
    let mut m2_param: *mut ia_mps_dec_m2_param_struct = (*p_aux_struct).m2_param;
    ...
    let mut h12_res: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res: *mut WORD32 = 0 as *mut WORD32;
    let mut g_s: *mut WORD32 = 0 as *mut WORD32;
    let mut c_l: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r: *mut WORD16 = 0 as *mut WORD16;
    let mut sqrt_tab: *const WORD32 = ((*(*pstr_mps_state)
        .ia_mps_dec_mps_table
    ...
    while ps < num_parameter_sets {
        ...
        while pb < num_parameter_bands {
            let mut p_l_c: WORD32 = 0;
            let mut p_r_c: WORD32 = 0;
            let mut p_l_lr: WORD32 = 0;
            let mut p_r_lr: WORD32 = 0;
            let mut left: WORD32 = 0;
            let mut right: WORD32 = 0;
            let mut center: WORD32 = 0;
            let mut cross: WORD32 = 0;
            ...
            center = p_r_c >> 1 as core::ffi::c_int;
            temp_1 = ixheaacd_mps_mult32_shr_15(left, right);
            qtemp1 = 15 as WORD16;
            temp_1 = ixheaacd_mps_sqrt(temp_1, &mut qtemp1, sqrt_tab);
            temp_1 = ixheaacd_mps_convert_to_qn(temp_1, qtemp1, 15 as WORD16);
            cross = ixheaacd_mps_mult32_shr_15(
                temp_1,
                (*p_aux_struct)
                    .ott_icc[1 as core::ffi::c_int as usize][ps as usize][pb as usize],
            );
            ...
            *iid.offset(pb as isize) = 10 as WORD32 * ixheaacd_mps_log10(temp_1, qtemp1)
            ...
            if temp_1 == 0 as core::ffi::c_int {
                temp_1 = 1 as core::ffi::c_int as WORD32;
            }
            *icc.offset(pb as isize) = ixheaacd_mps_div32_in_q15(cross, temp_1);
            temp_1 = ixheaac_add32_sat(left, right);
            qtemp1 = 15 as WORD16;
            temp_1 = ixheaacd_mps_sqrt(temp_1, &mut qtemp1, sqrt_tab);
            *g_s.offset(pb as isize) = ixheaacd_mps_convert_to_qn(
                temp_1,
                qtemp1,
                15 as WORD16,
            );
        ...
        while pb < num_parameter_bands {
            (*m2_param)
                ...
                *g_s.offset(pb as isize),
                *h12.offset(pb as isize),
            );
            (*m2_param)
                .m2_decor_real[1 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *g_s.offset(pb as isize),
                *h22.offset(pb as isize),
            );
            pb += 1;
        }
        pb = 0 as core::ffi::c_int as WORD32;
        while pb < num_parameter_bands {
            (*m2_param)
                ...
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *g_s.offset(pb as isize),
                *h11.offset(pb as isize),
            );
            (*m2_param)
                .m2_resid_real[1 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *g_s.offset(pb as isize),
                *h21.offset(pb as isize),
            );
            pb += 1;
        }
        ps += 1;
