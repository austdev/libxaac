extern "C" {
    ...
    fn ixheaacd_sbr_params(
        core_sbr_frame_len_idx: UWORD32,
        output_frame_length: *mut WORD32,
        block_size: *mut WORD32,
        output_samples: *mut WORD32,
        sampling_freq: *mut WORD32,
        sample_freq_indx: *mut UWORD32,
    ) -> UWORD32;
    static mut ixheaacd_book: ia_huff_code_book_struct;
    fn ixheaacd_hufftab(
        ptr_huff_code_book: *mut ia_huff_code_book_struct,
        ptr_huff_code_word: *const ia_huff_code_word_struct,
        code_book_tbl: *const WORD16,
        index: *const WORD32,
        dim: WORD32,
        lav: WORD32,
        lav_incr_esc: WORD32,
        sign_code_book: WORD32,
        max_code_word_len: UWORD8,
    ) -> VOID;
    fn ixheaacd_usac_ec_init(
        pstr_ec_state: *mut ia_ec_state_str,
        core_coder_mode: WORD32,
    ) -> VOID;
    ...
    fn ixheaacd_init_acelp_data(
        usac_data: *mut ia_usac_data_struct,
        st: ia_usac_lpd_decoder_handle,
    ) -> VOID;
    static ixheaacd_huff_book_scl: [ia_huff_code_word_struct; 0];
    static ixheaacd_book_scl_index: [WORD32; 0];
    static ixheaacd_book_scl_code_book: [WORD16; 0];
    static ixheaacd_samp_rate_info: [ia_usac_samp_rate_info; 0];
    static ixheaacd_sampling_boundaries: [WORD32; 16];
}
...
pub type ia_mps_dec_decorr_dec_handle = *mut C2RustUnnamed_0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const __ASSERT_FUNCTION: [core::ffi::c_char; 128] = unsafe {
    ::core::mem::transmute::<
        [u8; 128],
        [core::ffi::c_char; 128],
    >(
        *b"VOID ixheaacd_info_init(const ia_usac_samp_rate_info *, WORD32, ia_sfb_info_struct *, ia_sfb_info_struct *, WORD16 *, WORD16 *)\0",
    )
};
pub const LEN_SUPERFRAME: core::ffi::c_int = 1024 as core::ffi::c_int;
pub const LEN_FRAME: core::ffi::c_int = 256 as core::ffi::c_int;
pub const MAX_NUM_SUBFR: core::ffi::c_int = 4 as core::ffi::c_int;
pub const FSCALE_DENOM: core::ffi::c_int = 12800 as core::ffi::c_int;
pub const WIN_SEL_0: core::ffi::c_int = 0 as core::ffi::c_int;
pub const MAX_NUM_CHANNELS: core::ffi::c_int = 6 as core::ffi::c_int;
pub const MAX_NUM_CHANNELS_USAC_LVL2: core::ffi::c_int = 2 as core::ffi::c_int;
...
pub const ID_USAC_EXT: core::ffi::c_int = 3 as core::ffi::c_int;
#[no_mangle]
pub static mut ixheaacd_sampl_freq_idx_table: [WORD32; 17] = [
...
unsafe extern "C" fn ixheaacd_info_init(
    mut ptr_samp_info: *const ia_usac_samp_rate_info,
    mut block_size_samples: WORD32,
    mut pstr_sfb_info_long: *mut ia_sfb_info_struct,
    mut pstr_sfb_info_short: *mut ia_sfb_info_struct,
    mut sfb_width_short: *mut WORD16,
    mut sfb_width_long: *mut WORD16,
) -> VOID {
    let mut i: WORD32 = 0;
    let mut j: WORD32 = 0;
    let mut k: WORD32 = 0;
    let mut n: WORD32 = 0;
    let mut ws: WORD32 = 0;
    let mut sfbands: *const WORD16 = 0 as *const WORD16;
    let mut pstr_sfb_info_ip: *mut ia_sfb_info_struct = 0 as *mut ia_sfb_info_struct;
    (*pstr_sfb_info_long).islong = 1 as core::ffi::c_int as WORD32;
    (*pstr_sfb_info_long).max_win_len = 1 as core::ffi::c_int as WORD32;
    (*pstr_sfb_info_long).samp_per_bk = block_size_samples;
    match block_size_samples {
        480 => {
        ...
        _ => {
            __assert_fail(
                ...
                b"/mnt/c/Users/bohdan.bolbot/Repositories/libxaac/decoder/ixheaacd_create.c\0"
    ...
    (*pstr_sfb_info_long).sfb_width = sfb_width_long as pWORD16;
    (*pstr_sfb_info_long).num_groups = 1 as core::ffi::c_int as WORD32;
    (*pstr_sfb_info_long).group_len[0 as core::ffi::c_int as usize] = 1 as WORD16;
    i = 0 as core::ffi::c_int as WORD32;
    j = 0 as core::ffi::c_int as WORD32;
    n = (*pstr_sfb_info_long).sfb_per_sbk;
    while i < n {
        k = *((*pstr_sfb_info_long).ptr_sfb_tbl).offset(i as isize) as WORD32;
        *((*pstr_sfb_info_long).sfb_width).offset(i as isize) = (k - j)
            as core::ffi::c_short;
        j = k;
        i += 1;
    }
    (*pstr_sfb_info_short).islong = 0 as core::ffi::c_int as WORD32;
    (*pstr_sfb_info_short).max_win_len = NSHORT as core::ffi::c_int as WORD32;
    (*pstr_sfb_info_short).samp_per_bk = block_size_samples;
    i = 0 as core::ffi::c_int as WORD32;
    while i < (*pstr_sfb_info_short).max_win_len {
        match block_size_samples {
            768 => {
    ...
    (*pstr_sfb_info_short).sfb_width = sfb_width_short as pWORD16;
    i = 0 as core::ffi::c_int as WORD32;
    j = 0 as core::ffi::c_int as WORD32;
    n = (*pstr_sfb_info_short).sfb_per_sbk;
    while i < n {
        k = *((*pstr_sfb_info_short).ptr_sfb_tbl).offset(i as isize) as WORD32;
        *((*pstr_sfb_info_short).sfb_width).offset(i as isize) = (k - j)
            as core::ffi::c_short;
        j = k;
        i += 1;
    }
    pstr_sfb_info_ip = pstr_sfb_info_long;
    ws = 0 as core::ffi::c_int as WORD32;
    while ws < 2 as core::ffi::c_int {
        (*pstr_sfb_info_ip).sfb_per_bk = 0 as core::ffi::c_int as WORD32;
        k = 0 as core::ffi::c_int as WORD32;
        n = 0 as core::ffi::c_int as WORD32;
        i = 0 as core::ffi::c_int as WORD32;
        while i < (*pstr_sfb_info_ip).max_win_len {
            (*pstr_sfb_info_ip).bins_per_sbk = (*pstr_sfb_info_ip).samp_per_bk
                / (*pstr_sfb_info_ip).max_win_len;
            (*pstr_sfb_info_ip).sfb_per_bk += (*pstr_sfb_info_ip).sfb_per_sbk;
            sfbands = (*pstr_sfb_info_ip).ptr_sfb_tbl;
            j = 0 as core::ffi::c_int as WORD32;
            while j < (*pstr_sfb_info_ip).sfb_per_sbk {
                (*pstr_sfb_info_ip).sfb_idx_tbl[(j + k) as usize] = (*sfbands
                    .offset(j as isize) as WORD32 + n) as WORD16;
                j += 1;
            }
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_decode_init(
    mut handle: *mut core::ffi::c_void,
    mut sample_rate: WORD32,
    mut usac_data: *mut ia_usac_data_struct,
    mut pstr_stream_config: *mut ia_audio_specific_config_struct,
) -> WORD32 {
    let mut i: WORD32 = 0;
    let mut codec_handle: *mut ia_exhaacplus_dec_api_struct = handle
        as *mut ia_exhaacplus_dec_api_struct;
    let mut aac_dec_handle: *mut ia_aac_dec_state_struct = (*codec_handle).p_state_aac;
    let mut fscale: WORD32 = 0;
    let mut ele_id: WORD32 = 0 as WORD32;
    let mut ptr_usac_config: *mut ia_usac_config_struct = &mut (*pstr_stream_config)
        .str_usac_config;
    let mut ptr_usac_dec_config: *mut ia_usac_decoder_config_struct = &mut (*pstr_stream_config)
        .str_usac_config
        .str_usac_dec_config;
    let mut num_elements: WORD32 = (*ptr_usac_dec_config).num_elements as WORD32;
    let mut chan: WORD32 = 0 as WORD32;
    ...
    (*usac_data).huffman_code_book_scl_index = (*aac_dec_handle)
        .huffman_code_book_scl_index;
    (*usac_data).tns_coeff3_32 = ((*(*(*aac_dec_handle).pstr_aac_tables)
        .pstr_block_tables)
        .tns_coeff3_32)
        .as_mut_ptr();
    (*usac_data).tns_coeff4_32 = ((*(*(*aac_dec_handle).pstr_aac_tables)
        .pstr_block_tables)
        .tns_coeff4_32)
        .as_mut_ptr();
    (*usac_data).tns_max_bands_tbl_usac = &mut (*(*(*aac_dec_handle).pstr_aac_tables)
        .pstr_block_tables)
        .tns_max_bands_tbl_usac as *mut [[WORD32; 2]; 16];
    let mut ch: WORD32 = 0 as WORD32;
    while ch < MAX_NUM_CHANNELS {
        ixheaacd_usac_ec_init(
            &mut *((*usac_data).str_error_concealment).as_mut_ptr().offset(ch as isize),
            (*usac_data).core_mode,
        );
        memset(
            &mut *(*((*usac_data).overlap_data_ptr).as_mut_ptr().offset(ch as isize))
                .as_mut_ptr()
                .offset(0 as core::ffi::c_int as isize) as *mut WORD32
                as *mut core::ffi::c_void,
            0 as core::ffi::c_int,
            ::core::mem::size_of::<[WORD32; 4096]>() as size_t,
        );
        ch += 1;
    }
    i = 0 as core::ffi::c_int as WORD32;
    while i < 11 as core::ffi::c_int {
        if ixheaacd_sampling_boundaries[i as usize] <= sample_rate {
            break;
        }
        i += 1;
    }
    if i == (1 as core::ffi::c_int) << LEN_SAMP_IDX as core::ffi::c_int {
        return -(1 as WORD32);
    }
    (*usac_data).sampling_rate_idx = i;
    fscale = (sample_rate as core::ffi::c_double * FSCALE_DENOM as core::ffi::c_double
        / 12800.0f64) as WORD32;
    i = 0 as core::ffi::c_int as WORD32;
    while i < MAX_NUM_CHANNELS {
        (*usac_data).window_shape_prev[i as usize] = 0 as core::ffi::c_int as WORD32;
        (*usac_data).window_shape[i as usize] = 0 as core::ffi::c_int as WORD32;
        i += 1;
    }
    ixheaacd_hufftab(
        &mut ixheaacd_book,
        ixheaacd_huff_book_scl.as_ptr(),
        ixheaacd_book_scl_code_book.as_ptr(),
        ixheaacd_book_scl_index.as_ptr(),
        1 as WORD32,
        60 as WORD32,
        60 as WORD32,
        1 as WORD32,
    ...
    (*usac_data).pstr_usac_winmap[0 as core::ffi::c_int as usize] = &mut (*usac_data)
        .str_only_long_info;
    (*usac_data).pstr_usac_winmap[1 as core::ffi::c_int as usize] = &mut (*usac_data)
        .str_only_long_info;
    (*usac_data).pstr_usac_winmap[2 as core::ffi::c_int as usize] = &mut (*usac_data)
        .str_eight_short_info;
    (*usac_data).pstr_usac_winmap[3 as core::ffi::c_int as usize] = &mut (*usac_data)
        .str_only_long_info;
    (*usac_data).pstr_usac_winmap[4 as core::ffi::c_int as usize] = &mut (*usac_data)
        .str_only_long_info;
    if (*usac_data).ccfl != 480 as core::ffi::c_int
        && (*usac_data).ccfl != 512 as core::ffi::c_int
        && (*usac_data).ccfl != 768 as core::ffi::c_int
        && (*usac_data).ccfl != 960 as core::ffi::c_int
        && (*usac_data).ccfl != 1024 as core::ffi::c_int
    {
        return -(1 as WORD32);
    }
    ixheaacd_info_init(
        &*ixheaacd_samp_rate_info
            .as_ptr()
            .offset((*usac_data).sampling_rate_idx as isize),
        (*usac_data).ccfl,
        (*usac_data).pstr_usac_winmap[0 as core::ffi::c_int as usize],
        (*usac_data).pstr_usac_winmap[2 as core::ffi::c_int as usize],
        ((*usac_data).sfb_width_short).as_mut_ptr(),
        ((*usac_data).sfb_width_long).as_mut_ptr(),
    );
    i = 0 as core::ffi::c_int as WORD32;
    while i < MAX_NUM_CHANNELS {
        (*usac_data).str_tddec[i as usize] = &mut *((*usac_data).arr_str_tddec)
            .as_mut_ptr()
            .offset(i as isize) as *mut ia_usac_lpd_decoder
            as ia_usac_lpd_decoder_handle;
        if (*usac_data).ccfl == 768 as core::ffi::c_int {
            (*(*usac_data).str_tddec[i as usize]).fscale = (*pstr_stream_config)
                .sampling_frequency as WORD32;
        } else {
            (*(*usac_data).str_tddec[i as usize]).fscale = (fscale as core::ffi::c_int
                * (*usac_data).ccfl as core::ffi::c_int / LEN_SUPERFRAME) as WORD32;
        }
        (*usac_data).len_subfrm = ((*usac_data).ccfl as core::ffi::c_int
            / 4 as core::ffi::c_int) as WORD32;
        let mut fac_length: WORD32 = (*usac_data).len_subfrm / 4 as WORD32;
        ...
        (*usac_data).num_subfrm = (MAX_NUM_SUBFR * (*usac_data).ccfl as core::ffi::c_int
            / LEN_SUPERFRAME) as WORD32;
        ixheaacd_init_acelp_data(usac_data, (*usac_data).str_tddec[i as usize]);
        (*(*usac_data).str_tddec[i as usize]).fd_synth = &mut *((**((*usac_data)
            .str_tddec)
            .as_mut_ptr()
            .offset(i as isize))
            .fd_synth_buf)
    ...
    ele_id = 0 as core::ffi::c_int as WORD32;
    while ele_id < num_elements {
        let mut ele_type: UWORD32 = 0;
        let mut stereo_config_index: WORD32 = 0;
        let mut ptr_usac_ele_config: *mut ia_usac_dec_element_config_struct = &mut *((*ptr_usac_config)
            .str_usac_dec_config
            .str_usac_element_config)
            .as_mut_ptr()
            .offset(ele_id as isize) as *mut ia_usac_dec_element_config_struct;
        if !ptr_usac_ele_config.is_null() {
            if (*usac_data).tw_mdct[ele_id as usize] != 0 {
                if (*usac_data).ec_flag != 0 {
                    (*usac_data).tw_mdct[ele_id as usize] = 0 as core::ffi::c_int
                        as WORD32;
                } else {
                    return -(1 as WORD32)
                }
            }
            (*usac_data).noise_filling_config[ele_id as usize] = (*ptr_usac_ele_config)
                .noise_filling as WORD32;
        }
        ele_type = (*ptr_usac_config)
            .str_usac_dec_config
            .usac_element_type[ele_id as usize];
        stereo_config_index = (*ptr_usac_ele_config).stereo_config_index as WORD32;
        match ele_type {
            0 | 2 => {
                if chan as core::ffi::c_int + 1 as core::ffi::c_int
                    > MAX_NUM_CHANNELS_USAC_LVL2
                {
                    return -(1 as WORD32);
                }
                (*usac_data).seed_value[chan as usize] = 0x3039 as UWORD32;
                chan += 1;
            }
            1 => {
                static mut frame_len_tbl: [WORD32; 5] = [
                    -(1 as core::ffi::c_int),
                    -(1 as core::ffi::c_int),
                ...
                if chan as core::ffi::c_int + 2 as core::ffi::c_int
                    > MAX_NUM_CHANNELS_USAC_LVL2
                {
                    return -(1 as WORD32);
                }
                (*usac_data).seed_value[chan as usize] = 0x3039 as UWORD32;
                chan += 1;
                (*usac_data).seed_value[chan as usize] = 0x10932 as UWORD32;
                chan += 1;
                if stereo_config_index > 0 as core::ffi::c_int {
                    let mut bs_frame_length: WORD32 = frame_len_tbl[(*ptr_usac_config)
                        .core_sbr_framelength_index as usize];
                    let mut bs_residual_coding: WORD32 = if stereo_config_index
                        > 1 as core::ffi::c_int
                    {
                        1 as WORD32
                    } else {
                    ...
                    let mut ptr_usac_mps212_config: *mut ia_usac_dec_mps_config_struct = &mut (*((*ptr_usac_config)
                        .str_usac_dec_config
                        .str_usac_element_config)
                        .as_mut_ptr()
                        .offset(ele_id as isize))
                        .str_usac_mps212_config;
                    (*aac_dec_handle).mps_dec_handle.ec_flag = (*aac_dec_handle)
                        .ec_enable as WORD8;
                    if ixheaacd_mps_create(
                        &mut (*aac_dec_handle).mps_dec_handle,
                        bs_frame_length,
                        bs_residual_coding,
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_dec_data_init(
    mut handle: *mut core::ffi::c_void,
    mut pstr_frame_data: *mut ia_frame_data_struct,
    mut usac_data: *mut ia_usac_data_struct,
) -> WORD32 {
    let mut pstr_stream_config: *mut ia_audio_specific_config_struct = 0
        as *mut ia_audio_specific_config_struct;
    let mut layer_config: *mut ia_audio_specific_config_struct = 0
        as *mut ia_audio_specific_config_struct;
    let mut err_code: WORD32 = 0 as WORD32;
    let mut i_ch: WORD32 = 0;
    let mut i: WORD32 = 0;
    let mut ele_id: WORD32 = 0;
    let mut num_elements: WORD32 = 0;
    let mut out_frame_len: WORD32 = 0;
    let mut sbr_ratio_idx: WORD32 = 0;
    let mut ptr_usac_config: *mut ia_usac_config_struct = &mut (*pstr_frame_data)
        .str_audio_specific_config
        .str_usac_config;
    (*usac_data).last_frame_ok = 1 as core::ffi::c_int as WORD32;
    (*usac_data).frame_ok = 1 as core::ffi::c_int as WORD32;
    (*usac_data).window_shape_prev[0 as core::ffi::c_int as usize] = WIN_SEL_0 as WORD32;
    (*usac_data).window_shape_prev[1 as core::ffi::c_int as usize] = WIN_SEL_0 as WORD32;
    (*pstr_frame_data).str_layer.bit_rate = (*pstr_frame_data)
        .str_audio_specific_config
        .avg_bit_rate as WORD32;
    pstr_stream_config = &mut (*pstr_frame_data).str_audio_specific_config;
    layer_config = &mut (*pstr_frame_data).str_audio_specific_config;
    sbr_ratio_idx = ixheaacd_sbr_params(
        (*ptr_usac_config).core_sbr_framelength_index as UWORD32,
        &mut out_frame_len,
        &mut (*usac_data).ccfl,
        &mut (*usac_data).output_samples,
        &mut (*pstr_frame_data).str_layer.sample_rate_layer,
        &mut (*layer_config).samp_frequency_index,
    ) as WORD32;
    if (*pstr_frame_data).str_layer.sample_rate_layer == 0 {
        return -(1 as WORD32);
    }
    (*pstr_stream_config).sampling_frequency = (*pstr_frame_data)
        .str_layer
        .sample_rate_layer as UINT32;
    (*pstr_stream_config).samp_frequency_index = (*layer_config).samp_frequency_index;
    num_elements = (*ptr_usac_config).str_usac_dec_config.num_elements as WORD32;
    ele_id = 0 as core::ffi::c_int as WORD32;
    while ele_id < num_elements {
        let mut ptr_usac_ele_config: *mut ia_usac_dec_element_config_struct = &mut *((*ptr_usac_config)
            .str_usac_dec_config
            ...
            .offset(ele_id as isize) as *mut ia_usac_dec_element_config_struct;
        if !ptr_usac_ele_config.is_null() {
            (*usac_data).tw_mdct[ele_id as usize] = (*ptr_usac_ele_config).tw_mdct
                as WORD32;
        }
        let mut ptr_usac_mps212_config: *mut ia_usac_dec_mps_config_struct = &mut (*ptr_usac_ele_config)
            .str_usac_mps212_config;
        let mut stereo_config_index: WORD32 = (*ptr_usac_ele_config).stereo_config_index
            as WORD32;
        (*usac_data).mps_pseudo_lr[ele_id as usize] = (if stereo_config_index
            > 1 as core::ffi::c_int
        {
            (*ptr_usac_mps212_config).bs_pseudo_lr
        } else {
            0 as UINT32
        }) as WORD32;
        ele_id += 1;
    ...
    (*usac_data).esbr_bit_str[0 as core::ffi::c_int as usize].no_elements = 0 as WORD16;
    (*usac_data).esbr_bit_str[1 as core::ffi::c_int as usize].no_elements = 0 as WORD16;
    if (*usac_data).ccfl == 768 as core::ffi::c_int {
        (*pstr_frame_data).str_layer.sample_rate_layer = (4 as core::ffi::c_int
            * (*pstr_frame_data).str_layer.sample_rate_layer as core::ffi::c_int
            / 3 as core::ffi::c_int) as WORD32;
    }
    i = 0 as core::ffi::c_int as WORD32;
    while i < MAX_NUM_CHANNELS {
        (*usac_data).coef_fix[i as usize] = &mut *(*((*usac_data).arr_coef_fix)
            .as_mut_ptr()
            .offset(i as isize))
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize) as *mut WORD32;
        (*usac_data).coef[i as usize] = &mut *(*((*usac_data).arr_coef)
            .as_mut_ptr()
            .offset(i as isize))
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize) as *mut FLOAT32;
        (*usac_data).coef_save[i as usize] = &mut *(*((*usac_data).arr_coef_save)
            .as_mut_ptr()
            .offset(i as isize))
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize) as *mut WORD32;
        (*usac_data).factors[i as usize] = &mut *(*((*usac_data).arr_factors)
            .as_mut_ptr()
            .offset(i as isize))
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize) as *mut WORD16;
        (*usac_data).group_dis[i as usize] = &mut *(*((*usac_data).arr_group_dis)
            .as_mut_ptr()
            .offset(i as isize))
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize) as *mut UWORD8;
        (*usac_data).pstr_tns[i as usize] = &mut *((*usac_data).arr_str_tns)
            .as_mut_ptr()
            .offset(i as isize) as *mut ia_tns_frame_info_struct;
        (*usac_data).tw_ratio[i as usize] = &mut *(*((*usac_data).arr_tw_ratio)
            .as_mut_ptr()
            .offset(i as isize))
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize) as *mut WORD32;
        (*usac_data).ms_used[i as usize] = &mut *(*((*usac_data).arr_ms_used)
            .as_mut_ptr()
            .offset(i as isize))
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize) as *mut UWORD8;
        (*usac_data).window_shape_prev[i as usize] = WIN_SEL_0 as WORD32;
        (*usac_data).seed_value[i as usize] = 0 as UWORD32;
        (*usac_data).fac_data_present[i as usize] = 0 as core::ffi::c_int as WORD32;
        i += 1;
    }
    err_code = ixheaacd_decode_init(
        handle,
    ...
    while i_ch < MAX_NUM_CHANNELS {
        if (*usac_data).tw_mdct[0 as core::ffi::c_int as usize] == 1 as core::ffi::c_int
        {
            let mut i_0: WORD32 = 0;
            i_0 = 0 as core::ffi::c_int as WORD32;
            while i_0 < 2 as WORD32 * (*usac_data).ccfl {
                (*usac_data).warp_cont_mem[i_ch as usize][i_0 as usize] = 1.0f32;
                i_0 += 1;
            }
            (*usac_data).warp_sum[i_ch as usize][1 as core::ffi::c_int as usize] = (*usac_data)
                .ccfl as FLOAT32;
            (*usac_data).warp_sum[i_ch as usize][0 as core::ffi::c_int as usize] = (*usac_data)
                .warp_sum[i_ch as usize][1 as core::ffi::c_int as usize];
        }
        i_ch += 1;
    }
    return err_code;
}
unsafe extern "C" fn ixheaacd_count_tracks_per_layer(
    mut max_layer: *mut core::ffi::c_int,
    mut stream_count: *mut core::ffi::c_int,
    mut tracks_in_layer: *mut core::ffi::c_int,
) -> VOID {
    let mut stream: WORD32 = 0;
    let mut num_layer: WORD32 = 0;
    let mut num_streams: WORD32 = 0;
    let mut layer: WORD32 = 0 as WORD32;
    if stream_count.is_null() {
        num_streams = 0 as core::ffi::c_int as WORD32;
    } else {
        num_streams = *stream_count as WORD32;
    }
    if max_layer.is_null() {
        num_layer = num_streams;
    } else {
        num_layer = *max_layer as WORD32;
    }
    if num_layer < 0 as core::ffi::c_int {
        num_layer = num_streams;
    }
    stream = 0 as core::ffi::c_int as WORD32;
    while layer <= num_layer && stream < num_streams {
        *tracks_in_layer = 1 as core::ffi::c_int;
        stream += 1 as core::ffi::c_int;
        layer += 1;
        if layer <= num_layer {
            *tracks_in_layer = 0 as core::ffi::c_int;
        }
    }
    if !max_layer.is_null() {
        *max_layer = layer as core::ffi::c_int - 1 as core::ffi::c_int;
    }
    if !stream_count.is_null() {
        *stream_count = stream as core::ffi::c_int;
    }
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_frm_data_init(
    mut pstr_audio_conf: *mut ia_audio_specific_config_struct,
    mut pstr_dec_data: *mut ia_dec_data_struct,
) -> WORD32 {
    let mut layer: WORD32 = 0;
    let mut track: WORD32 = 0;
    let mut num_dec_streams: WORD32 = 0;
    let mut pstr_frame_data: *mut ia_frame_data_struct = 0 as *mut ia_frame_data_struct;
    let mut stream_count: WORD32 = 1 as WORD32;
    let mut max_layer: WORD32 = -(1 as WORD32);
    memset(
        pstr_dec_data as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_dec_data_struct>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    memset(
        &mut (*pstr_dec_data).str_frame_data as *mut ia_frame_data_struct
            as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ::core::mem::size_of::<ia_frame_data_struct>() as size_t,
    );
    pstr_frame_data = &mut (*pstr_dec_data).str_frame_data;
    if max_layer < 0 as core::ffi::c_int {
        max_layer = (stream_count as core::ffi::c_int - 1 as core::ffi::c_int) as WORD32;
    }
    ixheaacd_count_tracks_per_layer(
        &mut max_layer,
        &mut stream_count,
        &mut (*pstr_frame_data).tracks_in_layer,
    );
    (*pstr_frame_data).scal_out_select = max_layer as UWORD32;
    (*pstr_frame_data).stream_count = 0 as UINT32;
    track = 0 as core::ffi::c_int as WORD32;
    num_dec_streams = track;
    layer = 0 as core::ffi::c_int as WORD32;
    while layer
        < (*pstr_frame_data).scal_out_select as core::ffi::c_int + 1 as core::ffi::c_int
    {
        let mut j: WORD32 = 0;
        j = 0 as core::ffi::c_int as WORD32;
        while j < 1 as core::ffi::c_int {
            (*pstr_frame_data).str_audio_specific_config = *pstr_audio_conf;
            (*pstr_frame_data).str_layer.sample_rate_layer = (*pstr_frame_data)
                .str_audio_specific_config
                .sampling_frequency as WORD32;
            (*pstr_frame_data).str_layer.bit_rate = (*pstr_frame_data)
                .str_audio_specific_config
    ...
    (*pstr_frame_data).stream_count = num_dec_streams as UINT32;
    return num_dec_streams;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_decode_create(
    mut handle: *mut ia_exhaacplus_dec_api_struct,
    mut pstr_dec_data: *mut ia_dec_data_struct,
    mut tracks_for_decoder: WORD32,
) -> WORD32 {
    let mut stream: WORD32 = 0;
    let mut err: WORD32 = 0 as WORD32;
    let mut pstr_frame_data: *mut ia_frame_data_struct = 0 as *mut ia_frame_data_struct;
    let mut stream_count: WORD32 = 0;
    let mut aac_dec_handle: *mut ia_aac_dec_state_struct = (*handle).p_state_aac;
    pstr_frame_data = &mut (*pstr_dec_data).str_frame_data;
    stream_count = (*pstr_frame_data).stream_count as WORD32;
    (*pstr_frame_data).stream_count = tracks_for_decoder as UINT32;
    stream = 0 as core::ffi::c_int as WORD32;
    while stream < stream_count {
        let mut aot: UWORD32 = (*pstr_frame_data)
            .str_audio_specific_config
            .audio_object_type as UWORD32;
        match aot {
            42 => {
                err = ixheaacd_dec_data_init(
                    handle as *mut core::ffi::c_void,
                    pstr_frame_data,
                    &mut (*pstr_dec_data).str_usac_data,
                );
                if err != 0 as core::ffi::c_int {
                    if (*handle).aac_config.ui_err_conceal != 0 {
                        (*pstr_dec_data).str_usac_data.frame_ok = 0 as core::ffi::c_int
                            as WORD32;
                    } else {
                        return err
                    }
                }
                (*pstr_dec_data).str_usac_data.sampling_rate = (*pstr_frame_data)
                    .str_layer
                    .sample_rate_layer;
                match (*pstr_dec_data).str_usac_data.sbr_ratio_idx {
                    0 => {
                        (*handle).aac_config.ui_sbr_mode = 0 as UWORD32;
                    }
                    1 => {
                        (*handle).aac_config.ui_sbr_mode = 1 as UWORD32;
                    }
                    2 => {
                        (*handle).aac_config.ui_sbr_mode = 1 as UWORD32;
                    }
                    3 => {
                        (*handle).aac_config.ui_sbr_mode = 3 as UWORD32;
                    }
                    _ => {
                        (*handle).aac_config.ui_sbr_mode = 0 as UWORD32;
                    }
                }
                if (*aac_dec_handle).peak_lim_init == 0
                    && (*handle).aac_config.peak_limiter_off == 0
                    && (*handle).aac_config.ui_err_conceal != 0
                {
                    memset(
                        &mut (*aac_dec_handle).peak_limiter
                            as *mut ia_peak_limiter_struct as *mut core::ffi::c_void,
                        0 as core::ffi::c_int,
                        ::core::mem::size_of::<ia_peak_limiter_struct>() as size_t,
                    );
                    ixheaacd_peak_limiter_init(
                        &mut (*aac_dec_handle).peak_limiter,
                        MAX_NUM_CHANNELS as UWORD32,
                        (*pstr_dec_data).str_usac_data.sampling_rate as UWORD32,
                        &mut *((*aac_dec_handle).peak_limiter.buffer)
                            .as_mut_ptr()
                            .offset(0 as core::ffi::c_int as isize),
                        &mut (*aac_dec_handle).delay_in_samples,
                    );
                    (*aac_dec_handle).peak_lim_init = ((*aac_dec_handle).peak_lim_init)
                        .wrapping_add(1);
                }
            }
            _ => {}
    ...
    (*pstr_frame_data).scal_out_object_type = (*pstr_frame_data)
        .str_audio_specific_config
        .audio_object_type as WORD32;
    (*pstr_frame_data).scal_out_num_channels = (*pstr_frame_data)
        .str_audio_specific_config
        .channel_configuration as WORD32;
    (*pstr_frame_data).scal_out_sampling_frequency = (*pstr_frame_data)
        .str_audio_specific_config
        .sampling_frequency as WORD32;
    if !(&mut (*pstr_dec_data).str_usac_data as *mut ia_usac_data_struct).is_null() {
        let mut usac_def_header: ia_sbr_header_data_struct = ia_sbr_header_data_struct {
            sync_state: 0,
            err_flag: 0,
            err_flag_prev: 0,
            num_time_slots: 0,
        ...
        let mut pstr_aud_spec_config: *mut ia_audio_specific_config_struct = &mut (*pstr_frame_data)
            .str_audio_specific_config;
        let mut ptr_usac_config: *mut ia_usac_config_struct = &mut (*pstr_frame_data)
            .str_audio_specific_config
            .str_usac_config;
        let mut inter_test_flag: WORD32 = 0 as WORD32;
        let mut bs_pvc_flag: WORD32 = 0 as WORD32;
        let mut harmonic_Sbr_flag: WORD32 = 0 as WORD32;
        let mut ptr_usac_dec_config: *mut ia_usac_decoder_config_struct = &mut (*ptr_usac_config)
            .str_usac_dec_config;
        let num_ele: WORD32 = (*ptr_usac_dec_config).num_elements as WORD32;
        let mut elem_idx: WORD32 = 0 as WORD32;
        memset(
            &mut usac_def_header as *mut ia_sbr_header_data_struct
                as *mut core::ffi::c_void,
            0 as core::ffi::c_int,
            ::core::mem::size_of::<ia_sbr_header_data_struct>() as size_t,
        );
        elem_idx = 0 as core::ffi::c_int as WORD32;
        while elem_idx < num_ele {
            let mut usac_ele_type: UWORD32 = (*ptr_usac_config)
                .str_usac_dec_config
                .usac_element_type[elem_idx as usize];
            let mut ptr_usac_ele_config: *mut ia_usac_dec_element_config_struct = &mut *((*ptr_usac_config)
                .str_usac_dec_config
                .str_usac_element_config)
                .as_mut_ptr()
                .offset(elem_idx as isize) as *mut ia_usac_dec_element_config_struct;
            let mut ptr_usac_sbr_config: *mut ia_usac_dec_sbr_config_struct = &mut (*((*ptr_usac_dec_config)
                .str_usac_element_config)
                .as_mut_ptr()
                .offset(elem_idx as isize))
                .str_usac_sbr_config;
            if (*ptr_usac_sbr_config).bs_inter_tes != 0 {
                inter_test_flag = 1 as core::ffi::c_int as WORD32;
            }
            if (*ptr_usac_sbr_config).bs_pvc != 0 {
                bs_pvc_flag = 1 as core::ffi::c_int as WORD32;
            }
            if (*ptr_usac_sbr_config).harmonic_sbr != 0 {
                harmonic_Sbr_flag = 1 as core::ffi::c_int as WORD32;
            }
            if usac_ele_type != ID_USAC_LFE as UWORD32
                && usac_ele_type != ID_USAC_EXT as UWORD32
            {
                let mut ptr_usac_sbr_config_0: *mut ia_usac_dec_sbr_config_struct = &mut (*ptr_usac_ele_config)
                    .str_usac_sbr_config;
                usac_def_header.start_freq = (*ptr_usac_sbr_config_0).dflt_start_freq;
                usac_def_header.stop_freq = (*ptr_usac_sbr_config_0).dflt_stop_freq;
                usac_def_header.header_extra_1 = (*ptr_usac_sbr_config_0)
                    .dflt_header_extra1;
                usac_def_header.header_extra_2 = (*ptr_usac_sbr_config_0)
                    .dflt_header_extra2;
                usac_def_header.freq_scale = (*ptr_usac_sbr_config_0).dflt_freq_scale;
                usac_def_header.alter_scale = (*ptr_usac_sbr_config_0).dflt_alter_scale;
                usac_def_header.noise_bands = (*ptr_usac_sbr_config_0).dflt_noise_bands;
                usac_def_header.limiter_bands = (*ptr_usac_sbr_config_0)
                    .dflt_limiter_bands;
                usac_def_header.limiter_gains = (*ptr_usac_sbr_config_0)
                    .dflt_limiter_gains;
                usac_def_header.interpol_freq = (*ptr_usac_sbr_config_0)
                    .dflt_interpol_freq;
                usac_def_header.smoothing_mode = (*ptr_usac_sbr_config_0)
                    .dflt_smoothing_mode;
            }
            elem_idx += 1;
        }
        (*pstr_dec_data).str_usac_data.down_samp_sbr = 0 as core::ffi::c_int as WORD32;
        if (*pstr_dec_data).str_usac_data.sbr_ratio_idx > 0 as core::ffi::c_int {
            if (*pstr_aud_spec_config).ext_sampling_frequency
                == (*pstr_aud_spec_config).sampling_frequency
            {
                (*pstr_dec_data).str_usac_data.down_samp_sbr = 1 as core::ffi::c_int
                    as WORD32;
            }
            if (*pstr_dec_data).str_usac_data.down_samp_sbr == 0 as core::ffi::c_int {
                if (*pstr_dec_data).str_usac_data.sbr_ratio_idx == 3 as core::ffi::c_int
                {
                    (*pstr_frame_data).scal_out_sampling_frequency = 4 as WORD32
                        * (*pstr_frame_data).scal_out_sampling_frequency;
                } else {
                    (*pstr_frame_data).scal_out_sampling_frequency = 2 as WORD32
                        * (*pstr_frame_data).scal_out_sampling_frequency;
                }
            }
            let mut sbr_persistent_mem_v: *mut core::ffi::c_void = (*aac_dec_handle)
                .sbr_persistent_mem_u as *mut core::ffi::c_void;
            (*pstr_dec_data).str_usac_data.pstr_esbr_dec = ixheaacd_init_sbr(
                (*pstr_frame_data).str_layer.sample_rate_layer,
                (*pstr_dec_data).str_usac_data.ccfl,
                &mut (*pstr_dec_data).str_usac_data.down_samp_sbr,
                sbr_persistent_mem_v as *mut core::ffi::c_void,
                0 as *mut WORD32,
                (*pstr_frame_data).scal_out_num_channels as WORD,
                0 as WORD,
                (*pstr_dec_data).str_usac_data.sbr_ratio_idx as WORD,
                (*pstr_dec_data).str_usac_data.output_samples as WORD,
                &mut harmonic_Sbr_flag,
                &mut usac_def_header as *mut ia_sbr_header_data_struct
                    as *mut core::ffi::c_void,
                (*aac_dec_handle).str_sbr_config,
                (*pstr_dec_data).str_usac_data.audio_object_type as WORD,
                0 as WORD32,
                0 as WORD32,
            );
            (*pstr_dec_data).str_usac_data.sbr_scratch_mem_base = (*aac_dec_handle)
                .sbr_scratch_mem_u;
            if num_ele != 0 {
                ixheaacd_setesbr_flags(
                    sbr_persistent_mem_v as *mut core::ffi::c_void,
                    bs_pvc_flag as FLAG,
                    harmonic_Sbr_flag as FLAG,
                    inter_test_flag as FLAG,
                );
            }
            if ((*pstr_dec_data).str_usac_data.pstr_esbr_dec).is_null() {
                return -(1 as WORD32)
            } else {
                (*(*pstr_dec_data).str_usac_data.pstr_esbr_dec).xaac_jmp_buf = &mut (*aac_dec_handle)
                    .xaac_jmp_buf;
            }
        }
    }
    (*aac_dec_handle).decode_create_done = 1 as core::ffi::c_int as WORD32;
    return 0 as WORD32;
}
