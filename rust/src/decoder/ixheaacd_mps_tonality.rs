...
pub const PARAMETER_BANDS_40: C2RustUnnamed_0 = 40;
pub const PARAMETER_BANDS_28: C2RustUnnamed_0 = 28;
pub const PARAMETER_BANDS_20: C2RustUnnamed_0 = 20;
pub const PARAMETER_BANDS_14: C2RustUnnamed_0 = 14;
pub const PARAMETER_BANDS_10: C2RustUnnamed_0 = 10;
pub const PARAMETER_BANDS_7: C2RustUnnamed_0 = 7;
pub const PARAMETER_BANDS_5: C2RustUnnamed_0 = 5;
pub const PARAMETER_BANDS_4: C2RustUnnamed_0 = 4;
...
pub const MINUS_PI_BY_EIGHT_Q15: core::ffi::c_int = -(12868 as core::ffi::c_int);
pub const TWO_PI_BY_FIFTEEN_Q15: core::ffi::c_int = 13726 as core::ffi::c_int;
pub const ONE_IN_Q14: core::ffi::c_int = 16384 as core::ffi::c_int;
pub const ONE_IN_Q15: core::ffi::c_int = 32768 as core::ffi::c_int;
pub const POINT_FOUR_TWO_Q15: core::ffi::c_int = 13763 as core::ffi::c_int;
pub const QMF_BANDSXTSX6: core::ffi::c_int = 27648 as core::ffi::c_int;
pub const TWO_BY_TWENTYFIVE_Q16: core::ffi::c_int = 5243 as core::ffi::c_int;
pub const QBX48: core::ffi::c_int = 3072 as core::ffi::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_init_tonality(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut ton_state: *mut ia_mps_dec_tonality_state_struct = (*pstr_mps_state)
        .mps_persistent_mem
        .ton_state;
    let mut cnt: WORD32 = (*pstr_mps_state).qmf_bands * 8 as WORD32;
    let mut qmf_bands: WORD32 = (*pstr_mps_state).qmf_bands;
    memset(
        ((*ton_state).spec_prev_real).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (cnt as size_t).wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*ton_state).spec_prev_imag).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (cnt as size_t).wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*ton_state).p_cross_real).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (cnt as size_t).wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*ton_state).p_cross_imag).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (cnt as size_t).wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*ton_state).p_sum).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (cnt as size_t).wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*ton_state).p_sum_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (cnt as size_t).wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*ton_state).buf_real).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((qmf_bands as core::ffi::c_int * 6 as core::ffi::c_int) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*ton_state).buf_imag).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((qmf_bands as core::ffi::c_int * 6 as core::ffi::c_int) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*ton_state).win_buf_real).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((qmf_bands as core::ffi::c_int * 16 as core::ffi::c_int) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*ton_state).win_buf_imag).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((qmf_bands as core::ffi::c_int * 16 as core::ffi::c_int) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_zoom_fft16(
    mut in_real: *mut WORD32,
    mut in_imag: *mut WORD32,
    mut out_real: *mut WORD32,
    mut out_imag: *mut WORD32,
    mut qmf_band: WORD32,
    mut dfrac: WORD32,
    mut ia_mps_dec_mps_table_ptr: *mut ia_mps_dec_mps_tables_struct,
) -> VOID {
    let mut blackman: [WORD32; 16] = [0; 16];
    let mut v_real: [WORD32; 16] = [0; 16];
    let mut v_imag: [WORD32; 16] = [0; 16];
    let mut t_real: WORD32 = 0;
    let mut t_imag: WORD32 = 0;
    let mut e_real: WORD32 = 0;
    let mut e_imag: WORD32 = 0;
    let mut temp_1: WORD32 = 0;
    let mut temp_2: WORD32 = 0;
    let mut temp3: WORD32 = 0;
    let mut temp4: WORD32 = 0;
    let mut bitrev: *const WORD32 = ((*(*ia_mps_dec_mps_table_ptr).tonality_table_ptr)
        .bitrev)
        .as_mut_ptr();
    let mut w_real: *const WORD32 = ((*(*ia_mps_dec_mps_table_ptr).tonality_table_ptr)
        .w_real)
        .as_mut_ptr();
    let mut w_imag: *const WORD32 = ((*(*ia_mps_dec_mps_table_ptr).tonality_table_ptr)
        .w_imag)
        .as_mut_ptr();
    let mut cos_tab: *const WORD32 = ((*(*ia_mps_dec_mps_table_ptr).hybrid_table_ptr)
        .cosine_array)
        .as_mut_ptr();
    let mut sin_tab: *const WORD32 = ((*(*ia_mps_dec_mps_table_ptr).hybrid_table_ptr)
        .sine_array)
        .as_mut_ptr();
    let mut i: WORD32 = 0;
    let mut j: WORD32 = 0;
    let mut s1: WORD32 = 0;
    let mut s2: WORD32 = 0;
    temp3 = TWO_PI_BY_FIFTEEN_Q15 as WORD32;
    i = 0 as core::ffi::c_int as WORD32;
    while i < 16 as core::ffi::c_int {
        temp_1 = (i << 15 as core::ffi::c_int) + dfrac;
        temp_2 = ixheaacd_mps_mult32_shr_15(temp_1, temp3);
        temp_2 = ixheaacd_mps_cos(temp_2, cos_tab);
        temp_2 >>= 1 as core::ffi::c_int;
        temp_1 <<= 1 as core::ffi::c_int;
        ...
        blackman[i as usize] = temp_1 + temp4;
        i += 1;
    }
    i = 0 as core::ffi::c_int as WORD32;
    while i < 16 as core::ffi::c_int {
        let mut idx: WORD32 = *bitrev.offset(i as isize);
        temp_1 = ixheaacd_mps_mult32_shr_30(
            *in_real.offset(i as isize),
            *w_real.offset(i as isize),
        )
            - ixheaacd_mps_mult32_shr_30(
                *in_imag.offset(i as isize),
                *w_imag.offset(i as isize),
            );
        v_real[idx as usize] = ixheaacd_mps_mult32_shr_30(temp_1, blackman[i as usize]);
        temp_1 = ixheaacd_mps_mult32_shr_30(
            *in_real.offset(i as isize),
            *w_imag.offset(i as isize),
        )
        ...
        v_imag[idx as usize] = ixheaacd_mps_mult32_shr_30(temp_1, blackman[i as usize]);
        i += 1;
    }
    s1 = 1 as core::ffi::c_int as WORD32;
    s2 = 16 as core::ffi::c_int as WORD32;
    while s1 < 8 as core::ffi::c_int {
        i = 0 as core::ffi::c_int as WORD32;
        while i < 16 as core::ffi::c_int {
            j = 0 as core::ffi::c_int as WORD32;
            while j < s1 {
                t_real = ixheaacd_mps_mult32_shr_30(
                    v_real[(i + j + s1) as usize],
                    *w_real.offset((j * s2) as isize),
                )
                    - ixheaacd_mps_mult32_shr_30(
                        v_imag[(i + j + s1) as usize],
                        *w_imag.offset((j * s2) as isize),
                    );
                t_imag = ixheaacd_mps_mult32_shr_30(
                    v_real[(i + j + s1) as usize],
                    *w_imag.offset((j * s2) as isize),
                )
                    + ixheaacd_mps_mult32_shr_30(
                ...
                v_real[(i + j + s1) as usize] = v_real[(i + j) as usize] - t_real;
                v_imag[(i + j + s1) as usize] = v_imag[(i + j) as usize] - t_imag;
                v_real[(i + j) as usize] += t_real;
                v_imag[(i + j) as usize] += t_imag;
                j += 1;
            }
            i += (2 as WORD32 * s1) as core::ffi::c_int;
        }
        s1 <<= 1 as core::ffi::c_int;
        s2 >>= 1 as core::ffi::c_int;
    }
    j = 0 as core::ffi::c_int as WORD32;
    while j < 8 as core::ffi::c_int {
        let mut idx_0: WORD32 = j << 1 as core::ffi::c_int;
        t_real = ixheaacd_mps_mult32_shr_30(
            v_real[(j as core::ffi::c_int + 8 as core::ffi::c_int) as usize],
            *w_real.offset(idx_0 as isize),
        )
            - ixheaacd_mps_mult32_shr_30(
                v_imag[(j as core::ffi::c_int + 8 as core::ffi::c_int) as usize],
                *w_imag.offset(idx_0 as isize),
            );
        t_imag = ixheaacd_mps_mult32_shr_30(
            v_real[(j as core::ffi::c_int + 8 as core::ffi::c_int) as usize],
            *w_imag.offset(idx_0 as isize),
        ...
        if qmf_band as core::ffi::c_int & ONE_BIT_MASK == 0 as core::ffi::c_int {
            *out_real.offset(j as isize) = v_real[j as usize] + t_real;
            *out_imag.offset(j as isize) = v_imag[j as usize] + t_imag;
        } else {
            *out_real.offset(j as isize) = v_real[j as usize] - t_real;
            *out_imag.offset(j as isize) = v_imag[j as usize] - t_imag;
        }
    ...
    temp3 = MINUS_PI_BY_EIGHT_Q15 as WORD32;
    i = 0 as core::ffi::c_int as WORD32;
    while i < 8 as core::ffi::c_int {
        if qmf_band as core::ffi::c_int & ONE_BIT_MASK == 0 as core::ffi::c_int {
            ...
            temp_1 = (dfrac as core::ffi::c_int
                * (i as core::ffi::c_int - 8 as core::ffi::c_int)) as WORD32;
            temp_1 = ixheaacd_mps_mult32_shr_15(temp_1, temp3);
            e_real = ixheaacd_mps_cos(temp_1, cos_tab);
            e_imag = ixheaacd_mps_sin(temp_1, sin_tab);
        }
        t_real = ixheaacd_mps_mult32_shr_15(*out_real.offset(i as isize), e_real)
            - ixheaacd_mps_mult32_shr_15(*out_imag.offset(i as isize), e_imag);
        *out_imag.offset(i as isize) = ixheaacd_mps_mult32_shr_15(
            *out_real.offset(i as isize),
            e_imag,
        ) + ixheaacd_mps_mult32_shr_15(*out_imag.offset(i as isize), e_real);
        *out_real.offset(i as isize) = t_real;
        i += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_measure_tonality(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
    mut tonality: *mut WORD32,
) -> VOID {
    let mut ton_state: *mut ia_mps_dec_tonality_state_struct = (*pstr_mps_state)
        .mps_persistent_mem
        .ton_state;
    ...
    let mut spec_zoom_real: *mut WORD32 = 0 as *mut WORD32;
    let mut spec_zoom_imag: *mut WORD32 = 0 as *mut WORD32;
    let mut spec_prev_real: *mut WORD32 = ((*ton_state).spec_prev_real).as_mut_ptr();
    let mut spec_prev_imag: *mut WORD32 = ((*ton_state).spec_prev_imag).as_mut_ptr();
    let mut p_cross_real: *mut WORD32 = ((*ton_state).p_cross_real).as_mut_ptr();
    let mut p_cross_imag: *mut WORD32 = ((*ton_state).p_cross_imag).as_mut_ptr();
    let mut p_sum: *mut WORD32 = ((*ton_state).p_sum).as_mut_ptr();
    let mut p_sum_prev: *mut WORD32 = ((*ton_state).p_sum_prev).as_mut_ptr();
    let mut p_max: *mut WORD32 = 0 as *mut WORD32;
    let mut coh_spec: *mut WORD32 = 0 as *mut WORD32;
    let mut pow_spec: *mut WORD32 = 0 as *mut WORD32;
    ...
    let mut part: *const WORD32 = 0 as *const WORD32;
    let mut pstart: WORD32 = 0;
    let mut pstop: WORD32 = 0 as WORD32;
    let mut pqmf: WORD32 = 0;
    let mut num: WORD32 = 0;
    let mut den: WORD32 = 0;
    let mut tmp_ton: WORD32 = 0;
    let mut beta: WORD32 = 0;
    let mut dwin: WORD32 = 0;
    let mut dfrac: WORD32 = 0;
    let mut q_beta: WORD16 = 0;
    let mut q_tmp_ton: WORD16 = 0;
    let mut qmf_bands: WORD32 = (*pstr_mps_state).qmf_bands;
    ...
    let mut sampling_freq: WORD32 = (*pstr_mps_state).sampling_freq;
    let mut sqrt_tab: *const WORD32 = ((*(*pstr_mps_state)
        .ia_mps_dec_mps_table
        .common_table_ptr)
        .sqrt_tab)
        .as_mut_ptr();
    let mut nstart: WORD32 = 0;
    let mut tmp_real: WORD32 = 0;
    let mut tmp_imag: WORD32 = 0;
    let mut temp_1: WORD32 = 0;
    let mut temp: WORD32 = 0;
    let mut qtemp1: WORD16 = 0;
    let mut qtemp2: WORD16 = 0;
    spec_zoom_real = ((*pstr_mps_state).mps_scratch_mem_v as *mut WORD8)
        .offset(
            (176 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as isize,
        ) as *mut WORD32;
    spec_zoom_imag = spec_zoom_real
        .offset(
            ((512 as usize)
    ...
    temp = (time_slots as core::ffi::c_int - 6 as core::ffi::c_int) as WORD32;
    ...
    while q < qmf_bands {
        qmf_real = qmf_real.offset(6 as core::ffi::c_int as isize);
        qmf_imag = qmf_imag.offset(6 as core::ffi::c_int as isize);
        p_buf_re = p_buf_real;
        p_buf_im = p_buf_imag;
        s = 0 as core::ffi::c_int as WORD32;
        while s < time_slots {
            tmp_real = 0 as core::ffi::c_int as WORD32;
            tmp_imag = 0 as core::ffi::c_int as WORD32;
            buf_real = p_buf_re;
            buf_imag = p_buf_im;
            c = 0 as core::ffi::c_int as WORD32;
            while c < num_input_channels {
                tmp_real += *buf_real;
                tmp_imag += *buf_imag;
                buf_real = buf_real.offset(TSXHB as isize);
                buf_imag = buf_imag.offset(TSXHB as isize);
                c += 1;
            }
            if s == temp {
                qmf_real = qmf_real.offset(-(time_slots as isize));
                qmf_imag = qmf_imag.offset(-(time_slots as isize));
            }
            if (s as core::ffi::c_int + 6 as core::ffi::c_int) < time_slots {
                let fresh0 = qmf_real;
                ...
                *fresh1 = tmp_imag;
                ...
                qmf_real = qmf_real.offset(1);
                *fresh2 = (*ton_state)
                    .buf_real[q as usize][(s + 6 as WORD32 - time_slots) as usize];
                let fresh3 = qmf_imag;
                qmf_imag = qmf_imag.offset(1);
                *fresh3 = (*ton_state)
                    .buf_imag[q as usize][(s + 6 as WORD32 - time_slots) as usize];
                (*ton_state)
                    .buf_real[q as usize][(s + 6 as WORD32 - time_slots) as usize] = tmp_real;
                (*ton_state)
                    .buf_imag[q as usize][(s + 6 as WORD32 - time_slots) as usize] = tmp_imag;
            }
            p_buf_re = p_buf_re.offset(MAX_HYBRID_BANDS as isize);
            p_buf_re = p_buf_re.offset(MAX_HYBRID_BANDS as isize);
            s += 1;
        }
        qmf_real = qmf_real.offset(temp as isize);
        qmf_imag = qmf_imag.offset(temp as isize);
        p_buf_real = p_buf_real.offset(1);
        p_buf_imag = p_buf_imag.offset(1);
        q += 1;
    }
    gmax = (*(*pstr_mps_state).ia_mps_dec_mps_table.tonality_table_ptr)
        .gmax_fix[time_slots as usize] as WORD32;
    dwin = (*(*pstr_mps_state).ia_mps_dec_mps_table.tonality_table_ptr)
        .dwin_fix[time_slots as usize];
    qtemp1 = 15 as WORD16;
    temp_1 = ixheaacd_mps_mult32(
        dwin,
        40 as WORD32 * qmf_bands,
        &mut qtemp1,
        0 as WORD16,
    );
    beta = ixheaacd_mps_div_32(temp_1, sampling_freq, &mut q_beta);
    q_beta = (q_beta as core::ffi::c_int + qtemp1 as core::ffi::c_int) as WORD16;
    beta = ixheaacd_mps_convert_to_qn(beta, q_beta, 15 as WORD16);
    i = 0 as core::ffi::c_int as WORD32;
    while i < num_parameter_bands {
        *tonality.offset(i as isize) = ONE_IN_Q15 as WORD32;
        i += 1;
    }
    g = 0 as core::ffi::c_int as WORD32;
    while g < gmax {
        nstart = (*(*pstr_mps_state).ia_mps_dec_mps_table.tonality_table_ptr)
            .nstart_fix[g as usize][time_slots as usize];
        if time_slots <= 16 as core::ffi::c_int {
            dfrac = 0 as core::ffi::c_int as WORD32;
        } else {
            dfrac = (*(*pstr_mps_state).ia_mps_dec_mps_table.tonality_table_ptr)
                .dfrac_fix[g
                as usize][(time_slots as core::ffi::c_int - 16 as core::ffi::c_int)
                as usize];
        }
        qmf_real = pow_spec.offset(QBX48 as isize);
        qmf_imag = qmf_real.offset(QMF_BANDSXTSX6 as isize);
        q = 0 as core::ffi::c_int as WORD32;
        while q < qmf_bands {
            i = 0 as core::ffi::c_int as WORD32;
            while i < 16 as core::ffi::c_int {
                if nstart + i < 0 as core::ffi::c_int {
                    (*ton_state).win_buf_real[q as usize][i as usize] = (*ton_state)
                        .win_buf_real[q as usize][(16 as WORD32 + nstart + i) as usize];
                    (*ton_state).win_buf_imag[q as usize][i as usize] = (*ton_state)
                        .win_buf_imag[q as usize][(16 as WORD32 + nstart + i) as usize];
                } else {
                    (*ton_state).win_buf_real[q as usize][i as usize] = *qmf_real
                        .offset((nstart + i) as isize);
                    (*ton_state).win_buf_imag[q as usize][i as usize] = *qmf_imag
                        .offset((nstart + i) as isize);
                }
                i += 1;
            }
        ...
        while q < qmf_bands {
            ixheaacd_zoom_fft16(
                &mut *(*((*ton_state).win_buf_real).as_mut_ptr().offset(q as isize))
                    .as_mut_ptr()
                    .offset(0 as core::ffi::c_int as isize),
                &mut *(*((*ton_state).win_buf_imag).as_mut_ptr().offset(q as isize))
                    .as_mut_ptr()
                    .offset(0 as core::ffi::c_int as isize),
                &mut *spec_zoom_real
                    .offset((q as core::ffi::c_int * 8 as core::ffi::c_int) as isize),
                &mut *spec_zoom_imag
                    .offset((q as core::ffi::c_int * 8 as core::ffi::c_int) as isize),
                q,
                dfrac,
        ...
        cnt = 8 as WORD32 * qmf_bands;
        i = 0 as core::ffi::c_int as WORD32;
        while i < cnt {
            let mut temp_0: WORD64 = 0;
            let mut one_minus_beta: WORD32 = ONE_IN_Q15 - beta;
            let mut x: WORD32 = *spec_zoom_real;
            let mut y: WORD32 = *spec_zoom_imag;
            temp_0 = (x * *spec_prev_real.offset(i as isize)
                + y * *spec_prev_imag.offset(i as isize)) as WORD64;
            temp_1 = (temp_0 >> 10 as core::ffi::c_int) as WORD32;
            temp_1 = ixheaacd_mps_mult32_shr_15(temp_1, beta);
            *p_cross_real.offset(i as isize) = ixheaacd_mps_mult32_shr_15(
                *p_cross_real.offset(i as isize),
                one_minus_beta,
            );
            *p_cross_real.offset(i as isize) += temp_1;
            temp_0 = (y * *spec_prev_real.offset(i as isize)
                - x * *spec_prev_imag.offset(i as isize)) as WORD64;
            temp_1 = (temp_0 >> 10 as core::ffi::c_int) as WORD32;
            temp_1 = ixheaacd_mps_mult32_shr_15(temp_1, beta);
            *p_cross_imag.offset(i as isize) = ixheaacd_mps_mult32_shr_15(
                *p_cross_imag.offset(i as isize),
                one_minus_beta,
            );
            *p_cross_imag.offset(i as isize) += temp_1;
            temp_0 = (x * x + y * y) as WORD64;
            temp_1 = (temp_0 >> 10 as core::ffi::c_int) as WORD32;
            temp_1 = ixheaacd_mps_mult32_shr_15(temp_1, beta);
            *p_sum.offset(i as isize) = ixheaacd_mps_mult32_shr_15(
                *p_sum.offset(i as isize),
                one_minus_beta,
            );
            *p_sum.offset(i as isize) += temp_1;
            *p_max = if *p_sum.offset(i as isize) > *p_sum_prev.offset(i as isize) {
                *p_sum.offset(i as isize)
            } else {
                *p_sum_prev.offset(i as isize)
            };
            *p_sum_prev.offset(i as isize) = *p_sum.offset(i as isize);
            temp_0 = (*p_cross_real.offset(i as isize) * *p_cross_real.offset(i as isize)
                + *p_cross_imag.offset(i as isize) * *p_cross_imag.offset(i as isize))
                as WORD64;
            temp_1 = (temp_0 >> 10 as core::ffi::c_int) as WORD32;
            qtemp1 = 10 as WORD16;
            temp_1 = ixheaacd_mps_sqrt(temp_1, &mut qtemp1, sqrt_tab);
            let fresh4 = p_max;
            p_max = p_max.offset(1);
            *coh_spec = ixheaacd_mps_div_32(temp_1, *fresh4, &mut qtemp2);
            qtemp2 = (qtemp2 as core::ffi::c_int + qtemp1 as core::ffi::c_int
                - 10 as core::ffi::c_int) as WORD16;
            *coh_spec = ixheaacd_mps_convert_to_qn(*coh_spec, qtemp2, 10 as WORD16);
            coh_spec = coh_spec.offset(1);
            temp_0 = (x * x + y * y
                + *spec_prev_real.offset(i as isize) * *spec_prev_real.offset(i as isize)
                + *spec_prev_imag.offset(i as isize)
                    * *spec_prev_imag.offset(i as isize)) as WORD64;
            *pow_spec = (temp_0 >> 10 as core::ffi::c_int) as WORD32;
            let fresh5 = spec_zoom_real;
            spec_zoom_real = spec_zoom_real.offset(1);
            *spec_prev_real.offset(i as isize) = *fresh5;
            let fresh6 = spec_zoom_imag;
            spec_zoom_imag = spec_zoom_imag.offset(1);
            *spec_prev_imag.offset(i as isize) = *fresh6;
            i += 1;
        }
        spec_zoom_real = spec_zoom_real.offset(-(i as isize));
        spec_zoom_imag = spec_zoom_imag.offset(-(i as isize));
        p_max = p_max.offset(-(i as isize));
        coh_spec = coh_spec.offset(-(i as isize));
        pow_spec = pow_spec.offset(-(i as isize));
        pstart = 0 as core::ffi::c_int as WORD32;
        pqmf = 0 as core::ffi::c_int as WORD32;
        i = 0 as core::ffi::c_int as WORD32;
        while i < num_parameter_bands {
            pqmf += *part.offset(i as isize);
            pstop = (((pqmf as core::ffi::c_int) << 3 as core::ffi::c_int) + ONE_IN_Q14
                >> 15 as core::ffi::c_int) as WORD32;
            num = 0 as core::ffi::c_int as WORD32;
            den = 0 as core::ffi::c_int as WORD32;
            j = pstart;
            while j < pstop {
                num += ixheaacd_mps_mult32_shr_n(*pow_spec, *coh_spec, 10 as WORD16);
                coh_spec = coh_spec.offset(1);
                let fresh7 = pow_spec;
                pow_spec = pow_spec.offset(1);
                den += *fresh7;
                j += 1;
            }
            tmp_ton = ixheaacd_mps_div_32(num, den, &mut q_tmp_ton);
            ixheaacd_mps_convert_to_qn(tmp_ton, q_tmp_ton, 15 as WORD16);
            if tmp_ton > 32767 as core::ffi::c_int {
                tmp_ton = 32767 as core::ffi::c_int as WORD32;
            }
            if tmp_ton < *tonality.offset(i as isize) {
                *tonality.offset(i as isize) = tmp_ton;
            }
            pstart = pstop;
            i += 1;
        }
        coh_spec = coh_spec.offset(-(pstop as isize));
        pow_spec = pow_spec.offset(-(pstop as isize));
        g += 1;
    }
}
