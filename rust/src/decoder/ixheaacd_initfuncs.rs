...
pub const OVERLAP_BUFFER_SIZE: core::ffi::c_int = 512 as core::ffi::c_int;
pub const NULL: *mut core::ffi::c_void = 0 as *mut core::ffi::c_void;
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_set_aac_persistent_buffers(
    mut aac_persistent_mem_v: *mut core::ffi::c_void,
    mut num_channel: WORD32,
) -> WORD32 {
    let mut persistent_used: WORD32 = 0;
    let mut aac_persistent_mem: *mut ia_aac_persistent_struct = aac_persistent_mem_v
        as *mut ia_aac_persistent_struct;
    persistent_used = ((::core::mem::size_of::<ia_aac_persistent_struct>() as usize)
        .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
        & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize) as WORD32;
    memset(
        aac_persistent_mem as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_aac_persistent_struct>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    (*aac_persistent_mem).overlap_buffer = (aac_persistent_mem_v as *mut WORD8)
        .offset(persistent_used as isize) as *mut WORD32;
    memset(
        (aac_persistent_mem_v as *mut WORD8).offset(persistent_used as isize)
            as *mut WORD32 as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((4 as WORD32 * 512 as WORD32 * num_channel) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    persistent_used = (persistent_used as core::ffi::c_ulong)
        .wrapping_add(
    ...
    (*aac_persistent_mem).sbr_payload_buffer = (aac_persistent_mem_v as *mut WORD8)
        .offset(persistent_used as isize);
    memset(
        (aac_persistent_mem_v as *mut WORD8).offset(persistent_used as isize)
            as *mut WORD16 as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
    ...
    (*aac_persistent_mem).prev_sbr_payload_buffer = (aac_persistent_mem_v as *mut WORD8)
        .offset(persistent_used as isize);
    memset(
        (*aac_persistent_mem).prev_sbr_payload_buffer as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (num_channel as size_t)
            .wrapping_mul(
                (1024 as size_t)
    ...
    while i < num_channel {
        (*aac_persistent_mem).ltp_buf[i as usize] = (aac_persistent_mem_v as *mut WORD8)
            .offset(persistent_used as isize) as *mut WORD16;
        memset(
            (aac_persistent_mem_v as *mut WORD8).offset(persistent_used as isize)
                as *mut WORD16 as *mut core::ffi::c_void,
            0 as core::ffi::c_int,
            (ltp_buffer_size as core::ffi::c_int as size_t)
        ...
        (*aac_persistent_mem).ptr_aac_dec_static_channel_info[i as usize] = (aac_persistent_mem_v
            as *mut WORD8)
            .offset(persistent_used as isize) as *mut ia_aac_dec_channel_info;
        persistent_used = (persistent_used as core::ffi::c_ulong)
            .wrapping_add(
        ...
        (*(*aac_persistent_mem).ptr_aac_dec_static_channel_info[i as usize])
            .overlap_add_data
            .win_shape = 0 as WORD16;
        (*(*aac_persistent_mem).ptr_aac_dec_static_channel_info[i as usize])
            .overlap_add_data
            .win_seq = 0 as WORD16;
        (*(*aac_persistent_mem).ptr_aac_dec_static_channel_info[i as usize])
            .overlap_add_data
            .ptr_overlap_buf = &mut *((*aac_persistent_mem).overlap_buffer)
            .offset((i as core::ffi::c_int * OVERLAP_BUFFER_SIZE) as isize)
            as *mut WORD32;
        i += 1;
    }
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_huff_tables_create(
    mut ptr_aac_tables: *mut ia_aac_dec_tables_struct,
) -> VOID {
    (*ptr_aac_tables).code_book[0 as core::ffi::c_int as usize] = 0 as *mut UWORD16;
    (*ptr_aac_tables).code_book[1 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb1)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[2 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb2)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[3 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb3)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[4 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb4)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[5 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb5)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[6 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb6)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[7 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb7)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[8 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb8)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[9 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb9)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[10 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb10)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[11 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb10)
        .as_mut_ptr();
    (*ptr_aac_tables).code_book[12 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .input_table_cb10)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[1 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf1)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[2 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf2)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[3 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf3)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[4 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf4)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[5 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf5)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[6 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf6)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[7 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf7)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[8 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf8)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[9 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf9)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[10 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf10)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[11 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf10)
        .as_mut_ptr();
    (*ptr_aac_tables).index_table[12 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .idx_table_hf10)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[0 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[1 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[2 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[3 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[4 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[5 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[6 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[7 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[8 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[9 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[10 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[11 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_8_128)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[12 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[13 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[14 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[15 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[16 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[17 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[18 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[19 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[20 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[21 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[22 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_short[23 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_8_120)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[0 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[1 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[2 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_64_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[3 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[4 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[5 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_32_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[6 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[7 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[8 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[9 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[10 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[11 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_8_1024)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[12 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[13 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_96_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[14 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_64_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[15 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[16 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[17 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[18 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[19 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[20 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[21 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[22 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_16_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_factor_bands_long[23 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_8_960)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[0 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[1 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[2 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[3 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[4 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[5 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_32_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[6 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[7 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[8 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[9 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[10 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[11 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[12 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[13 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[14 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_512[15 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_512)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[0 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[1 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[2 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[3 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[4 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_48_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[5 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_32_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[6 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[7 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[8 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[9 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[10 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[11 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[12 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[13 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[14 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
    (*ptr_aac_tables).scale_fac_bands_480[15 as core::ffi::c_int as usize] = ((*(*ptr_aac_tables)
        .pstr_huffmann_tables)
        .ixheaacd_sfb_24_480)
        .as_mut_ptr();
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_aac_decoder_init(
    mut p_state_enhaacplus_dec: *mut ia_aac_dec_state_struct,
    mut ptr_sbr_bitstream: *mut ia_aac_dec_sbr_bitstream_struct,
    mut channels: WORD,
    mut aac_persistent_mem_v: *mut core::ffi::c_void,
    ...
    let mut aac_persistent_mem: *mut ia_aac_persistent_struct = 0
        as *mut ia_aac_persistent_struct;
    aac_persistent_mem = aac_persistent_mem_v as *mut ia_aac_persistent_struct;
    (*aac_persistent_mem).str_aac_decoder.pstr_sbr_bitstream = ptr_sbr_bitstream;
    ch = 0 as core::ffi::c_int as WORD;
    while ch < channels {
        let mut aac_dec_handle: *mut ia_aac_decoder_struct = &mut (*aac_persistent_mem)
            .str_aac_decoder;
        (*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize] = &mut *((*aac_persistent_mem)
            .str_aac_dec_overlap_info)
            .as_mut_ptr()
            .offset(ch as isize) as *mut ia_aac_dec_overlap_info;
        (*aac_dec_handle).pstr_pns_rand_vec_data = &mut (*aac_persistent_mem)
            .str_pns_rand_vec_data;
        (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize]).window_shape = 0
            as WORD16;
        (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize]).window_sequence = 0
            as WORD16;
            ...
            == AOT_ER_AAC_ELD as core::ffi::c_int as core::ffi::c_uint
        {
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_overlap_buf = &mut *((*aac_persistent_mem).overlap_buffer)
                .offset(
                    (ch as core::ffi::c_int * 4 as core::ffi::c_int
                        * OVERLAP_BUFFER_SIZE) as isize,
                ) as *mut WORD32;
        } else {
            (*(*aac_dec_handle).pstr_aac_dec_overlap_info[ch as usize])
                .ptr_overlap_buf = &mut *((*aac_persistent_mem).overlap_buffer)
                .offset((ch as core::ffi::c_int * OVERLAP_BUFFER_SIZE) as isize)
                as *mut WORD32;
        }
        let mut ptr_overlap_buf: *mut WORD32 = (*(*aac_dec_handle)
            .pstr_aac_dec_overlap_info[ch as usize])
            .ptr_overlap_buf;
        memset(
            ptr_overlap_buf as *mut core::ffi::c_void,
            0 as core::ffi::c_int,
            (::core::mem::size_of::<WORD32>() as size_t)
                .wrapping_mul(4 as size_t)
                .wrapping_mul(512 as size_t)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
        );
        (*aac_persistent_mem)
            .str_aac_decoder
            .ptr_aac_dec_static_channel_info[ch as usize] = (*aac_persistent_mem)
            .ptr_aac_dec_static_channel_info[ch as usize];
        (*(*aac_persistent_mem)
            .str_aac_decoder
            .ptr_aac_dec_static_channel_info[ch as usize])
            .ltp_buf = (*aac_persistent_mem).ltp_buf[ch as usize];
        ch += 1;
    }
    i = 0 as core::ffi::c_int as WORD;
    while i < 1 as core::ffi::c_int {
        let mut ptr_sbr_bitstream_0: *mut ia_aac_dec_sbr_bitstream_struct = &mut *((*aac_persistent_mem)
            .str_aac_decoder
            .pstr_sbr_bitstream)
            .offset(i as isize) as *mut ia_aac_dec_sbr_bitstream_struct;
        (*ptr_sbr_bitstream_0).no_elements = 0 as WORD16;
        let ref mut fresh0 = (*((*ptr_sbr_bitstream_0).str_sbr_ele)
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize))
            .ptr_sbr_data;
        *fresh0 = &mut *((*aac_persistent_mem).sbr_payload_buffer)
            .offset(
                (((1024 as WORD + 7 as WORD >> 3 as core::ffi::c_int)
                    << 3 as core::ffi::c_int) * i) as isize,
            ) as *mut WORD8;
        let ref mut fresh1 = (*((*ptr_sbr_bitstream_0).str_sbr_ele)
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize))
            .ptr_prev_sbr_data;
        *fresh1 = &mut *((*aac_persistent_mem).prev_sbr_payload_buffer)
            .offset(
                (((1024 as WORD + 7 as WORD >> 3 as core::ffi::c_int)
                    << 3 as core::ffi::c_int) * i) as isize,
            ) as *mut WORD8;
        (*((*ptr_sbr_bitstream_0).str_sbr_ele)
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize))
            .sbr_ele_id = ID_SCE as core::ffi::c_int as WORD32;
        (*((*ptr_sbr_bitstream_0).str_sbr_ele)
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize))
            .size_payload = 0 as core::ffi::c_int as WORD32;
        (*((*ptr_sbr_bitstream_0).str_sbr_ele)
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize))
            .prev_size_payload = 0 as core::ffi::c_int as WORD32;
        (*((*ptr_sbr_bitstream_0).str_sbr_ele)
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize))
            .prev_sbr_ele_id = ID_SCE as core::ffi::c_int as WORD32;
        (*((*ptr_sbr_bitstream_0).str_sbr_ele)
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize))
            .size_payload_old = 0 as core::ffi::c_int as WORD32;
        i += 1;
    }
    let mut ptr_aac_tables: *mut ia_aac_dec_tables_struct = (*aac_persistent_mem)
        .str_aac_decoder
        .pstr_aac_tables;
    let mut pstr_huffmann_tables: *mut ia_aac_dec_huffman_tables_struct = (*ptr_aac_tables)
        .pstr_huffmann_tables;
    let mut num_entries: WORD = (::core::mem::size_of::<
        [ia_sampling_rate_info_struct; 13],
    >() as usize)
        .wrapping_div(::core::mem::size_of::<ia_sampling_rate_info_struct>() as usize)
        as WORD;
    let mut sampling_rate: WORD32 = (*p_state_enhaacplus_dec).sampling_rate as WORD32;
    let mut sfidx: WORD = 0;
    i = 0 as core::ffi::c_int as WORD;
    while i < num_entries
        && sampling_rate
            != (*pstr_huffmann_tables)
                .str_sample_rate_info[i as usize]
                .sampling_frequency
    {
        i += 1;
    }
    if i == 12 as core::ffi::c_int {
        i = (i as core::ffi::c_int - 1 as core::ffi::c_int) as WORD;
    }
    if i == num_entries {
        return 0 as *mut ia_aac_decoder_struct;
    }
    sfidx = i;
    if frame_length == 1024 as core::ffi::c_int
        || frame_length == 960 as core::ffi::c_int
    {
        let mut psfb_table_idx: [*mut WORD16; 2] = [0 as *mut WORD16; 2];
        let mut psfb_width: [*const WORD8; 2] = [0 as *const WORD8; 2];
        let mut width_idx: WORD = 0;
        let mut j: WORD32 = 0;
        if frame_length == 960 as core::ffi::c_int {
            sfidx += 12 as core::ffi::c_int;
        }
        psfb_table_idx[0 as core::ffi::c_int as usize] = ((*ptr_aac_tables)
            .sfb_long_table)
            .as_mut_ptr();
        psfb_table_idx[1 as core::ffi::c_int as usize] = ((*ptr_aac_tables)
            .sfb_short_table)
            .as_mut_ptr();
        psfb_width[0 as core::ffi::c_int as usize] = (*ptr_aac_tables)
            .scale_factor_bands_long[sfidx as usize];
        psfb_width[1 as core::ffi::c_int as usize] = (*ptr_aac_tables)
            .scale_factor_bands_short[sfidx as usize];
        j = 1 as core::ffi::c_int as WORD32;
        while j >= 0 as core::ffi::c_int {
            let mut ptr_width: *const WORD8 = psfb_width[j as usize];
            let mut ptable_idx: *mut WORD16 = psfb_table_idx[j as usize];
            width_idx = 0 as core::ffi::c_int as WORD;
            let fresh2 = ptable_idx;
            ptable_idx = ptable_idx.offset(1);
            *fresh2 = width_idx as WORD16;
            loop {
                let fresh3 = ptr_width;
                ptr_width = ptr_width.offset(1);
                width_idx += *fresh3 as core::ffi::c_int;
                let fresh4 = ptable_idx;
                ptable_idx = ptable_idx.offset(1);
                *fresh4 = width_idx as WORD16;
                if !(*ptr_width as core::ffi::c_int != -(1 as core::ffi::c_int)) {
                    break;
                }
            }
            (*aac_persistent_mem).str_aac_decoder.num_swb_window[j as usize] = ptr_width
                .offset_from(psfb_width[j as usize]) as core::ffi::c_long as WORD8;
            j -= 1;
        }
        (*ptr_aac_tables).str_aac_sfb_info[0 as core::ffi::c_int as usize].sfb_index = ((*ptr_aac_tables)
            .sfb_long_table)
            .as_mut_ptr();
        (*ptr_aac_tables).str_aac_sfb_info[1 as core::ffi::c_int as usize].sfb_index = ((*ptr_aac_tables)
            .sfb_long_table)
            .as_mut_ptr();
        (*ptr_aac_tables).str_aac_sfb_info[3 as core::ffi::c_int as usize].sfb_index = ((*ptr_aac_tables)
            .sfb_long_table)
            .as_mut_ptr();
        (*ptr_aac_tables).str_aac_sfb_info[2 as core::ffi::c_int as usize].sfb_index = ((*ptr_aac_tables)
            .sfb_short_table)
            .as_mut_ptr();
        (*ptr_aac_tables).str_aac_sfb_info[0 as core::ffi::c_int as usize].sfb_width = psfb_width[0
            as core::ffi::c_int as usize] as *mut WORD8;
        (*ptr_aac_tables).str_aac_sfb_info[1 as core::ffi::c_int as usize].sfb_width = psfb_width[0
            as core::ffi::c_int as usize] as *mut WORD8;
        (*ptr_aac_tables).str_aac_sfb_info[3 as core::ffi::c_int as usize].sfb_width = psfb_width[0
            as core::ffi::c_int as usize] as *mut WORD8;
        (*ptr_aac_tables).str_aac_sfb_info[2 as core::ffi::c_int as usize].sfb_width = psfb_width[1
            as core::ffi::c_int as usize] as *mut WORD8;
    } else {
        let mut ptr_sfb_idx: [*mut WORD16; 2] = [0 as *mut WORD16; 2];
        let mut ptr_sfb_width: [*const WORD8; 2] = [
            0 as *const WORD8,
            0 as *const WORD8,
        ];
        let mut width_idx_0: WORD = 0;
        let mut j_0: WORD32 = 0;
        ptr_sfb_idx[0 as core::ffi::c_int as usize] = ((*ptr_aac_tables).sfb_long_table)
            .as_mut_ptr();
        ptr_sfb_idx[1 as core::ffi::c_int as usize] = ((*ptr_aac_tables).sfb_short_table)
            .as_mut_ptr();
        if frame_length == 512 as core::ffi::c_int {
            ptr_sfb_width[0 as core::ffi::c_int as usize] = (*ptr_aac_tables)
                .scale_fac_bands_512[i as usize];
        } else {
            ptr_sfb_width[0 as core::ffi::c_int as usize] = (*ptr_aac_tables)
                .scale_fac_bands_480[i as usize];
        }
        j_0 = 0 as core::ffi::c_int as WORD32;
        while j_0 >= 0 as core::ffi::c_int {
            let mut ptr_width_0: *const WORD8 = ptr_sfb_width[j_0 as usize];
            let mut ptr_idx: *mut WORD16 = ptr_sfb_idx[j_0 as usize];
            width_idx_0 = 0 as core::ffi::c_int as WORD;
            let fresh5 = ptr_idx;
            ptr_idx = ptr_idx.offset(1);
            *fresh5 = width_idx_0 as WORD16;
            loop {
                let fresh6 = ptr_width_0;
                ptr_width_0 = ptr_width_0.offset(1);
                width_idx_0 += *fresh6 as core::ffi::c_int;
                let fresh7 = ptr_idx;
                ptr_idx = ptr_idx.offset(1);
                *fresh7 = width_idx_0 as WORD16;
                if !(*ptr_width_0 as core::ffi::c_int != -(1 as core::ffi::c_int)) {
                    break;
                }
            }
            (*aac_persistent_mem).str_aac_decoder.num_swb_window[j_0 as usize] = ptr_width_0
                .offset_from(ptr_sfb_width[j_0 as usize]) as core::ffi::c_long as WORD8;
            j_0 -= 1;
        }
        (*ptr_aac_tables).str_aac_sfb_info[0 as core::ffi::c_int as usize].sfb_index = ((*ptr_aac_tables)
            .sfb_long_table)
        ...
        (*ptr_aac_tables).str_aac_sfb_info[2 as core::ffi::c_int as usize].sfb_index = ((*ptr_aac_tables)
            .sfb_short_table)
            .as_mut_ptr();
        (*ptr_aac_tables).str_aac_sfb_info[0 as core::ffi::c_int as usize].sfb_width = ptr_sfb_width[0
            as core::ffi::c_int as usize] as *mut WORD8;
        (*ptr_aac_tables).str_aac_sfb_info[1 as core::ffi::c_int as usize].sfb_width = ptr_sfb_width[0
            as core::ffi::c_int as usize] as *mut WORD8;
        (*ptr_aac_tables).str_aac_sfb_info[3 as core::ffi::c_int as usize].sfb_width = ptr_sfb_width[0
            as core::ffi::c_int as usize] as *mut WORD8;
        (*ptr_aac_tables).str_aac_sfb_info[2 as core::ffi::c_int as usize].sfb_width = ptr_sfb_width[1
            as core::ffi::c_int as usize] as *mut WORD8;
    }
    let mut aac_dec_handle_0: *mut ia_aac_decoder_struct = &mut (*aac_persistent_mem)
        .str_aac_decoder;
    (*aac_dec_handle_0).sampling_rate_index = i as WORD16;
    (*aac_dec_handle_0).sampling_rate = sampling_rate;
    (*aac_dec_handle_0).channels = 1 as WORD16;
    (*aac_dec_handle_0).block_number = 0 as core::ffi::c_int as WORD32;
    (*aac_dec_handle_0).samples_per_frame = frame_length;
    return &mut (*aac_persistent_mem).str_aac_decoder;
}
