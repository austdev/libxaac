extern "C" {
    ...
    static ixheaacd_mps_dec_res_block_tables: ia_mps_dec_res_block_tables_struct;
    static ixheaacd_mps_dec_res_huffmann_tables: ia_mps_dec_res_huffmann_tables_struct;
    ...
    fn ixheaacd_syn_filt_bank_init(
        self_0: ia_mps_dec_synthesis_interface_handle,
        resolution: WORD32,
    ) -> IA_ERRORCODE;
    fn ixheaacd_decorr_create(
        hDecorrDec: ia_mps_dec_decorr_dec_handle,
        subbands: WORD32,
        seed: WORD32,
        dec_type: WORD32,
        decorr_config: WORD32,
        ia_mps_dec_mps_table: *mut ia_mps_dec_mps_tables_struct,
    ) -> WORD32;
    fn ixheaacd_parse_specific_config(
        pstr_mps_state: *mut ia_heaac_mps_state_struct,
        sac_header_len: WORD32,
    ) -> IA_ERRORCODE;
    fn ixheaacd_default_specific_config(
        pstr_mps_state: *mut ia_heaac_mps_state_struct,
        sampling_freq: WORD32,
    ) -> IA_ERRORCODE;
    fn ixheaacd_set_current_state_parameters(
        pstr_mps_state: *mut ia_heaac_mps_state_struct,
    ) -> IA_ERRORCODE;
    fn ixheaacd_mdct2qmf_create(
        pstr_mps_state: *mut ia_heaac_mps_state_struct,
    ) -> IA_ERRORCODE;
    fn ixheaacd_init_tonality(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_init_bb_env(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    fn ixheaacd_init_ana_hyb_filt_bank(
        hyb_state: *mut ia_mps_dec_thyb_filter_state_struct,
    ) -> VOID;
    fn ixheaacd_init_blind(pstr_mps_state: *mut ia_heaac_mps_state_struct) -> VOID;
    ...
    static ixheaacd_mps_dec_wf_tables: ia_mps_dec_wf_tables_struct;
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ia_mps_dec_wf_tables_struct {
    pub wf_02: [WORD32; 2],
    pub wf_03: [WORD32; 3],
    pub wf_04: [WORD32; 4],
    pub wf_15: [WORD32; 15],
...
#[derive(Copy, Clone)]
#[repr(C)]
pub struct ia_mps_dec_decorr_dec_struct {
...
pub type ia_mps_dec_decorr_dec_handle = *mut ia_mps_dec_decorr_dec_struct;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const TREE_7572: C2RustUnnamed = 6;
pub const TREE_7571: C2RustUnnamed = 5;
pub const TREE_7272: C2RustUnnamed = 4;
pub const TREE_7271: C2RustUnnamed = 3;
pub const TREE_525: C2RustUnnamed = 2;
pub const TREE_5152: C2RustUnnamed = 1;
pub const TREE_5151: C2RustUnnamed = 0;
...
pub const MAX_NUM_TTT: core::ffi::c_int = 1 as core::ffi::c_int;
...
pub const MAX_RESIDUAL_FRAMES: core::ffi::c_int = 4 as core::ffi::c_int;
pub const MAX_OUTPUT_CHANNELS_MPS: core::ffi::c_int = 8 as core::ffi::c_int;
pub const MAX_M2_INPUT: core::ffi::c_int = 8 as core::ffi::c_int;
pub const MAX_M2_OUTPUT: core::ffi::c_int = 8 as core::ffi::c_int;
pub const MAX_NO_DECORR_CHANNELS: core::ffi::c_int = 5 as core::ffi::c_int;
pub const MAX_OUTPUT_CHANNELS_AT_MPS: core::ffi::c_int = 8 as core::ffi::c_int;
pub const QMF_FILTER_STATE_ANA_SIZE_MPS: core::ffi::c_int = 640 as core::ffi::c_int;
...
pub const SYN_BUFFER_SIZE: core::ffi::c_int = 18432 as core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_getsize_mps_persistent() -> WORD32 {
    return ((::core::mem::size_of::<ia_mps_persistent_mem>() as usize)
        .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
        & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize) as WORD32;
}
unsafe extern "C" fn ixheaacd_calc_decorr_size() -> WORD32 {
    let mut matrix_alloc_size: WORD32 = 0;
    let mut decorr_filter_size: WORD32 = 0;
    let mut num_den_size: WORD32 = 0;
    let mut fraction_alloc_size: WORD32 = 0;
    let mut ducker_create_size: WORD32 = 0;
    let mut decor_dec_size: WORD32 = 0;
    let mut state_alloc_size: WORD32 = 0;
    let mut alloc_size: WORD32 = 0;
    let mut dec_type: WORD32 = 0 as WORD32;
    matrix_alloc_size = ((MAX_NO_DECORR_CHANNELS * 2 as core::ffi::c_int) as usize)
        .wrapping_mul(
            (MAX_HYBRID_BANDS as usize)
                .wrapping_mul(
                    ((72 as core::ffi::c_int + 14 as core::ffi::c_int) as usize)
    ...
    decorr_filter_size = ((MAX_NO_DECORR_CHANNELS * MAX_HYBRID_BANDS) as usize)
        .wrapping_mul(
            (::core::mem::size_of::<ia_mps_dec_decorr_filter_instance_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize,
        ) as WORD32;
    num_den_size = ((MAX_NO_DECORR_CHANNELS * MAX_HYBRID_BANDS) as usize)
        .wrapping_mul(
            (21 as usize)
                .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
    ...
    if dec_type == 1 as core::ffi::c_int {
        fraction_alloc_size = 4 as WORD32 * num_den_size;
    } else {
        fraction_alloc_size = 2 as WORD32 * num_den_size;
    }
    state_alloc_size = ((MAX_NO_DECORR_CHANNELS * MAX_HYBRID_BANDS
    ...
    ducker_create_size = (MAX_NO_DECORR_CHANNELS as usize)
        .wrapping_mul(
            ((::core::mem::size_of::<ia_mps_dec_ducker_interface>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                .wrapping_add(
                    (::core::mem::size_of::<ia_mps_dec_duck_instance_struct>() as usize)
                        .wrapping_add(
                            (8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize,
                        ) & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize,
                ),
        ) as WORD32;
    decor_dec_size = (MAX_NO_DECORR_CHANNELS as usize)
        .wrapping_mul(
            (::core::mem::size_of::<ia_mps_dec_decorr_dec_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize,
        ) as WORD32;
    alloc_size = matrix_alloc_size + decorr_filter_size + fraction_alloc_size
        + ducker_create_size + decor_dec_size + state_alloc_size;
    return 2 as WORD32 * alloc_size;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_mps_persistent_buffer_sizes() -> WORD32 {
    let mut buffer_size: WORD32 = 0;
    buffer_size = ixheaacd_getsize_mps_persistent();
    buffer_size
        += 5824 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 24 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 5376 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 5376 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 1680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 1680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 2128 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 2128 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 7680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 7680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 15360 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((18432 as usize)
                .wrapping_add(
                    ::core::mem::size_of::<ia_mps_dec_synthesis_interface>() as usize,
                )
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
    ...
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_thyb_filter_state_struct>() as usize)
    ...
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_tonality_state_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
        ) as WORD32 as WORD32;
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_smoothing_state_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
        ) as WORD32 as WORD32;
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_reshape_bb_env_state_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
        ) as WORD32 as WORD32;
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_subband_tp_params_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
        ) as WORD32 as WORD32;
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_blind_decoder_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
        ) as WORD32 as WORD32;
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_spatial_bs_frame_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
        ) as WORD32 as WORD32;
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_reuse_array_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
        ) as WORD32 as WORD32;
    buffer_size
        += 327680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 368640 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 368640 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 110592 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 110592 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 163584 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size
        += 163584 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_auxilary_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
        ) as WORD32 as WORD32;
    buffer_size = (buffer_size as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_m2_param_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                as core::ffi::c_ulong,
        ) as WORD32 as WORD32;
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_set_mps_persistent_buffers(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
    mut persistent_used: *mut WORD32,
    mut num_channel: WORD32,
    mut persistent_mem: *mut core::ffi::c_void,
) -> VOID {
    let mut used_persistent: WORD32 = *persistent_used;
    let mut mps_persistent_mem: *mut ia_mps_persistent_mem = &mut (*pstr_mps_state)
        .mps_persistent_mem;
    let mut decorr_size: WORD32 = 0;
    num_channel = (if 2 as core::ffi::c_int > num_channel {
        2 as core::ffi::c_int
    } else {
        num_channel as core::ffi::c_int
    }) as WORD32;
    (*mps_persistent_mem).prev_gain_at = persistent_mem as *mut WORD8 as *mut WORD32;
    memset(
        (*mps_persistent_mem).prev_gain_at as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (5824 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
    ...
    used_persistent
        += 5824 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).arbdmx_alpha_prev = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).arbdmx_alpha_prev as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (24 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    used_persistent
        += 24 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).m1_param_real_prev = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).m1_param_real_prev as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (5376 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    used_persistent
        += 5376 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).m1_param_imag_prev = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).m1_param_imag_prev as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (5376 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    used_persistent
        += 5376 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).m2_decor_real_prev = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).m2_decor_real_prev as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (1680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    used_persistent
        += 1680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).m2_decor_imag_prev = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).m2_decor_imag_prev as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (1680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    used_persistent
        += 1680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).m2_resid_real_prev = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).m2_resid_real_prev as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (2128 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    used_persistent
        += 2128 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).m2_resid_imag_prev = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).m2_resid_imag_prev as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (2128 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    used_persistent
        += 2128 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).qmf_input_delay_real = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).qmf_input_delay_real as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (7680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    used_persistent
        += 7680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).qmf_input_delay_imag = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).qmf_input_delay_imag as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (7680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    used_persistent
        += 7680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*mps_persistent_mem).syn_qmf_states_buffer = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).syn_qmf_states_buffer as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (18432 as size_t)
            .wrapping_add(
                ::core::mem::size_of::<ia_mps_dec_synthesis_interface>() as size_t,
            )
    ...
    (*mps_persistent_mem).ana_qmf_states_buffer = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    memset(
        (*mps_persistent_mem).ana_qmf_states_buffer as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (15360 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int)) as size_t,
    );
    ...
    (*mps_persistent_mem).decorr_ptr = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32 as *mut core::ffi::c_void;
    memset(
        (*mps_persistent_mem).decorr_ptr as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        decorr_size as size_t,
    );
    used_persistent += decorr_size;
    (*mps_persistent_mem).hyb_filter_state = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_thyb_filter_state_struct;
    memset(
        (*mps_persistent_mem).hyb_filter_state as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_mps_dec_thyb_filter_state_struct>() as size_t)
    ...
    (*mps_persistent_mem).ton_state = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_tonality_state_struct;
    memset(
        (*mps_persistent_mem).ton_state as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_mps_dec_tonality_state_struct>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    used_persistent = (used_persistent as core::ffi::c_ulong)
    ...
    (*mps_persistent_mem).smooth_state = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_smoothing_state_struct;
    memset(
        (*mps_persistent_mem).smooth_state as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_mps_dec_smoothing_state_struct>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    used_persistent = (used_persistent as core::ffi::c_ulong)
    ...
    (*mps_persistent_mem).reshape_bb_env_state = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_reshape_bb_env_state_struct;
    memset(
        (*mps_persistent_mem).reshape_bb_env_state as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_mps_dec_reshape_bb_env_state_struct>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    used_persistent = (used_persistent as core::ffi::c_ulong)
    ...
    (*mps_persistent_mem).sub_band_params = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_subband_tp_params_struct;
    memset(
        (*mps_persistent_mem).sub_band_params as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_mps_dec_subband_tp_params_struct>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    used_persistent = (used_persistent as core::ffi::c_ulong)
    ...
    (*mps_persistent_mem).blind_decoder = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_blind_decoder_struct;
    memset(
        (*mps_persistent_mem).blind_decoder as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_mps_dec_blind_decoder_struct>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    used_persistent = (used_persistent as core::ffi::c_ulong)
    ...
    (*mps_persistent_mem).p_bs_frame = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_spatial_bs_frame_struct;
    memset(
        (*mps_persistent_mem).p_bs_frame as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_mps_dec_spatial_bs_frame_struct>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    used_persistent = (used_persistent as core::ffi::c_ulong)
    ...
    (*pstr_mps_state).array_struct = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_reuse_array_struct;
    memset(
        (*pstr_mps_state).array_struct as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<ia_mps_dec_reuse_array_struct>() as size_t)
            .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as size_t,
    );
    used_persistent = (used_persistent as core::ffi::c_ulong)
    ...
    let mut p_array_struct: *mut ia_mps_dec_reuse_array_struct = (*pstr_mps_state)
        .array_struct;
    (*p_array_struct).res_mdct = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    used_persistent
        += 327680 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*p_array_struct).qmf_residual_real = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    used_persistent
        += 368640 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*p_array_struct).qmf_residual_imag = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    used_persistent
        += 368640 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*p_array_struct).m_qmf_real = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    used_persistent
        += 110592 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*p_array_struct).m_qmf_imag = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    used_persistent
        += 110592 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*p_array_struct).buf_real = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    used_persistent
        += 163584 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    (*p_array_struct).buf_imag = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut WORD32;
    used_persistent
        += 163584 as core::ffi::c_int + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
            & !(8 as core::ffi::c_int - 1 as core::ffi::c_int);
    ...
    (*p_array_struct).hyb_output_imag_dry = ((*p_array_struct).res_mdct)
        .offset(
            (((8 as core::ffi::c_int * 5112 as core::ffi::c_int) as usize)
                .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
                & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
    ...
    (*p_array_struct).env_dmx_0 = ((*p_array_struct).m_qmf_real)
        .offset(
            ((25560 as usize)
                .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
    ...
    (*p_array_struct).env_dmx_1 = ((*p_array_struct).env_dmx_0)
        .offset(
            ((72 as usize)
                .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
    ...
    (*p_array_struct).qmf_residual_real_post = ((*p_array_struct).qmf_residual_real)
        .offset(
            ((46080 as usize)
                .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
    ...
    (*pstr_mps_state).aux_struct = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_auxilary_struct;
    used_persistent = (used_persistent as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_auxilary_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
    ...
    (*(*pstr_mps_state).aux_struct).m2_param = (persistent_mem as *mut WORD8)
        .offset(used_persistent as isize) as *mut ia_mps_dec_m2_param_struct;
    used_persistent = (used_persistent as core::ffi::c_ulong)
        .wrapping_add(
            ((::core::mem::size_of::<ia_mps_dec_m2_param_struct>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_scratch_buffer_sizes() -> WORD32 {
    let mut buffer_size: WORD32 = 0;
    buffer_size = (327680 as core::ffi::c_int
        + (8 as core::ffi::c_int - 1 as core::ffi::c_int)
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_set_scratch_buffers(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
    mut scratch_mem: *mut core::ffi::c_void,
) -> VOID {
    let mut scratch_used: WORD32 = 0 as WORD32;
    (*pstr_mps_state).mps_scratch_mem_v = (scratch_mem as *mut WORD8)
        .offset(scratch_used as isize) as *mut core::ffi::c_void;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_ana_filter_bank_init(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
    mut qmf_bank: *mut ia_mps_dec_qmf_ana_filter_bank,
) -> VOID {
    memset(
        (*qmf_bank).qmf_states_buffer as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (QMF_FILTER_STATE_ANA_SIZE_MPS as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    (*qmf_bank).p_filter_ana = ((*(*pstr_mps_state).ia_mps_dec_mps_table.qmf_table_ptr)
        .ia_mps_enc_qmf_64_640)
        .as_mut_ptr();
    (*qmf_bank).flag = 0 as WORD16;
    (*qmf_bank).offset = 0 as WORD16;
    (*qmf_bank).ref_co_eff_ptr_l = ((*qmf_bank).p_filter_ana)
        .offset(10 as core::ffi::c_int as isize);
    (*qmf_bank).ref_co_eff_ptr_r = ((*qmf_bank).p_filter_ana)
        .offset(QMF_FILTER_STATE_ANA_SIZE_MPS as isize);
    (*qmf_bank).offset_l = 5 as core::ffi::c_int as WORD32;
    (*qmf_bank).offset_r = 5 as core::ffi::c_int as WORD32;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_syn_filter_bank_create(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut qmf_bank: *mut ia_mps_dec_qmf_syn_filter_bank = &mut (*pstr_mps_state)
        .syn_qmf_bank;
    memset(
        (*qmf_bank).sbr_qmf_states_synthesis as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        SYN_BUFFER_SIZE as size_t,
    );
    (*qmf_bank).p_filter_syn = ((*(*pstr_mps_state)
        .ia_mps_dec_mps_table
        .tp_process_table_ptr)
        .ia_mps_dec_qmf_64_640)
        .as_mut_ptr();
}
unsafe extern "C" fn ixheaacd_set_m2_params(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> IA_ERRORCODE {
    let mut curr_state: *mut ia_heaac_mps_state_struct = pstr_mps_state;
    let mut up_mix_type: WORD32 = (*curr_state).up_mix_type;
    match (*curr_state).tree_config {
        0 => {
            if up_mix_type == 2 as core::ffi::c_int {
                (*curr_state).m2_param_imag_present = 1 as core::ffi::c_int as WORD32;
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][1 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[1 as core::ffi::c_int
                    as usize][1 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[1 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m1_param_present[0 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m1_param_present[1 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
            } else if up_mix_type == 3 as core::ffi::c_int {
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][3 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[1 as core::ffi::c_int
                    as usize][3 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                ...
                (*curr_state)
                    ...
                    as WORD32;
                (*curr_state)
                    .m1_param_present[3 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
            } else {
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][1 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][2 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][3 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[1 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                ...
                (*curr_state)
                    ...
                    as WORD32;
                (*curr_state)
                    .m2_param_present[2 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[2 as core::ffi::c_int
                ...
                (*curr_state)
                    ...
                    as WORD32;
                (*curr_state)
                    .m2_param_present[3 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[4 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[4 as core::ffi::c_int
                ...
                (*curr_state)
                    .m2_param_present[4 as core::ffi::c_int
                    as usize][4 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[5 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[5 as core::ffi::c_int
                ...
                (*curr_state)
                    ...
                    as WORD32;
                (*curr_state)
                    .m1_param_present[2 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m1_param_present[3 as core::ffi::c_int
                    ...
                    as WORD32;
                (*curr_state)
                    .m1_param_present[4 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
            }
        }
        1 => {
            if up_mix_type == 2 as core::ffi::c_int {
                ...
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][2 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[1 as core::ffi::c_int
                    as usize][2 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
        ...
        2 => {
            if up_mix_type == 1 as core::ffi::c_int {
                ...
                (*curr_state)
                    .m2_param_present[2 as core::ffi::c_int
                    as usize][4 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[3 as core::ffi::c_int
                    as usize][4 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                ...
                (*curr_state)
                    .m2_param_present[2 as core::ffi::c_int
                    as usize][1 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[3 as core::ffi::c_int
                    as usize][1 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                ...
                (*curr_state)
                    .m2_param_present[4 as core::ffi::c_int
                    as usize][2 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m1_param_present[0 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                ...
                (*curr_state)
                    ...
                    as usize][2 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                    as WORD32;
            } else if up_mix_type == 2 as core::ffi::c_int {
                if !((*curr_state).binaural_quality == 1 as core::ffi::c_int) {
                    (*curr_state).m2_param_imag_present = 1 as core::ffi::c_int
                        as WORD32;
                    (*curr_state)
                        .m2_param_present[0 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                    ...
                    if (*curr_state).arbitrary_downmix == 2 as core::ffi::c_int {
                        (*curr_state)
                            .m2_param_present[0 as core::ffi::c_int
                            as usize][2 as core::ffi::c_int as usize] = 2
                            as core::ffi::c_int as WORD32;
                        (*curr_state)
                            .m2_param_present[0 as core::ffi::c_int
                            as usize][3 as core::ffi::c_int as usize] = 2
                            as core::ffi::c_int as WORD32;
                        (*curr_state)
                            .m2_param_present[1 as core::ffi::c_int
                            as usize][2 as core::ffi::c_int as usize] = 2
        ...
        3 => {
            if up_mix_type == 0 as core::ffi::c_int {
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][3 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[0 as core::ffi::c_int
                    as usize][6 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[1 as core::ffi::c_int
                    as usize][3 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                ...
                (*curr_state)
                    .m2_param_present[3 as core::ffi::c_int
                    as usize][7 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[4 as core::ffi::c_int
                    as usize][4 as core::ffi::c_int as usize] = 3 as core::ffi::c_int
                ...
                (*curr_state)
                    ...
                    as WORD32;
                (*curr_state)
                    .m2_param_present[6 as core::ffi::c_int
                    as usize][2 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m2_param_present[7 as core::ffi::c_int
                    as usize][2 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                    as WORD32;
                (*curr_state)
                    .m1_param_present[0 as core::ffi::c_int
        ...
        5 => {
            ...
            (*curr_state)
                .m2_param_present[2 as core::ffi::c_int
                as usize][4 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                as WORD32;
            (*curr_state)
                .m2_param_present[3 as core::ffi::c_int
                as usize][1 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
            ...
            (*curr_state)
                .m2_param_present[5 as core::ffi::c_int
                as usize][5 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                as WORD32;
            (*curr_state)
                .m2_param_present[6 as core::ffi::c_int
                as usize][2 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
            ...
            (*curr_state)
                .m2_param_present[7 as core::ffi::c_int
                as usize][3 as core::ffi::c_int as usize] = 2 as core::ffi::c_int
                as WORD32;
            (*curr_state)
                .m1_param_present[0 as core::ffi::c_int
                as usize][0 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
            ...
            (*curr_state)
                ...
                as WORD32;
            (*curr_state)
                .m1_param_present[5 as core::ffi::c_int
                as usize][5 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                as WORD32;
            (*curr_state)
                .m1_param_present[6 as core::ffi::c_int
                as usize][0 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                as WORD32;
            (*curr_state)
                .m1_param_present[7 as core::ffi::c_int
                as usize][1 as core::ffi::c_int as usize] = 1 as core::ffi::c_int
                as WORD32;
        }
        6 => {
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_sb_tp_init(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut ch: WORD32 = 0;
    ...
    let mut q_prev_tp_scale: *mut WORD16 = ((*sub_band_tp).q_prev_tp_scale).as_mut_ptr();
    ...
    while ch < MAX_OUTPUT_CHANNELS_MPS {
        *prev_tp_scale.offset(ch as isize) = ONE_IN_Q15 as WORD32;
        *q_prev_tp_scale.offset(ch as isize) = 15 as WORD16;
        *old_wet_ener.offset(ch as isize) = ONE_IN_Q30 as WORD32;
        *q_old_wet_ener.offset(ch as isize) = 0 as WORD16;
        *run_wet_ener.offset(ch as isize) = 0 as core::ffi::c_int as WORD32;
        *q_run_wet_ener.offset(ch as isize) = 0 as WORD16;
        ch += 1;
    }
    ch = 0 as core::ffi::c_int as WORD32;
    while ch < MAX_INPUT_CHANNELS_MPS {
        (*sub_band_tp).old_dry_ener[ch as usize] = ONE_IN_Q30 as WORD32;
        (*sub_band_tp).q_old_dry_ener[ch as usize] = 0 as WORD16;
        (*sub_band_tp).run_dry_ener[ch as usize] = 0 as core::ffi::c_int as WORD32;
        (*sub_band_tp).q_run_dry_ener[ch as usize] = 0 as WORD16;
        ch += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_decorr_init(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut decorr_persistent: *mut core::ffi::c_void = (*pstr_mps_state)
        .mps_persistent_mem
        .decorr_ptr;
    let mut i: WORD32 = 0;
    let mut k: WORD32 = 0;
    let mut hybrid_bands: WORD32 = (*pstr_mps_state).hybrid_bands;
    let mut dec_type: WORD32 = (*pstr_mps_state).dec_type;
    k = 0 as core::ffi::c_int as WORD32;
    while k < MAX_NO_DECORR_CHANNELS {
        (*pstr_mps_state).ap_decor[k as usize] = decorr_persistent
            as ia_mps_dec_decorr_dec_handle;
        decorr_persistent = (decorr_persistent as *mut WORD8)
            .offset(
                ((::core::mem::size_of::<ia_mps_dec_decorr_dec_struct>() as usize)
                    .wrapping_add(
                        (8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize,
    ...
    k = 0 as core::ffi::c_int as WORD32;
    while k < MAX_NO_DECORR_CHANNELS {
        (*(*pstr_mps_state).ap_decor[k as usize]).ducker = decorr_persistent
            as *mut ia_mps_dec_ducker_interface;
        decorr_persistent = (decorr_persistent as *mut WORD8)
            .offset(
                ((::core::mem::size_of::<ia_mps_dec_ducker_interface>() as usize)
                    .wrapping_add(
    ...
    while k < MAX_NO_DECORR_CHANNELS {
        ...
        while i < hybrid_bands {
            (*(*pstr_mps_state).ap_decor[k as usize]).filter[i as usize] = decorr_persistent
                as *mut ia_mps_dec_decorr_filter_instance_struct;
            decorr_persistent = (decorr_persistent as *mut WORD8)
                .offset(
                    ((::core::mem::size_of::<ia_mps_dec_decorr_filter_instance_struct>()
                        as usize)
                        .wrapping_add(
                            (8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize,
                        ) & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
    ...
    if dec_type == 1 as core::ffi::c_int {
        ...
        while k < MAX_NO_DECORR_CHANNELS {
            i = 0 as core::ffi::c_int as WORD32;
            while i < hybrid_bands {
                (*(*(*pstr_mps_state).ap_decor[k as usize]).filter[i as usize])
                    .numerator_real = decorr_persistent as *mut WORD32;
                decorr_persistent = (decorr_persistent as *mut WORD8)
                    .offset(
                        ((21 as usize)
                            .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
                ...
                (*(*(*pstr_mps_state).ap_decor[k as usize]).filter[i as usize])
                    .denominator_real = decorr_persistent as *mut WORD32;
                decorr_persistent = (decorr_persistent as *mut WORD8)
                    .offset(
                        ((21 as usize)
                            .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
                ...
                (*(*(*pstr_mps_state).ap_decor[k as usize]).filter[i as usize])
                    .numerator_imag = decorr_persistent as *mut WORD32;
                decorr_persistent = (decorr_persistent as *mut WORD8)
                    .offset(
                        ((21 as usize)
                            .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
                ...
                (*(*(*pstr_mps_state).ap_decor[k as usize]).filter[i as usize])
                    .denominator_imag = decorr_persistent as *mut WORD32;
                decorr_persistent = (decorr_persistent as *mut WORD8)
                    .offset(
                        ((21 as usize)
                            .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
    ...
    while k < MAX_NO_DECORR_CHANNELS {
        i = 0 as core::ffi::c_int as WORD32;
        while i < hybrid_bands {
            (*(*(*pstr_mps_state).ap_decor[k as usize]).filter[i as usize]).state_real = decorr_persistent
                as *mut WORD32;
            decorr_persistent = (decorr_persistent as *mut WORD8)
                .offset(
                    ((21 as usize)
            ...
            (*(*(*pstr_mps_state).ap_decor[k as usize]).filter[i as usize]).state_imag = decorr_persistent
                as *mut WORD32;
            decorr_persistent = (decorr_persistent as *mut WORD8)
                .offset(
                    ((21 as usize)
    ...
    k = 0 as core::ffi::c_int as WORD32;
    while k < MAX_NO_DECORR_CHANNELS {
        (*(*pstr_mps_state).ap_decor[k as usize]).delay_buffer_real = decorr_persistent
            as *mut *mut WORD32;
        decorr_persistent = (decorr_persistent as *mut WORD8)
            .offset(
                ((hybrid_bands as usize)
                    .wrapping_mul(::core::mem::size_of::<*mut WORD32>() as usize)
                    .wrapping_add(
                        (8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize,
                    ) & !(8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
        ...
        i = 0 as core::ffi::c_int as WORD32;
        while i < hybrid_bands {
            let ref mut fresh1 = *((*(*pstr_mps_state).ap_decor[k as usize])
                .delay_buffer_real)
                .offset(i as isize);
            *fresh1 = decorr_persistent as *mut WORD32;
            decorr_persistent = (decorr_persistent as *mut WORD8)
                .offset(
                    (((72 as core::ffi::c_int + 14 as core::ffi::c_int) as usize)
                        .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
        ...
        (*(*pstr_mps_state).ap_decor[k as usize]).delay_buffer_imag = (((decorr_persistent
            as size_t)
            .wrapping_add(7 as size_t) >> 3 as core::ffi::c_int)
            << 3 as core::ffi::c_int) as *mut *mut WORD32;
        decorr_persistent = (decorr_persistent as *mut WORD8)
            .offset(
                ((hybrid_bands as usize)
                    .wrapping_mul(::core::mem::size_of::<*mut WORD32>() as usize)
        ...
        i = 0 as core::ffi::c_int as WORD32;
        while i < hybrid_bands {
            let ref mut fresh2 = *((*(*pstr_mps_state).ap_decor[k as usize])
                .delay_buffer_imag)
                .offset(i as isize);
            *fresh2 = (((decorr_persistent as size_t).wrapping_add(7 as size_t)
                >> 3 as core::ffi::c_int) << 3 as core::ffi::c_int) as *mut WORD32;
            decorr_persistent = (decorr_persistent as *mut WORD8)
                .offset(
                    (((72 as core::ffi::c_int + 14 as core::ffi::c_int) as usize)
                        .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_bs_frame_init(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut bs_frame: *mut ia_mps_dec_spatial_bs_frame_struct = (*pstr_mps_state)
        .bs_frame;
    memset(
        ((*bs_frame).ott_cld_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_OTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).ott_icc_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_OTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).cmp_ott_cld_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_OTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).cmp_ott_icc_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_OTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).ttt_cpc_1_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).ttt_cpc_2_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).ttt_cld_1_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).ttt_cld_2_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).ttt_icc_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).cmp_ttt_cpc_1_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).cmp_ttt_cpc_2_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).cmp_ttt_cld_1_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).cmp_ttt_cld_2_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).cmp_ttt_icc_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_NUM_TTT * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).arbdmx_gain_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_INPUT_CHANNELS_MPS * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        ((*bs_frame).cmp_arbdmx_gain_idx_prev).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_INPUT_CHANNELS_MPS * MAX_PARAMETER_BANDS) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_modules_init(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> IA_ERRORCODE {
    ...
    let mut in_channels: WORD32 = (*pstr_mps_state).num_input_channels;
    let mut n_ch: WORD32 = 0;
    if (*pstr_mps_state).smooth_config != 0 {
        ixheaacd_init_tonality(pstr_mps_state);
    }
    if up_mix_type != 2 as core::ffi::c_int {
    ...
    if (*pstr_mps_state).scaling_enable == 1 as core::ffi::c_int {
        ixheaacd_sb_tp_init(pstr_mps_state);
    }
    err_code = ixheaacd_syn_filt_bank_init(
        (*pstr_mps_state).syn as ia_mps_dec_synthesis_interface_handle,
        (*pstr_mps_state).qmf_bands,
    );
    if err_code != IA_NO_ERROR {
        return err_code;
    }
    n_ch = 0 as core::ffi::c_int as WORD32;
    while n_ch < in_channels {
        ixheaacd_init_ana_hyb_filt_bank(&mut *hyb_filter_state.offset(n_ch as isize));
        n_ch += 1;
    }
    n_ch = 0 as core::ffi::c_int as WORD32;
    while n_ch < in_channels {
        (*(*pstr_mps_state).aux_struct).arbdmx_alpha[n_ch as usize] = 0
            as core::ffi::c_int as WORD32;
        n_ch += 1;
    }
    memset(
        &mut *((*(*pstr_mps_state).aux_struct).ttt_cld_1)
            .as_mut_ptr()
            .offset(0 as core::ffi::c_int as isize) as *mut [[WORD32; 28]; 8]
            as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((8 as core::ffi::c_int * 28 as core::ffi::c_int) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    if (*pstr_mps_state).residual_coding != 0 {
        let mut offset: WORD32 = in_channels;
        n_ch = 0 as core::ffi::c_int as WORD32;
        while n_ch < (*pstr_mps_state).num_ott_boxes + (*pstr_mps_state).num_ttt_boxes {
            if (*pstr_mps_state).res_bands[n_ch as usize] > 0 as core::ffi::c_int {
                ixheaacd_init_ana_hyb_filt_bank(
                    &mut *hyb_filter_state.offset((offset + n_ch) as isize),
                );
            }
            n_ch += 1;
        }
    ...
    if (*pstr_mps_state).arbitrary_downmix == 2 as core::ffi::c_int {
        let mut offset_0: WORD32 = in_channels + (*pstr_mps_state).num_ott_boxes
            + (*pstr_mps_state).num_ttt_boxes;
        n_ch = 0 as core::ffi::c_int as WORD32;
        while n_ch < in_channels {
            ixheaacd_init_ana_hyb_filt_bank(
                &mut *hyb_filter_state.offset((offset_0 + n_ch) as isize),
            );
            n_ch += 1;
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_header_parse(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> IA_ERRORCODE {
    let mut err_code: IA_ERRORCODE = IA_NO_ERROR;
    let mut up_mix_type: WORD32 = (*pstr_mps_state).up_mix_type;
    ...
    if up_mix_type != 1 as core::ffi::c_int {
        (*pstr_mps_state).sac_time_align_flag = ixheaacd_read_bits_buf(
            mps_bit_buf,
            1 as WORD,
        );
        sac_header_len = ixheaacd_read_bits_buf(mps_bit_buf, 7 as WORD);
        if sac_header_len == 127 as core::ffi::c_int {
            sac_header_len += ixheaacd_read_bits_buf(mps_bit_buf, 16 as WORD);
        }
        err_code = ixheaacd_parse_specific_config(pstr_mps_state, sac_header_len);
        if err_code != IA_NO_ERROR {
            return err_code;
        }
        if (*pstr_mps_state).bs_config.bs_temp_shape_config == 1 as core::ffi::c_int {
            (*pstr_mps_state).scaling_enable = 1 as core::ffi::c_int as WORD32;
        }
        ixheaacd_byte_align(mps_bit_buf, &mut alignment_bits);
    } else {
        err_code = ixheaacd_default_specific_config(
            pstr_mps_state,
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_aac_mps_create(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> IA_ERRORCODE {
    let mut i: WORD32 = 0;
    let mut j: WORD32 = 0;
    let mut k: WORD32 = 0;
    let mut prev_gain_at: *mut WORD32 = (*pstr_mps_state)
        .mps_persistent_mem
        .prev_gain_at;
    let mut err_code: IA_ERRORCODE = IA_NO_ERROR;
    let mut dec_type: WORD32 = (*pstr_mps_state).dec_type;
    ...
    i = 0 as core::ffi::c_int as WORD32;
    while i < MAX_OUTPUT_CHANNELS_AT_MPS {
        j = 0 as core::ffi::c_int as WORD32;
        while j < MAX_PARAMETER_BANDS {
            let fresh0 = prev_gain_at;
            prev_gain_at = prev_gain_at.offset(1);
            *fresh0 = ONE_IN_Q15 as WORD32;
            j += 1;
        }
        i += 1;
    }
    ...
    while i < in_channels {
        ixheaacd_ana_filter_bank_init(
            pstr_mps_state,
            &mut *((*pstr_mps_state).qmf_bank).as_mut_ptr().offset(i as isize),
        );
        i += 1;
    }
    ...
    k = 0 as core::ffi::c_int as WORD32;
    while k < MAX_NO_DECORR_CHANNELS {
        let mut idec: WORD32 = 0;
        if up_mix_type == 3 as core::ffi::c_int {
            idec = 0 as core::ffi::c_int as WORD32;
        } else {
            idec = k;
        }
        err_code = ixheaacd_decorr_create(
            (*pstr_mps_state).ap_decor[k as usize],
            (*pstr_mps_state).hybrid_bands,
            idec,
            dec_type,
            (*pstr_mps_state).decorr_config,
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_wf_table_init(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut wf: *mut *const WORD32 = ((*pstr_mps_state).wf_tab.wf).as_mut_ptr();
    let mut mps_table_ptr: *mut ia_mps_dec_mps_tables_struct = &mut (*pstr_mps_state)
        .ia_mps_dec_mps_table;
    let ref mut fresh3 = *wf.offset(0 as core::ffi::c_int as isize);
    *fresh3 = 0 as *const WORD32;
    let ref mut fresh4 = *wf.offset(1 as core::ffi::c_int as isize);
    *fresh4 = (ixheaacd_mps_dec_wf_tables.wf_02).as_ptr();
    let ref mut fresh5 = *wf.offset(2 as core::ffi::c_int as isize);
    *fresh5 = (ixheaacd_mps_dec_wf_tables.wf_03).as_ptr();
    let ref mut fresh6 = *wf.offset(3 as core::ffi::c_int as isize);
    *fresh6 = (ixheaacd_mps_dec_wf_tables.wf_04).as_ptr();
    let ref mut fresh7 = *wf.offset(4 as core::ffi::c_int as isize);
    *fresh7 = 0 as *const WORD32;
    let ref mut fresh8 = *wf.offset(5 as core::ffi::c_int as isize);
    *fresh8 = 0 as *const WORD32;
    let ref mut fresh9 = *wf.offset(6 as core::ffi::c_int as isize);
    *fresh9 = 0 as *const WORD32;
    let ref mut fresh10 = *wf.offset(7 as core::ffi::c_int as isize);
    *fresh10 = 0 as *const WORD32;
    let ref mut fresh11 = *wf.offset(8 as core::ffi::c_int as isize);
    *fresh11 = 0 as *const WORD32;
    let ref mut fresh12 = *wf.offset(9 as core::ffi::c_int as isize);
    *fresh12 = 0 as *const WORD32;
    let ref mut fresh13 = *wf.offset(10 as core::ffi::c_int as isize);
    *fresh13 = 0 as *const WORD32;
    let ref mut fresh14 = *wf.offset(11 as core::ffi::c_int as isize);
    *fresh14 = 0 as *const WORD32;
    let ref mut fresh15 = *wf.offset(12 as core::ffi::c_int as isize);
    *fresh15 = 0 as *const WORD32;
    let ref mut fresh16 = *wf.offset(13 as core::ffi::c_int as isize);
    *fresh16 = 0 as *const WORD32;
    let ref mut fresh17 = *wf.offset(14 as core::ffi::c_int as isize);
    *fresh17 = (ixheaacd_mps_dec_wf_tables.wf_15).as_ptr();
    let ref mut fresh18 = *wf.offset(15 as core::ffi::c_int as isize);
    *fresh18 = (ixheaacd_mps_dec_wf_tables.wf_16).as_ptr();
    let ref mut fresh19 = *wf.offset(16 as core::ffi::c_int as isize);
    *fresh19 = 0 as *const WORD32;
    let ref mut fresh20 = *wf.offset(17 as core::ffi::c_int as isize);
    *fresh20 = (ixheaacd_mps_dec_wf_tables.wf_18).as_ptr();
    let ref mut fresh21 = *wf.offset(18 as core::ffi::c_int as isize);
    *fresh21 = 0 as *const WORD32;
    let ref mut fresh22 = *wf.offset(19 as core::ffi::c_int as isize);
    *fresh22 = 0 as *const WORD32;
    let ref mut fresh23 = *wf.offset(20 as core::ffi::c_int as isize);
    *fresh23 = 0 as *const WORD32;
    let ref mut fresh24 = *wf.offset(21 as core::ffi::c_int as isize);
    *fresh24 = 0 as *const WORD32;
    let ref mut fresh25 = *wf.offset(22 as core::ffi::c_int as isize);
    *fresh25 = 0 as *const WORD32;
    let ref mut fresh26 = *wf.offset(23 as core::ffi::c_int as isize);
    *fresh26 = (ixheaacd_mps_dec_wf_tables.wf_24).as_ptr();
    let ref mut fresh27 = *wf.offset(24 as core::ffi::c_int as isize);
    *fresh27 = 0 as *const WORD32;
    let ref mut fresh28 = *wf.offset(25 as core::ffi::c_int as isize);
    *fresh28 = 0 as *const WORD32;
    let ref mut fresh29 = *wf.offset(26 as core::ffi::c_int as isize);
    *fresh29 = 0 as *const WORD32;
    let ref mut fresh30 = *wf.offset(27 as core::ffi::c_int as isize);
    *fresh30 = 0 as *const WORD32;
    let ref mut fresh31 = *wf.offset(28 as core::ffi::c_int as isize);
    *fresh31 = 0 as *const WORD32;
    let ref mut fresh32 = *wf.offset(29 as core::ffi::c_int as isize);
    *fresh32 = (ixheaacd_mps_dec_wf_tables.wf_30).as_ptr();
    let ref mut fresh33 = *wf.offset(30 as core::ffi::c_int as isize);
    *fresh33 = 0 as *const WORD32;
    let ref mut fresh34 = *wf.offset(31 as core::ffi::c_int as isize);
    *fresh34 = (ixheaacd_mps_dec_wf_tables.wf_32).as_ptr();
    (*mps_table_ptr).wf_tab_ptr = &mut (*pstr_mps_state).wf_tab;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_res_huff_tables_init(
    mut aac_tables_ptr: *mut ia_mps_dec_residual_aac_tables_struct,
) -> VOID {
    (*aac_tables_ptr).code_book[0 as core::ffi::c_int as usize] = 0 as *mut UWORD16;
    (*aac_tables_ptr).code_book[1 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_1)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[2 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_2)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[3 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_3)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[4 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_4)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[5 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_5)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[6 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_6)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[7 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_7)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[8 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_8)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[9 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_9)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[10 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_10)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[11 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_10)
        .as_mut_ptr();
    (*aac_tables_ptr).code_book[12 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .huffman_code_book_10)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[0 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[1 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[2 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[3 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[4 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[5 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[6 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_24_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[7 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_24_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[8 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[9 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[10 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[11 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_8_128)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[12 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[13 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[14 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[15 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[16 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[17 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[18 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_24_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[19 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_24_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[20 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[21 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[22 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_short[23 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_8_120)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[0 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[1 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[2 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_64_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[3 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[4 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[5 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_32_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[6 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_24_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[7 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_24_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[8 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[9 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[10 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[11 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_8_1024)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[12 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[13 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_96_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[14 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_64_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[15 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[16 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[17 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_48_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[18 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_24_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[19 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_24_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[20 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[21 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[22 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_16_960)
        .as_mut_ptr();
    (*aac_tables_ptr).scale_factor_bands_long[23 as core::ffi::c_int as usize] = ((*(*aac_tables_ptr)
        .res_huffmann_tables_ptr)
        .sfb_8_960)
        .as_mut_ptr();
}
unsafe extern "C" fn ixheaacd_table_ptr_init(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut mps_table_ptr: *mut ia_mps_dec_mps_tables_struct = &mut (*pstr_mps_state)
        .ia_mps_dec_mps_table;
    let mut aac_table_ptr: *mut ia_mps_dec_residual_aac_tables_struct = &mut (*pstr_mps_state)
        .aac_table;
    (*mps_table_ptr).qmf_table_ptr = &ixheaacd_mps_dec_qmf_tables
        as *const ia_mps_dec_qmf_tables_struct as *mut ia_mps_dec_qmf_tables_struct;
    (*mps_table_ptr).common_table_ptr = &ixheaacd_mps_dec_common_tables
        as *const ia_mps_dec_common_tables_struct
        as *mut ia_mps_dec_common_tables_struct;
    (*mps_table_ptr).hybrid_table_ptr = &ixheaacd_mps_dec_hybrid_tables
        as *const ia_mps_dec_hybrid_tables_struct
        as *mut ia_mps_dec_hybrid_tables_struct;
    (*mps_table_ptr).m1_m2_table_ptr = &ixheaacd_mps_dec_m1_m2_tables
        as *const ia_mps_dec_m1_m2_tables_struct as *mut ia_mps_dec_m1_m2_tables_struct;
    (*mps_table_ptr).decor_table_ptr = &ixheaacd_mps_dec_decorr_tables
        as *const ia_mps_dec_decorr_tables_struct
        as *mut ia_mps_dec_decorr_tables_struct;
    (*mps_table_ptr).tp_process_table_ptr = &ixheaacd_mps_dec_tp_process_tables
        as *const ia_mps_dec_tp_process_tables_struct
        as *mut ia_mps_dec_tp_process_tables_struct;
    (*mps_table_ptr).mdct2qmf_table_ptr = &ixheaacd_mps_dec_mdct2qmf_table
        as *const ia_mps_dec_mdct2qmf_table_struct
        as *mut ia_mps_dec_mdct2qmf_table_struct;
    (*mps_table_ptr).tonality_table_ptr = &ixheaacd_mps_dec_tonality_tables
        as *const ia_mps_dec_tonality_tables_struct
        as *mut ia_mps_dec_tonality_tables_struct;
    (*mps_table_ptr).bitdec_table_ptr = &mut ixheaacd_mps_dec_bitdec_tables
        as *mut ia_mps_dec_bitdec_tables_struct;
    (*mps_table_ptr).blind_table_ptr = &ixheaacd_mps_dec_blind_tables
        as *const ia_mps_dec_blind_tables_struct as *mut ia_mps_dec_blind_tables_struct;
    (*mps_table_ptr).mdct2qmfcos_table_ptr = &ixheaacd_mps_dec_mdct2qmf_tables
        as *const ia_mps_dec_mdct2qmf_tables_struct
        as *mut ia_mps_dec_mdct2qmf_tables_struct;
    (*mps_table_ptr).mdct2qmfcos_tab_ptr = &mut (*pstr_mps_state)
        .ia_mps_dec_mdct2qmfcos_table as *mut ia_mps_dec_mdct2qmf_cos_table_struct;
    (*aac_table_ptr).res_huffmann_tables_ptr = &ixheaacd_mps_dec_res_huffmann_tables
        as *const ia_mps_dec_res_huffmann_tables_struct
        as *mut ia_mps_dec_res_huffmann_tables_struct;
    (*aac_table_ptr).res_block_tables_ptr = &ixheaacd_mps_dec_res_block_tables
        as *const ia_mps_dec_res_block_tables_struct
        as *mut ia_mps_dec_res_block_tables_struct;
    ixheaacd_res_huff_tables_init(aac_table_ptr);
    (*mps_table_ptr).aac_tab = aac_table_ptr as *mut core::ffi::c_void;
    ixheaacd_wf_table_init(pstr_mps_state);
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_aac_mps_init(
    mut p_obj_mps_dec: *mut ia_exhaacplus_dec_api_struct,
    mut databuf: *mut UWORD8,
    mut buffer_size: WORD32,
    mut sample_rate: WORD32,
) -> IA_ERRORCODE {
    let mut i: WORD32 = 0;
    let mut buf_ptr: *mut core::ffi::c_void = 0 as *mut core::ffi::c_void;
    let mut persistent_mem: *mut ia_mps_persistent_mem = &mut (*(*p_obj_mps_dec)
        .p_state_aac)
        .heaac_mps_handle
        .mps_persistent_mem;
    let mut err_code: IA_ERRORCODE = IA_NO_ERROR;
    let mut curr_state: *mut ia_heaac_mps_state_struct = &mut (*(*p_obj_mps_dec)
        .p_state_aac)
        .heaac_mps_handle;
    let mut p_bs_config: *mut ia_mps_spatial_bs_config_struct = &mut (*curr_state)
        .bs_config;
    (*curr_state).ec_flag = (*(*p_obj_mps_dec).p_state_aac).ec_enable;
    ixheaacd_table_ptr_init(curr_state);
    (*curr_state).ptr_mps_bit_buff = ixheaacd_create_bit_buf(
        &mut (*curr_state).mps_bit_buf,
        databuf,
        buffer_size,
    ) as *mut ia_bit_buf_struct;
    (*(*curr_state).ptr_mps_bit_buff).cnt_bits
        += (8 as WORD32 * buffer_size) as core::ffi::c_int;
    (*(*curr_state).ptr_mps_bit_buff).xaac_jmp_buf = &mut (*(*p_obj_mps_dec).p_state_aac)
        .xaac_jmp_buf;
    if sample_rate < 27713 as core::ffi::c_int {
        (*curr_state).qmf_bands = 32 as core::ffi::c_int as WORD32;
    } else if sample_rate >= 55426 as core::ffi::c_int {
        (*curr_state).qmf_bands = 128 as core::ffi::c_int as WORD32;
    } else {
        (*curr_state).qmf_bands = 64 as core::ffi::c_int as WORD32;
    }
    (*curr_state).sampling_freq = sample_rate;
    (*curr_state).num_input_channels = (*(*(*p_obj_mps_dec).p_state_aac).p_config)
        .ui_n_channels as WORD32;
    (*curr_state).bits_per_sample = (*(*(*p_obj_mps_dec).p_state_aac).p_config)
        .ui_pcm_wdsz as WORD32;
    ...
    (*curr_state).is_buried_flag = (*p_bs_config).ui_bs_is_buried as WORD32;
    (*curr_state).bs_frame = (*persistent_mem).p_bs_frame;
    buf_ptr = (*persistent_mem).syn_qmf_states_buffer as *mut core::ffi::c_void;
    (*curr_state).syn = buf_ptr as *mut ia_mps_dec_synthesis_interface;
    (*curr_state).syn_qmf_bank.sbr_qmf_states_synthesis = (buf_ptr as *mut WORD8)
        .offset(
            ::core::mem::size_of::<ia_mps_dec_synthesis_interface>() as usize as isize,
        ) as *mut WORD32;
    buf_ptr = (*persistent_mem).ana_qmf_states_buffer as *mut core::ffi::c_void;
    memset(
        ((*curr_state).m2_param_present).as_mut_ptr() as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ((MAX_M2_OUTPUT * MAX_M2_INPUT) as size_t)
            .wrapping_mul(::core::mem::size_of::<WORD32>() as size_t),
    );
    memset(
        &mut (*curr_state).bs_config as *mut ia_mps_spatial_bs_config_struct
            as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        ::core::mem::size_of::<ia_mps_spatial_bs_config_struct>() as size_t,
    );
    memset(
        &mut (*curr_state).res_block_type as *mut [[WORD32; 4]; 10]
            as *mut core::ffi::c_void,
        0 as core::ffi::c_int,
        (::core::mem::size_of::<WORD32>() as size_t)
            .wrapping_mul(MAX_RESIDUAL_CHANNELS_MPS as size_t)
            .wrapping_mul(MAX_RESIDUAL_FRAMES as size_t),
    );
    (*curr_state).bs_config.ui_pcm_wdsz = 16 as UWORD32;
    (*curr_state).bs_config.ui_samp_freq = 48000 as UWORD32;
    (*curr_state).bs_config.ui_in_channels = 2 as UWORD32;
    (*curr_state).bs_config.ui_qmf_bands = 64 as UWORD32;
    err_code = ixheaacd_header_parse(curr_state);
    if err_code != IA_NO_ERROR {
        return err_code;
    }
    i = 0 as core::ffi::c_int as WORD32;
    while i < (*curr_state).num_input_channels {
        (*curr_state).qmf_bank[i as usize].qmf_states_buffer = buf_ptr as *mut WORD32;
        buf_ptr = (buf_ptr as *mut WORD8)
            .offset(
                (QMF_FILTER_STATE_ANA_SIZE_MPS as usize)
                    .wrapping_mul(::core::mem::size_of::<WORD32>() as usize) as isize,
            ) as *mut core::ffi::c_void;
        i += 1;
    }
    (*curr_state).i_bytes_consumed_mps = ((*(*curr_state).ptr_mps_bit_buff)
        .ptr_read_next)
        .offset_from((*(*curr_state).ptr_mps_bit_buff).ptr_bit_buf_base)
        as core::ffi::c_long as WORD32;
    (*curr_state).bytes_remaining = buffer_size - (*curr_state).i_bytes_consumed_mps;
    if (*curr_state).bytes_remaining != 0 as core::ffi::c_int {
        let mut ii: WORD32 = 0 as WORD32;
        while ii < (*curr_state).bytes_remaining {
            (*curr_state).temp_buf[ii as usize] = *databuf
                .offset((ii + (*curr_state).i_bytes_consumed_mps) as isize);
            ii += 1;
        }
    }
    ...
    (*curr_state).mps_init_done = 1 as core::ffi::c_int as WORD32;
    (*curr_state).first_frame = 1 as core::ffi::c_int as WORD32;
    return err_code;
}
