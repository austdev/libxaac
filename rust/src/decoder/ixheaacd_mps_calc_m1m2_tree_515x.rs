...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_calc_m1m2_5151(
    ...
    let mut ps: WORD32 = 0;
    let mut pb: WORD32 = 0;
    let mut h11_fs: *mut WORD32 = 0 as *mut WORD32;
    let mut h11_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_fs: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_fs: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_fs: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_fs: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_fs: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_c: *mut WORD32 = 0 as *mut WORD32;
    let mut c_l_fs: *mut WORD16 = 0 as *mut WORD16;
    let mut c_l_c: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r_fs: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r_c: *mut WORD16 = 0 as *mut WORD16;
    let mut h11_f: *mut WORD32 = 0 as *mut WORD32;
    let mut h11_s: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_f: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_s: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_f: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_s: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_f: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_s: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_f: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_s: *mut WORD32 = 0 as *mut WORD32;
    let mut c_r_clfe: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_f: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_s: *mut WORD32 = 0 as *mut WORD32;
    let mut c_l_clfe: *mut WORD32 = 0 as *mut WORD32;
    let mut c_l_f: *mut WORD16 = 0 as *mut WORD16;
    let mut c_l_s: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r_f: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r_s: *mut WORD16 = 0 as *mut WORD16;
    ...
    h11_fs = (*pstr_mps_state).mps_scratch_mem_v as *mut WORD32;
    h11_c = h11_fs
        .offset(
            ((28 as usize)
    ...
    c_l_fs = ((*pstr_mps_state).mps_scratch_mem_v as *mut WORD16)
        .offset(
            ((1456 as usize)
    ...
    while ps < num_parameter_sets {
        ixheaacd_param_2_umx_ps(
            ...
            0 as WORD32,
            ps,
            *res_bands.offset(0 as core::ffi::c_int as isize),
        );
        ixheaacd_param_2_umx_ps(
            pstr_mps_state,
            h11_c,
        ...
        while pb < (*p_aux_struct).num_ott_bands[4 as core::ffi::c_int as usize] {
            ...
            *c_l_clfe.offset(pb as isize) = (*(*pstr_mps_state)
                ...
                .ott_cld_idx[4 as core::ffi::c_int as usize][ps as usize][pb as usize]
            ...
            *c_r_clfe.offset(pb as isize) = (*(*pstr_mps_state)
                ...
                - (*p_cur_bs)
                    .ott_cld_idx[4 as core::ffi::c_int
                    as usize][ps as usize][pb as usize]) as usize];
            pb += 1;
        }
        pb = (*p_aux_struct).num_ott_bands[4 as core::ffi::c_int as usize];
        ...
        while pb < num_parameter_bands {
            ...
            (*m1_param)
                ...
                as usize][0 as core::ffi::c_int as usize][ps as usize][pb as usize] = *c_l_fs
                .offset(pb as isize) as WORD32;
            (*m1_param)
                .m1_param_real[3 as core::ffi::c_int
                as usize][0 as core::ffi::c_int as usize][ps as usize][pb as usize] = ixheaac_mult16_shl(
                *c_l_fs.offset(pb as isize),
                *c_l_c.offset(pb as isize),
            ) as WORD32;
            (*m1_param)
                .m1_param_real[4 as core::ffi::c_int
                as usize][0 as core::ffi::c_int as usize][ps as usize][pb as usize] = *c_r_fs
                .offset(pb as isize) as WORD32;
            pb += 1;
        }
        pb = 0 as core::ffi::c_int as WORD32;
        while pb < num_parameter_bands {
            (*m2_param)
                .m2_decor_real[0 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_f.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h11_c.offset(pb as isize),
                    *h12_fs.offset(pb as isize),
                ),
            );
            (*m2_param)
                .m2_decor_real[1 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_f.offset(pb as isize),
                *h12_c.offset(pb as isize),
            );
            (*m2_param)
                .m2_decor_real[2 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h12_f.offset(pb as isize);
            (*m2_param)
                .m2_decor_real[3 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_f.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h11_c.offset(pb as isize),
                    *h12_fs.offset(pb as isize),
                ),
            ...
            (*m2_param)
                .m2_decor_real[4 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_f.offset(pb as isize),
                *h12_c.offset(pb as isize),
            );
            (*m2_param)
                .m2_decor_real[5 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h22_f.offset(pb as isize);
            (*m2_param)
                .m2_decor_real[6 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *c_l_clfe.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h21_c.offset(pb as isize),
                    *h12_fs.offset(pb as isize),
                ),
            );
            (*m2_param)
                .m2_decor_real[7 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *c_l_clfe.offset(pb as isize),
                *h22_c.offset(pb as isize),
            );
            (*m2_param)
                .m2_decor_real[8 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_s.offset(pb as isize),
                *h22_fs.offset(pb as isize),
            );
            (*m2_param)
                .m2_decor_real[9 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h12_s.offset(pb as isize);
            (*m2_param)
                .m2_decor_real[10 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_s.offset(pb as isize),
                *h22_fs.offset(pb as isize),
            );
            (*m2_param)
                .m2_decor_real[11 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h22_s.offset(pb as isize);
            pb += 1;
        }
        pb = 0 as core::ffi::c_int as WORD32;
        while pb < num_parameter_bands {
            ...
            let fresh0 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh0 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_f.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h11_c.offset(pb as isize),
                    *h11_fs.offset(pb as isize),
                ),
            );
            if residual_coding != 0 {
                let fresh1 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh1 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h11_f.offset(pb as isize),
                    ixheaacd_mps_mult32_shr_15(
                        *h11_c.offset(pb as isize),
                        *h12_res_fs.offset(pb as isize),
                    ),
                );
                let fresh2 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh2 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h11_f.offset(pb as isize),
                    *h12_res_c.offset(pb as isize),
                );
                let fresh3 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh3 as usize][ps as usize][pb as usize] = *h12_res_f
                    .offset(pb as isize);
            }
            let fresh4 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh4 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_f.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h11_c.offset(pb as isize),
                    *h11_fs.offset(pb as isize),
            ...
            if residual_coding != 0 {
                let fresh5 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh5 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h21_f.offset(pb as isize),
                    ixheaacd_mps_mult32_shr_15(
                        *h11_c.offset(pb as isize),
                        *h12_res_fs.offset(pb as isize),
                ...
                let fresh6 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh6 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h21_f.offset(pb as isize),
                    *h12_res_c.offset(pb as isize),
                );
                let fresh7 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh7 as usize][ps as usize][pb as usize] = *h22_res_f
                    .offset(pb as isize);
            }
            let fresh8 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh8 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *c_l_clfe.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h21_c.offset(pb as isize),
                    *h11_fs.offset(pb as isize),
            ...
            if residual_coding != 0 {
                let fresh9 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh9 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *c_l_clfe.offset(pb as isize),
                    ixheaacd_mps_mult32_shr_15(
                        *h21_c.offset(pb as isize),
                        *h12_res_fs.offset(pb as isize),
                ...
                let fresh10 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh10 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *c_l_clfe.offset(pb as isize),
                    *h22_res_c.offset(pb as isize),
                );
            }
            let fresh11 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh11 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *c_r_clfe.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *c_r_c.offset(pb as isize) as WORD32,
                    *c_l_fs.offset(pb as isize) as WORD32,
                ),
            );
            let fresh12 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh12 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_s.offset(pb as isize),
                *h21_fs.offset(pb as isize),
            );
            if residual_coding != 0 {
                let fresh13 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh13 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h11_s.offset(pb as isize),
                    *h22_res_fs.offset(pb as isize),
                );
                let fresh14 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh14 as usize][ps as usize][pb as usize] = *h12_res_s
                    .offset(pb as isize);
            }
            let fresh15 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh15 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_s.offset(pb as isize),
                *h21_fs.offset(pb as isize),
            );
            if residual_coding != 0 {
                ...
                let fresh17 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh17 as usize][ps as usize][pb as usize] = *h22_res_s
                    .offset(pb as isize);
            }
            pb += 1;
        }
            ...
            while pb < num_parameter_bands {
                ...
                if arbitrary_downmix == 2 as core::ffi::c_int {
                    (*m1_param)
                        ...
                        as usize][ps as usize][pb as usize] = (*m1_param)
                        .m1_param_real[0 as core::ffi::c_int
                ...
                (*m1_param)
                    ...
                    (*m1_param)
                        ...
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize],
                    g_real[0 as core::ffi::c_int as usize],
                );
                (*m1_param)
                    .m1_param_real[1 as core::ffi::c_int
                    as usize][0 as core::ffi::c_int
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_calc_m1m2_5152(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut p_aux_struct: *mut ia_mps_dec_auxilary_struct = (*pstr_mps_state).aux_struct;
    let mut m2_param: *mut ia_mps_dec_m2_param_struct = (*p_aux_struct).m2_param;
    ...
    let mut ps: WORD32 = 0;
    let mut pb: WORD32 = 0;
    let mut h11_lr: *mut WORD32 = 0 as *mut WORD32;
    let mut h11_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_lr: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_lr: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_lr: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_lr: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_c: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_lr: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_c: *mut WORD32 = 0 as *mut WORD32;
    let mut c_l_lr: *mut WORD16 = 0 as *mut WORD16;
    let mut c_l_c: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r_lr: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r_c: *mut WORD16 = 0 as *mut WORD16;
    ...
    let mut c_l_clfe: *mut WORD32 = 0 as *mut WORD32;
    let mut c_r_clfe: *mut WORD32 = 0 as *mut WORD32;
    let mut c_l_l: *mut WORD16 = 0 as *mut WORD16;
    let mut c_l_r: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r_l: *mut WORD16 = 0 as *mut WORD16;
    let mut c_r_r: *mut WORD16 = 0 as *mut WORD16;
    let mut idx: WORD32 = 0;
    let mut num_parameter_sets: WORD32 = (*pstr_mps_state).num_parameter_sets;
    let mut residual_coding: WORD32 = (*pstr_mps_state).residual_coding;
    let mut num_parameter_bands: WORD32 = (*pstr_mps_state).num_parameter_bands;
    let mut arbitrary_downmix: WORD32 = (*pstr_mps_state).arbitrary_downmix;
    let mut res_bands: *mut WORD32 = ((*pstr_mps_state).res_bands).as_mut_ptr();
    h11_lr = (*pstr_mps_state).mps_scratch_mem_v as *mut WORD32;
    h11_c = h11_lr
        .offset(
            ((28 as usize)
                .wrapping_mul(::core::mem::size_of::<WORD32>() as usize)
    ...
    c_l_lr = ((*pstr_mps_state).mps_scratch_mem_v as *mut WORD16)
        .offset(
            ((1456 as usize)
                .wrapping_mul(::core::mem::size_of::<WORD16>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
    ...
    while ps < num_parameter_sets {
        ...
        pb = 0 as core::ffi::c_int as WORD32;
        while pb < (*p_aux_struct).num_ott_bands[2 as core::ffi::c_int as usize] {
            let mut p_cur_bs: *mut ia_mps_dec_spatial_bs_frame_struct = (*pstr_mps_state)
                .bs_frame;
            *c_l_clfe.offset(pb as isize) = (*(*pstr_mps_state)
                .ia_mps_dec_mps_table
        ...
        pb = (*p_aux_struct).num_ott_bands[2 as core::ffi::c_int as usize];
        while pb < num_parameter_bands {
            *c_l_clfe.offset(pb as isize) = ONE_IN_Q15 as WORD32;
            *c_r_clfe.offset(pb as isize) = 0 as core::ffi::c_int as WORD32;
            pb += 1;
        ...
        while pb < num_parameter_bands {
            ...
            (*m1_param)
                .m1_param_real[2 as core::ffi::c_int
                as usize][0 as core::ffi::c_int as usize][ps as usize][pb as usize] = *c_l_c
                .offset(pb as isize) as WORD32;
            (*m1_param)
                .m1_param_real[3 as core::ffi::c_int
                as usize][0 as core::ffi::c_int as usize][ps as usize][pb as usize] = ixheaac_mult16_shl(
                *c_l_c.offset(pb as isize),
                *c_l_lr.offset(pb as isize),
            ) as WORD32;
            (*m1_param)
                .m1_param_real[4 as core::ffi::c_int
                as usize][0 as core::ffi::c_int as usize][ps as usize][pb as usize] = ixheaac_mult16_shl(
                *c_l_c.offset(pb as isize),
                *c_r_lr.offset(pb as isize),
            ) as WORD32;
            pb += 1;
        }
        pb = 0 as core::ffi::c_int as WORD32;
        while pb < num_parameter_bands {
            ...
            (*m2_param)
                ...
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_l.offset(pb as isize),
                *h12_lr.offset(pb as isize),
            );
            (*m2_param)
                .m2_decor_real[2 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h12_l.offset(pb as isize);
            (*m2_param)
                .m2_decor_real[3 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
            ...
            (*m2_param)
                .m2_decor_real[5 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h22_l.offset(pb as isize);
            (*m2_param)
                .m2_decor_real[6 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_r.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h21_lr.offset(pb as isize),
                    *h12_c.offset(pb as isize),
                ),
            );
            (*m2_param)
                ...
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_r.offset(pb as isize),
                *h22_lr.offset(pb as isize),
            );
            (*m2_param)
                .m2_decor_real[8 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h12_r.offset(pb as isize);
            (*m2_param)
                .m2_decor_real[9 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
            ...
            (*m2_param)
                .m2_decor_real[11 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = *h22_r.offset(pb as isize);
            (*m2_param)
                .m2_decor_real[12 as core::ffi::c_int
                as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *c_l_clfe.offset(pb as isize),
                *h22_c.offset(pb as isize),
            );
        ...
        while pb < num_parameter_bands {
            ...
            let fresh18 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh18 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_l.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h11_lr.offset(pb as isize),
                    *h11_c.offset(pb as isize),
            ...
            if residual_coding != 0 {
                ...
                let fresh20 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh20 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h11_l.offset(pb as isize),
                    *h12_res_lr.offset(pb as isize),
                );
                let fresh21 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh21 as usize][ps as usize][pb as usize] = *h12_res_l
                    .offset(pb as isize);
            }
            let fresh22 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh22 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_l.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h11_lr.offset(pb as isize),
                    *h11_c.offset(pb as isize),
            ...
            if residual_coding != 0 {
                let fresh23 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh23 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h21_l.offset(pb as isize),
                    ixheaacd_mps_mult32_shr_15(
                        *h11_lr.offset(pb as isize),
                        *h12_res_c.offset(pb as isize),
                ...
                let fresh25 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh25 as usize][ps as usize][pb as usize] = *h22_res_l
                    .offset(pb as isize);
            }
            let fresh26 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh26 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_r.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h21_lr.offset(pb as isize),
                    *h11_c.offset(pb as isize),
            ...
            if residual_coding != 0 {
                ...
                let fresh28 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh28 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h11_r.offset(pb as isize),
                    *h22_res_lr.offset(pb as isize),
                );
                let fresh29 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh29 as usize][ps as usize][pb as usize] = *h12_res_r
                    .offset(pb as isize);
            }
            let fresh30 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh30 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_r.offset(pb as isize),
                ixheaacd_mps_mult32_shr_15(
                    *h21_lr.offset(pb as isize),
                    *h11_c.offset(pb as isize),
            ...
            if residual_coding != 0 {
                let fresh31 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh31 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h21_r.offset(pb as isize),
                    ixheaacd_mps_mult32_shr_15(
                        *h21_lr.offset(pb as isize),
                        *h12_res_c.offset(pb as isize),
                ...
                let fresh32 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh32 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h21_r.offset(pb as isize),
                    *h22_res_lr.offset(pb as isize),
                );
                let fresh33 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh33 as usize][ps as usize][pb as usize] = *h22_res_r
                    .offset(pb as isize);
            }
            let fresh34 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh34 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *c_l_clfe.offset(pb as isize),
                *h21_c.offset(pb as isize),
            );
            if residual_coding != 0 {
                let fresh35 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh35 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *c_l_clfe.offset(pb as isize),
                    *h22_res_c.offset(pb as isize),
                );
            }
            let fresh36 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh36 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *c_r_c.offset(pb as isize) as WORD32,
                *c_r_clfe.offset(pb as isize),
            );
            pb += 1;
