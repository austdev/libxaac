extern "C" {
    ...
    fn ixheaacd_peak_limiter_process_float(
        peak_limiter: *mut ia_peak_limiter_struct,
        samples: *mut [FLOAT32; 4096],
        frame_len: UWORD32,
    ) -> VOID;
    fn ixheaacd_frm_data_init(
        pstr_audio_conf: *mut ia_audio_specific_config_struct,
        pstr_dec_data: *mut ia_dec_data_struct,
    ) -> WORD32;
    fn ixheaacd_decode_create(
        dec_handle: *mut ia_exhaacplus_dec_api_struct,
        pstr_dec_data: *mut ia_dec_data_struct,
        tracks_for_decoder: WORD32,
    ) -> WORD32;
    fn ixheaacd_usac_process(
        pstr_dec_data: *mut ia_dec_data_struct,
        num_out_channels: *mut WORD32,
        dec_handle: *mut core::ffi::c_void,
    ) -> WORD32;
...
pub const IA_XHEAAC_DEC_EXE_NONFATAL_INSUFFICIENT_INPUT_BYTES: core::ffi::c_int = 0x1804
    as core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_samples_sat(
    mut outbuffer: *mut WORD8,
    mut num_samples_out: WORD32,
    mut pcmsize: WORD32,
    mut out_samples: *mut [FLOAT32; 4096],
    mut out_bytes: *mut WORD32,
    mut num_channel_out: WORD32,
) -> VOID {
    let mut num: WORD32 = 0;
    let mut i: WORD32 = 0;
    let mut write_local: WORD32 = 0;
    let mut write_local_float: FLOAT32 = 0.;
    let mut out_buf: *mut WORD16 = outbuffer as *mut WORD16;
    num = num_channel_out * num_samples_out;
    if pcmsize == 16 as core::ffi::c_int {
        i = 0 as core::ffi::c_int as WORD32;
        while i < num {
            write_local_float = (*out_samples
                .offset((i % num_channel_out) as isize))[(i / num_channel_out) as usize];
            if write_local_float > 32767.0f32 {
                write_local_float = 32767.0f32 as FLOAT32;
            } else if write_local_float < -32768.0f32 {
                write_local_float = -32768.0f32 as FLOAT32;
            }
            *out_buf.offset(i as isize) = write_local_float as WORD16;
            i += 1;
        }
        *out_bytes = (num as usize)
            .wrapping_mul(::core::mem::size_of::<WORD16>() as usize) as WORD32;
    } else {
        let mut out_24bit: *mut WORD8 = out_buf as *mut WORD8;
        i = 0 as core::ffi::c_int as WORD32;
        while i < num {
            write_local_float = (*out_samples
                .offset((i % num_channel_out) as isize))[(i / num_channel_out) as usize]
                * 256 as core::ffi::c_int as FLOAT32;
            if write_local_float > 8388607.0f32 {
                write_local_float = 8388607.0f32 as FLOAT32;
            } else if write_local_float < -8388608.0f32 {
                write_local_float = -8388608.0f32 as FLOAT32;
            }
            write_local = write_local_float as WORD32;
            let fresh0 = out_24bit;
            out_24bit = out_24bit.offset(1);
            *fresh0 = (write_local & 0xff as core::ffi::c_int) as WORD8;
            let fresh1 = out_24bit;
            out_24bit = out_24bit.offset(1);
            *fresh1 = (write_local >> 8 as core::ffi::c_int & 0xff as core::ffi::c_int)
                as WORD8;
            let fresh2 = out_24bit;
            out_24bit = out_24bit.offset(1);
            *fresh2 = (write_local >> 16 as core::ffi::c_int & 0xff as core::ffi::c_int)
                as WORD8;
            i += 1;
        }
        *out_bytes = ((num as core::ffi::c_int * 3 as core::ffi::c_int) as usize)
            .wrapping_mul(::core::mem::size_of::<WORD8>() as usize) as WORD32;
    };
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_samples_sat_mc(
    mut outbuffer: *mut WORD8,
    mut num_samples_out: WORD32,
    mut out_samples: *mut [FLOAT32; 4096],
    mut out_bytes: *mut WORD32,
    ...
    let mut out_buf: *mut WORD16 = outbuffer as *mut WORD16;
    num = num_channel_out * num_samples_out;
    if num_channel_out == 1 as core::ffi::c_int {
        i = 0 as core::ffi::c_int as WORD32;
        while i < num {
            write_local_float = (*out_samples
                .offset((i % num_channel_out) as isize))[(i / num_channel_out) as usize];
            ...
            *out_buf.offset((i * ch_fac) as isize) = write_local_float as WORD16;
            i += 1;
        }
    } else if num_channel_out == 2 as core::ffi::c_int {
        i = 0 as core::ffi::c_int as WORD32;
        while i < num_samples_out {
            write_local_float = (*out_samples
                .offset(
                    (2 as WORD32 * i % num_channel_out) as isize,
                ))[(2 as WORD32 * i / num_channel_out) as usize];
            if write_local_float > 32767.0f32 {
                write_local_float = 32767.0f32 as FLOAT32;
            } else if write_local_float < -32768.0f32 {
                write_local_float = -32768.0f32 as FLOAT32;
            ...
            *out_buf.offset((i * ch_fac) as isize) = write_local_float as WORD16;
            write_local_float = (*out_samples
                .offset(
                    ((2 as WORD32 * i + 1 as WORD32) % num_channel_out) as isize,
                ))[((2 as WORD32 * i + 1 as WORD32) / num_channel_out) as usize];
            if write_local_float > 32767.0f32 {
                write_local_float = 32767.0f32 as FLOAT32;
            } else if write_local_float < -32768.0f32 {
                write_local_float = -32768.0f32 as FLOAT32;
            ...
            *out_buf
                .offset(
                    (i as core::ffi::c_int * ch_fac as core::ffi::c_int
                        + 1 as core::ffi::c_int) as isize,
                ) = write_local_float as WORD16;
            i += 1;
        }
    }
    *out_bytes = (num as usize).wrapping_mul(::core::mem::size_of::<WORD16>() as usize)
        as WORD32;
}
unsafe extern "C" fn ixheaacd_audio_preroll_parsing(
    mut pstr_dec_data: *mut ia_dec_data_struct,
    mut conf_buf: *mut UWORD8,
    mut preroll_units: *mut WORD32,
    mut preroll_frame_offset: *mut WORD32,
    mut aac_dec_handle: *mut ia_aac_dec_state_struct,
    mut config_changed: *mut WORD32,
    mut apply_crossfade: *mut WORD32,
) -> WORD32 {
    let mut temp_buff: *mut ia_bit_buf_struct = &mut (*pstr_dec_data).dec_bit_buf
        as *mut ia_bit_buf_struct as *mut ia_bit_buf_struct;
    let mut ext_ele_present: WORD32 = 0 as WORD32;
    let mut ext_ele_use_dflt_len: WORD32 = 0 as WORD32;
    let mut ext_ele_payload_len: WORD32 = 0 as WORD32;
    let mut num_pre_roll_frames: WORD32 = 0 as WORD32;
    let mut frame_idx: WORD32 = 0 as WORD32;
    let mut temp: WORD32 = 0 as WORD32;
    let mut config_len: WORD32 = 0 as WORD32;
    let mut loop_0: WORD32 = 0;
    if (*pstr_dec_data)
        .str_frame_data
        .str_audio_specific_config
        .str_usac_config
        .str_usac_dec_config
        .usac_element_type[0 as core::ffi::c_int as usize] == ID_USAC_EXT as UWORD32
    {
        temp = ixheaacd_show_bits_buf(temp_buff, 3 as WORD);
        ext_ele_present = (temp as core::ffi::c_int >> 1 as core::ffi::c_int
            & 0x1 as core::ffi::c_int) as WORD32;
        if ext_ele_present != 0 {
            ext_ele_use_dflt_len = (temp as core::ffi::c_int & 0x1 as core::ffi::c_int)
                as WORD32;
            if ext_ele_use_dflt_len != 0 as core::ffi::c_int {
                return 0 as WORD32;
            }
            ixheaacd_read_bits_buf(temp_buff, 3 as WORD);
            ext_ele_payload_len = ixheaacd_read_bits_buf(temp_buff, 8 as WORD);
            if ext_ele_payload_len == 255 as core::ffi::c_int {
                let mut val_add: WORD32 = 0 as WORD32;
                val_add = ixheaacd_read_bits_buf(temp_buff, 16 as WORD);
                ext_ele_payload_len = (ext_ele_payload_len + val_add as core::ffi::c_int
                    - 2 as core::ffi::c_int) as UWORD32 as WORD32;
            }
            config_len = ixheaacd_read_bits_buf(temp_buff, 4 as WORD);
            if config_len == 15 as core::ffi::c_int {
                let mut val_add_0: WORD32 = 0 as WORD32;
                val_add_0 = ixheaacd_read_bits_buf(temp_buff, 4 as WORD);
                config_len += val_add_0;
                if val_add_0 == 15 as core::ffi::c_int {
                    let mut val_add1: WORD32 = 0 as WORD32;
                    val_add1 = ixheaacd_read_bits_buf(temp_buff, 8 as WORD);
                    config_len += val_add1;
                }
            }
            loop_0 = 0 as core::ffi::c_int as WORD32;
            while loop_0 < config_len {
                *conf_buf.offset(loop_0 as isize) = ixheaacd_read_bits_buf(
                    temp_buff,
                    8 as WORD,
                ) as UWORD8;
                loop_0 += 1;
            }
            if (*aac_dec_handle).preroll_config_present as core::ffi::c_int
                == 1 as core::ffi::c_int
            {
                if memcmp(
                    ((*aac_dec_handle).preroll_config_prev).as_mut_ptr()
                        as *const core::ffi::c_void,
                    conf_buf as *const core::ffi::c_void,
                    (::core::mem::size_of::<UWORD8>() as size_t)
                        .wrapping_mul(config_len as size_t),
                ) == 0
                {
                    config_len = 0 as core::ffi::c_int as WORD32;
                }
                if memcmp(
                    ((*aac_dec_handle).preroll_config_prev).as_mut_ptr()
                        as *const core::ffi::c_void,
                ...
                {
                    *config_changed = 1 as core::ffi::c_int as WORD32;
                } else {
                    *config_changed = 0 as core::ffi::c_int as WORD32;
                }
            }
            (*aac_dec_handle).preroll_config_present = 1 as UWORD8;
            memcpy(
                ((*aac_dec_handle).preroll_config_prev).as_mut_ptr()
            ...
            *apply_crossfade = ixheaacd_read_bits_buf(temp_buff, 1 as WORD);
            ixheaacd_read_bits_buf(temp_buff, 1 as WORD);
            num_pre_roll_frames = ixheaacd_read_bits_buf(temp_buff, 2 as WORD);
            if num_pre_roll_frames == 3 as core::ffi::c_int {
                let mut val_add_1: WORD32 = 0 as WORD32;
                val_add_1 = ixheaacd_read_bits_buf(temp_buff, 4 as WORD);
                num_pre_roll_frames += val_add_1;
            }
            if num_pre_roll_frames > MAX_AUDIO_PREROLLS {
                if (*pstr_dec_data).str_usac_data.ec_flag != 0 {
                    num_pre_roll_frames = 0 as core::ffi::c_int as WORD32;
                    longjmp(
                        (*(*pstr_dec_data).xaac_jmp_buf).as_mut_ptr(),
            ...
            frame_idx = 0 as core::ffi::c_int as WORD32;
            while frame_idx < num_pre_roll_frames {
                let mut au_len: WORD32 = 0 as WORD32;
                au_len = ixheaacd_read_bits_buf(temp_buff, 16 as WORD);
                if au_len == 65535 as core::ffi::c_int {
                    let mut val_add_2: WORD32 = ixheaacd_read_bits_buf(
                        temp_buff,
                        16 as WORD,
                    );
                    au_len += val_add_2;
                }
                if config_len != 0 as core::ffi::c_int {
                    *preroll_frame_offset.offset(frame_idx as isize) = (*temp_buff).size
                        - (*temp_buff).cnt_bits;
                }
                (*temp_buff).ptr_read_next = ((*temp_buff).ptr_read_next)
                    .offset(au_len as isize);
                (*temp_buff).cnt_bits
                    -= au_len as core::ffi::c_int * 8 as core::ffi::c_int;
                if (*temp_buff).cnt_bits < 0 as core::ffi::c_int {
                    if (*pstr_dec_data).str_usac_data.ec_flag != 0 {
                        (*temp_buff).cnt_bits = 0 as core::ffi::c_int as WORD32;
                        longjmp(
                            (*(*pstr_dec_data).xaac_jmp_buf).as_mut_ptr(),
                            IA_XHEAAC_DEC_EXE_NONFATAL_INSUFFICIENT_INPUT_BYTES,
                        );
    ...
    if config_len == 0 as core::ffi::c_int {
        *preroll_units = 0 as core::ffi::c_int as WORD32;
    } else {
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_dec_main(
    mut temp_handle: *mut core::ffi::c_void,
    mut inbuffer: *mut WORD8,
    mut outbuffer: *mut WORD8,
    mut out_bytes: *mut WORD32,
    mut frames_done: WORD32,
    mut pcmsize: WORD32,
    mut num_channel_out: *mut WORD32,
) -> WORD32 {
    let mut err: WORD32 = 0 as WORD32;
    let mut handle: *mut ia_exhaacplus_dec_api_struct = temp_handle
    ...
    let mut pstr_audio_specific_config: *mut ia_audio_specific_config_struct = (*aac_dec_handle)
        .ia_audio_specific_config as *mut ia_audio_specific_config_struct;
    let mut suitable_tracks: WORD32 = 1 as WORD32;
    let mut num_samples_out: WORD32 = 0;
    let mut pstr_dec_data: *mut ia_dec_data_struct = 0 as *mut ia_dec_data_struct;
    let mut config: [UWORD8; 285] = [0; 285];
    let mut config_len: WORD32 = 0;
    let mut delay: WORD32 = 0;
    let mut preroll_frame_offset: [WORD; 4] = [0 as core::ffi::c_int; 4];
    let mut preroll_units: WORD = -(1 as WORD);
    let mut access_units: WORD32 = 0 as WORD32;
    let mut bits_consumed: WORD32 = 0 as WORD32;
    if frames_done == 0 as core::ffi::c_int {
        if (*pstr_audio_specific_config).channel_configuration > 2 as UINT32
            || (*pstr_audio_specific_config).channel_configuration == 0 as UINT32
        {
            return -(1 as WORD32);
        }
        pstr_dec_data = (*aac_dec_handle).pstr_dec_data as *mut ia_dec_data_struct;
        tmp = (*pstr_audio_specific_config).channel_configuration as WORD32;
        suitable_tracks = ixheaacd_frm_data_init(
            pstr_audio_specific_config,
            pstr_dec_data,
        );
        (*pstr_audio_specific_config).channel_configuration = tmp as UINT32;
        if suitable_tracks <= 0 as core::ffi::c_int {
            return -(1 as WORD32);
        }
    }
    let mut tot_out_bytes: WORD32 = 0 as WORD32;
    ...
    pstr_dec_data = (*aac_dec_handle).pstr_dec_data as *mut ia_dec_data_struct;
    (*pstr_dec_data).str_usac_data.frame_ok = 1 as core::ffi::c_int as WORD32;
    (*pstr_dec_data).str_usac_data.ec_flag = (*(*aac_dec_handle).p_config)
        .ui_err_conceal;
    if (*pstr_dec_data).str_usac_data.ec_flag != 0 {
        err = _setjmp(local.as_mut_ptr()) as WORD32;
    }
    if (*(*aac_dec_handle).p_config).ui_err_conceal != 0 {
        if err == 0 as core::ffi::c_int {
            if (*pstr_dec_data).dec_bit_buf.cnt_bits != 0 {
                (*aac_dec_handle).ui_in_bytes = ((*aac_dec_handle).ui_in_bytes)
                    .wrapping_add(
                        ((*pstr_dec_data).dec_bit_buf.cnt_bits >> 3 as core::ffi::c_int)
                            as UWORD32,
                    );
                if (*aac_dec_handle).ui_in_bytes > IA_MAX_INP_BUFFER_SIZE as UWORD32 {
                    (*aac_dec_handle).ui_in_bytes = 0 as UWORD32;
                }
            }
        } else {
            (*pstr_dec_data).str_usac_data.frame_ok = 0 as core::ffi::c_int as WORD32;
        }
    }
    if frames_done == 0 as core::ffi::c_int {
        let mut delay_0: WORD32 = 0;
        (*pstr_dec_data).str_usac_data.first_frame = 1 as core::ffi::c_int as WORD32;
        if (*aac_dec_handle).decode_create_done == 0 as core::ffi::c_int {
            delay_0 = ixheaacd_decode_create(
                handle,
                pstr_dec_data,
                ((*pstr_dec_data).str_frame_data.scal_out_select)
                    .wrapping_add(1 as UWORD32) as WORD32,
            );
            if delay_0 == -(1 as core::ffi::c_int) {
                return -(1 as WORD32);
            }
        }
        (*pstr_dec_data).dec_bit_buf.max_size = (*((*handle).p_mem_info_aac)
            .offset(IA_MEMTYPE_INPUT as isize))
            .ui_size as WORD32;
        *num_channel_out = (*pstr_dec_data).str_frame_data.scal_out_num_channels;
        return 0 as WORD32;
    }
    (*pstr_dec_data).dec_bit_buf.ptr_bit_buf_base = inbuffer as *mut UWORD8;
    (*pstr_dec_data).dec_bit_buf.size = ((*aac_dec_handle).ui_in_bytes
        << 3 as core::ffi::c_int) as WORD32;
    (*pstr_dec_data).dec_bit_buf.ptr_bit_buf_end = (inbuffer as *mut UWORD8)
        .offset((*aac_dec_handle).ui_in_bytes as isize)
        .offset(-(1 as core::ffi::c_int as isize));
    (*pstr_dec_data).dec_bit_buf.ptr_read_next = inbuffer as *mut UWORD8;
    (*pstr_dec_data).dec_bit_buf.bit_pos = 7 as core::ffi::c_int as WORD32;
    (*pstr_dec_data).dec_bit_buf.cnt_bits = (*pstr_dec_data).dec_bit_buf.size;
    (*pstr_dec_data).dec_bit_buf.xaac_jmp_buf = &mut (*aac_dec_handle).xaac_jmp_buf;
    if (*pstr_dec_data).str_usac_data.ec_flag != 0 {
        (*pstr_dec_data).xaac_jmp_buf = &mut local;
    }
    (*pstr_dec_data).str_usac_data.usac_flag = (*aac_dec_handle).usac_flag as WORD32;
    (*pstr_dec_data).str_usac_data.esbr_hq = (*handle).aac_config.ui_hq_esbr;
    (*pstr_dec_data).str_usac_data.enh_sbr = 1 as core::ffi::c_int as WORD32;
        ...
        && (*pstr_dec_data).str_usac_data.frame_ok != 0
    {
        let mut sync: WORD32 = ixheaacd_read_bits_buf(
            &mut (*pstr_dec_data).dec_bit_buf,
            11 as WORD,
        );
        if sync == 0x2b7 as core::ffi::c_int {
            let mut result: WORD32 = ixheaacd_latm_audio_mux_element(
                &mut (*pstr_dec_data).dec_bit_buf,
                &mut (*aac_dec_handle).latm_struct_element,
                aac_dec_handle,
                &mut *((*(*handle).aac_tables.pstr_huffmann_tables).str_sample_rate_info)
                    .as_mut_ptr()
        ...
        bits_consumed = (*pstr_dec_data).dec_bit_buf.size
            - (*pstr_dec_data).dec_bit_buf.cnt_bits;
    }
    loop {
        config_len = 0 as core::ffi::c_int as WORD32;
        if err == 0 as core::ffi::c_int
            || (*(*aac_dec_handle).p_config).ui_err_conceal == 0 as core::ffi::c_int
        {
            if access_units == 0 as core::ffi::c_int
                && (*pstr_audio_specific_config)
                    .str_usac_config
                    .str_usac_dec_config
                    .preroll_flag != 0
            {
                config_len = ixheaacd_audio_preroll_parsing(
                    pstr_dec_data,
                    &mut *config.as_mut_ptr().offset(0 as core::ffi::c_int as isize),
                    &mut preroll_units,
                    &mut *preroll_frame_offset
                        .as_mut_ptr()
                        .offset(0 as core::ffi::c_int as isize),
                    aac_dec_handle,
                    &mut (*aac_dec_handle).drc_config_changed,
                    &mut (*aac_dec_handle).apply_crossfade,
                );
                if config_len as core::ffi::c_uint == IA_FATAL_ERROR {
                    return IA_FATAL_ERROR as WORD32;
                }
            }
            if config_len != 0 as core::ffi::c_int {
                let mut config_bit_buf: ia_bit_buf_struct = {
                ...
                config_bit_buf.ptr_bit_buf_base = config.as_mut_ptr();
                config_bit_buf.size = config_len << 3 as core::ffi::c_int;
                config_bit_buf.ptr_read_next = config_bit_buf.ptr_bit_buf_base;
                config_bit_buf.ptr_bit_buf_end = config
                    .as_mut_ptr()
                    .offset(config_len as isize);
                config_bit_buf.bit_pos = 7 as core::ffi::c_int as WORD32;
                config_bit_buf.cnt_bits = config_bit_buf.size;
                if (*pstr_dec_data).str_usac_data.ec_flag != 0 {
                    config_bit_buf.xaac_jmp_buf = &mut local;
                } else {
                    config_bit_buf.xaac_jmp_buf = &mut (*aac_dec_handle).xaac_jmp_buf;
                }
                suitable_tracks = ixheaacd_frm_data_init(
                    pstr_audio_specific_config,
                    pstr_dec_data,
                ...
                (*aac_dec_handle).decode_create_done = 0 as core::ffi::c_int as WORD32;
                if (*(*aac_dec_handle).p_config).ui_err_conceal != 0 {
                    if (*pstr_dec_data).str_usac_data.frame_ok == 1 as core::ffi::c_int
                ...
                (*pstr_dec_data)
                    .str_frame_data
                    .str_audio_specific_config
                    .sampling_frequency = (*pstr_dec_data)
                    .str_frame_data
                    .str_audio_specific_config
                    .str_usac_config
        ...
        (*pstr_dec_data).str_usac_data.enh_sbr = 1 as core::ffi::c_int as WORD32;
        (*pstr_dec_data).str_usac_data.enh_sbr_ps = (*handle).aac_config.ui_enh_sbr_ps;
        if preroll_frame_offset[access_units as usize] != 0
            && ((*pstr_dec_data).str_usac_data.ec_flag != 0
                && (*pstr_dec_data).str_usac_data.frame_ok == 1 as core::ffi::c_int
                || (*pstr_dec_data).str_usac_data.ec_flag == 0 as core::ffi::c_int)
        {
            (*pstr_dec_data).dec_bit_buf.cnt_bits = ((*pstr_dec_data).dec_bit_buf.size
                as WORD - preroll_frame_offset[access_units as usize]) as WORD32;
            (*pstr_dec_data).dec_bit_buf.bit_pos = (7 as core::ffi::c_int
                - preroll_frame_offset[access_units as usize] % 8 as core::ffi::c_int)
                as WORD32;
            (*pstr_dec_data).dec_bit_buf.ptr_read_next = ((*pstr_dec_data)
                .dec_bit_buf
                .ptr_read_next)
                .offset(
                    (preroll_frame_offset[access_units as usize] / 8 as core::ffi::c_int)
            ...
            (*pstr_dec_data).dec_bit_buf.cnt_bits = (*pstr_dec_data).dec_bit_buf.size
                - bits_consumed;
            (*pstr_dec_data).dec_bit_buf.bit_pos = (7 as core::ffi::c_int
                - bits_consumed as core::ffi::c_int % 8 as core::ffi::c_int) as WORD32;
            (*pstr_dec_data).dec_bit_buf.ptr_read_next = ((*pstr_dec_data)
                .dec_bit_buf
                .ptr_read_next)
                .offset(
                    (bits_consumed as core::ffi::c_int / 8 as core::ffi::c_int) as isize,
                );
        }
        if (*pstr_dec_data).str_usac_data.ec_flag != 0 {
            if (*aac_dec_handle).decode_create_done == 0
                && (*pstr_dec_data).str_usac_data.frame_ok == 1 as core::ffi::c_int
                && config_len != 0 as core::ffi::c_int
            {
                return IA_FATAL_ERROR as WORD32;
            }
        } else if (*aac_dec_handle).decode_create_done == 0 {
            return IA_FATAL_ERROR as WORD32
        }
        err = ixheaacd_usac_process(
            pstr_dec_data,
            num_channel_out,
        ...
        if err == -(1 as core::ffi::c_int) {
            return err;
        }
        num_samples_out = (*pstr_dec_data).str_usac_data.output_samples;
        if (*handle).aac_config.peak_limiter_off == 0
            && (*pstr_dec_data).str_usac_data.ec_flag != 0
        {
            (*aac_dec_handle).peak_limiter.num_channels = *num_channel_out as UWORD32;
            ixheaacd_peak_limiter_process_float(
                &mut (*aac_dec_handle).peak_limiter,
                ((*pstr_dec_data).str_usac_data.time_sample_vector).as_mut_ptr(),
                num_samples_out as UWORD32,
            );
        }
        ixheaacd_samples_sat(
            outbuffer.offset(tot_out_bytes as isize),
            num_samples_out,
            pcmsize,
            ((*pstr_dec_data).str_usac_data.time_sample_vector).as_mut_ptr()
                as *mut [FLOAT32; 4096],
        ...
        let mut preroll_counter: WORD32 = (*pstr_dec_data)
            .str_frame_data
            .str_audio_specific_config
            .str_usac_config
            .str_usac_dec_config
            .preroll_counter;
        let mut i: UWORD8 = 0;
        let mut payload_buffer_offset: WORD32 = 0 as WORD32;
        let mut copy_bytes: WORD32 = ((*pstr_dec_data)
            .str_frame_data
            .str_audio_specific_config
            .str_usac_config
            .str_usac_dec_config
            .usac_ext_gain_payload_len[preroll_counter as usize] as usize)
            .wrapping_mul(::core::mem::size_of::<WORD8>() as usize) as WORD32;
        (*pstr_audio_specific_config)
            .str_usac_config
            .str_usac_dec_config
            .usac_ext_gain_payload_len[preroll_counter as usize] = (*pstr_dec_data)
            .str_frame_data
            .str_audio_specific_config
            .str_usac_config
            .str_usac_dec_config
            .usac_ext_gain_payload_len[preroll_counter as usize];
        i = 0 as UWORD8;
        while (i as core::ffi::c_int) < preroll_counter {
            payload_buffer_offset = (payload_buffer_offset as core::ffi::c_ulong)
                .wrapping_add(
                    ((*pstr_dec_data)
                        .str_frame_data
                        .str_audio_specific_config
        ...
        memcpy(
            ((*pstr_audio_specific_config)
                ...
                .as_mut_ptr()
                .offset(payload_buffer_offset as isize) as *mut core::ffi::c_void,
            ((*pstr_dec_data)
                .str_frame_data
                .str_audio_specific_config
                .str_usac_config
                ...
                .usac_ext_gain_payload_buf)
                .as_mut_ptr()
                .offset(payload_buffer_offset as isize) as *const core::ffi::c_void,
            copy_bytes as size_t,
        );
        (*pstr_audio_specific_config)
            .str_usac_config
            .str_usac_dec_config
            .preroll_bytes[preroll_counter as usize] = *out_bytes as UWORD32;
        preroll_counter += 1;
        if preroll_counter > MAX_AUDIO_PREROLLS + 1 as core::ffi::c_int {
            return IA_FATAL_ERROR as WORD32;
        }
        (*pstr_dec_data)
            .str_frame_data
        ...
        let mut pstr_usac_dec_config_state: *mut ia_usac_decoder_config_struct = &mut (*pstr_audio_specific_config)
            .str_usac_config
            .str_usac_dec_config;
        let mut pstr_usac_dec_config_dec_data: *mut ia_usac_decoder_config_struct = &mut (*pstr_dec_data)
            .str_frame_data
            .str_audio_specific_config
            .str_usac_config
            .str_usac_dec_config;
        (*pstr_usac_dec_config_state).num_config_extensions = (*pstr_usac_dec_config_dec_data)
            .num_config_extensions;
        (*pstr_usac_dec_config_state).num_elements = (*pstr_usac_dec_config_dec_data)
            .num_elements;
        memcpy(
            ((*pstr_usac_dec_config_state).usac_cfg_ext_info_buf).as_mut_ptr()
                as *mut core::ffi::c_void,
            ((*pstr_usac_dec_config_dec_data).usac_cfg_ext_info_buf).as_mut_ptr()
                as *const core::ffi::c_void,
            ::core::mem::size_of::<[[UWORD8; 768]; 16]>() as size_t,
        );
        memcpy(
            ((*pstr_usac_dec_config_state).usac_ext_ele_payload_present).as_mut_ptr()
                as *mut core::ffi::c_void,
            ((*pstr_usac_dec_config_dec_data).usac_ext_ele_payload_present).as_mut_ptr()
                as *const core::ffi::c_void,
            ::core::mem::size_of::<[WORD32; 16]>() as size_t,
        );
        memcpy(
            ((*pstr_usac_dec_config_state).usac_ext_ele_payload_buf).as_mut_ptr()
                as *mut core::ffi::c_void,
            ((*pstr_usac_dec_config_dec_data).usac_ext_ele_payload_buf).as_mut_ptr()
                as *const core::ffi::c_void,
            ::core::mem::size_of::<[[UWORD8; 768]; 16]>() as size_t,
        );
        access_units += 1;
        ...
        if !(preroll_units >= 0 as core::ffi::c_int) {
            break;
        }
    }
    *out_bytes = tot_out_bytes;
    if (*aac_dec_handle).bs_format == LOAS_BSFORMAT {
        ...
        (*pstr_dec_data).dec_bit_buf.cnt_bits = (*pstr_dec_data).dec_bit_buf.size;
        (*pstr_dec_data).dec_bit_buf.xaac_jmp_buf = &mut (*aac_dec_handle).xaac_jmp_buf;
        ixheaacd_read_bits_buf(&mut (*pstr_dec_data).dec_bit_buf, 11 as WORD);
        (*aac_dec_handle).i_bytes_consumed = (ixheaacd_read_bits_buf(
            &mut (*pstr_dec_data).dec_bit_buf,
            13 as WORD,
