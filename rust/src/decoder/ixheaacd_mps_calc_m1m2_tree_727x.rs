extern "C" {
    ...
    fn ixheaacd_param_2_umx_ps(
        ...
        c_r: *mut WORD16,
        ott_box_indx: WORD32,
        parameter_set_indx: WORD32,
        res_bands: WORD32,
    ) -> VOID;
    fn ixheaacd_calculate_arb_dmx_mtx(
        pstr_mps_state: *mut ia_heaac_mps_state_struct,
        ps: WORD32,
        pb: WORD32,
        g_real: *mut WORD32,
    ) -> VOID;
    fn ixheaacd_calculate_ttt(
        pstr_mps_state: *mut ia_heaac_mps_state_struct,
        ps: WORD32,
        pb: WORD32,
        ttt_mode: WORD32,
...
pub const MINUS_SQRT_2_Q30: core::ffi::c_int = -(1518500250 as core::ffi::c_int);
#[inline]
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_calc_m1m2_7271(
    ...
    let mut i: WORD32 = 0;
    let mut m_pre: [[WORD32; 5]; 3] = [[0; 5]; 3];
    let mut m_ttt: [[WORD32; 3]; 3] = [[0; 3]; 3];
    let mut g_real: [WORD32; 2] = [0; 2];
    let mut temp_1: WORD32 = 0;
    let mut temp_2: WORD32 = 0;
    let mut acc: WORD64 = 0;
    let mut h11_l: *mut WORD32 = 0 as *mut WORD32;
    let mut h11_r: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_l: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_r: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_l: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_r: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_l: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_r: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_l: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_r: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_l: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_r: *mut WORD32 = 0 as *mut WORD32;
    let mut c_l_clfe: *mut WORD32 = 0 as *mut WORD32;
    let mut c_r_clfe: *mut WORD32 = 0 as *mut WORD32;
    let mut kappa: *mut WORD32 = 0 as *mut WORD32;
    let mut g_dd: *mut WORD32 = 0 as *mut WORD32;
    let mut c_f_l: *mut WORD16 = 0 as *mut WORD16;
    let mut c_f_r: *mut WORD16 = 0 as *mut WORD16;
    let mut dummy: *mut WORD16 = 0 as *mut WORD16;
    let mut h11_lc: *mut WORD32 = 0 as *mut WORD32;
    let mut h11_rc: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_lc: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_rc: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_lc: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_rc: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_lc: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_rc: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_lc: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_rc: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_lc: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_rc: *mut WORD32 = 0 as *mut WORD32;
    let mut c_f_lc: *mut WORD16 = 0 as *mut WORD16;
    let mut c_f_rc: *mut WORD16 = 0 as *mut WORD16;
    ...
    let mut m1_param_imag_present: WORD32 = (*pstr_mps_state).m1_param_imag_present;
    ...
    let mut mode_0: WORD32 = (*p_aux_struct)
        .ttt_config[0 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
        .mode;
    let mut mode_1: WORD32 = (*p_aux_struct)
        .ttt_config[1 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
        .mode;
    let mut enable_additionals: WORD32 = (mode_0 == 0 as core::ffi::c_int
        || mode_1 == 0 as core::ffi::c_int) as core::ffi::c_int;
    let mut pos: [WORD32; 5] = [0 as core::ffi::c_int; 5];
    let mut pos_resid: [WORD32; 5] = [0 as core::ffi::c_int; 5];
    h11_l = (*pstr_mps_state).mps_scratch_mem_v as *mut WORD32;
    h11_r = h11_l
        .offset(
            ((28 as usize)
    ...
    c_f_l = ((*pstr_mps_state).mps_scratch_mem_v as *mut WORD16)
        .offset(
            ((1568 as usize)
    ...
    if enable_additionals != 0 {
        if mode_1 == 0 as core::ffi::c_int
            && (*p_aux_struct)
                ...
                >= (*p_aux_struct)
                    ...
                    .stop_band
        {
            enable_additionals = 0 as core::ffi::c_int as WORD32;
        } else if mode_0 == 0 as core::ffi::c_int
            && (*p_aux_struct)
    ...
    while ps < num_parameter_sets {
        ixheaacd_param_2_umx_ps(
            ...
            1 as WORD32,
            ps,
            *res_bands.offset(1 as core::ffi::c_int as isize),
        );
        ixheaacd_param_2_umx_ps(
            pstr_mps_state,
            h11_r,
            ...
            2 as WORD32,
            ps,
            *res_bands.offset(2 as core::ffi::c_int as isize),
        );
        ixheaacd_param_2_umx_ps(
            pstr_mps_state,
            h11_lc,
            ...
            3 as WORD32,
            ps,
            *res_bands.offset(3 as core::ffi::c_int as isize),
        );
        ixheaacd_param_2_umx_ps(
            pstr_mps_state,
            h11_rc,
            ...
            4 as WORD32,
            ps,
            *res_bands.offset(4 as core::ffi::c_int as isize),
        );
        ...
        while i < 2 as core::ffi::c_int {
            ...
            while pb
                < (*p_aux_struct)
                    ...
                    .stop_band
            {
                let mut mtx_inversion: WORD32 = (*pstr_mps_state).mtx_inversion;
                memset(
                    m_pre.as_mut_ptr() as *mut core::ffi::c_void,
                    0 as core::ffi::c_int,
                    ::core::mem::size_of::<[[WORD32; 5]; 3]>() as size_t,
                );
                if (*p_aux_struct)
                    .ttt_config[i as usize][0 as core::ffi::c_int as usize]
                    .mode >= 2 as core::ffi::c_int
                {
                    mtx_inversion = (mtx_inversion != 0
                        && ((*p_aux_struct)
                            .ttt_config[i as usize][0 as core::ffi::c_int as usize]
                            .mode == 2 as core::ffi::c_int
                            || (*p_aux_struct)
                                .ttt_config[i as usize][0 as core::ffi::c_int as usize]
                                .mode == 4 as core::ffi::c_int)) as core::ffi::c_int
                        as WORD32;
                }
                ...
                while row < 3 as core::ffi::c_int {
                    col = 0 as core::ffi::c_int as WORD32;
                    while col < 3 as core::ffi::c_int {
                        m_pre[row as usize][col as usize] = m_ttt[row
                            as usize][col as usize];
                        col += 1;
                    }
                    row += 1;
                }
                if arbitrary_downmix != 0 as core::ffi::c_int {
                    let mut ch: WORD32 = 0;
                    ...
                    while ch < num_input_channels {
                        row = 0 as core::ffi::c_int as WORD32;
                        while row < 3 as core::ffi::c_int {
                            m_pre[row as usize][col as usize] = ixheaacd_mps_mult32_shr_15(
                                m_pre[row as usize][col as usize],
                                g_real[ch as usize],
                            );
                            if arbitrary_downmix == 2 as core::ffi::c_int
                                && pb < (*pstr_mps_state).arbdmx_residual_bands
                            {
                                m_pre[row as usize][(3 as WORD32 + ch) as usize] = m_ttt[row
                                    as usize][ch as usize];
                            }
                            row += 1;
                        }
                        ch += 1;
                ...
                if mtx_inversion != 0 {
                    let mut h_real: [[WORD32; 2]; 2] = [[0; 2]; 2];
                    let mut h_imag: [[WORD32; 2]; 2] = [[0; 2]; 2];
                    ...
                    acc = m_pre[0 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                        * h_real[0 as core::ffi::c_int
                            as usize][0 as core::ffi::c_int as usize] as WORD64
                        + m_pre[0 as core::ffi::c_int
                            as usize][1 as core::ffi::c_int as usize] as WORD64
                            * h_real[1 as core::ffi::c_int
                                as usize][0 as core::ffi::c_int as usize] as WORD64;
                    acc >>= 15 as core::ffi::c_int;
                    (*m1_param)
                        .m1_param_real[0 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = acc as WORD32;
                    acc = m_pre[0 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                        * h_real[0 as core::ffi::c_int
                            as usize][1 as core::ffi::c_int as usize] as WORD64
                    ...
                    (*m1_param)
                        ...
                        as usize][ps as usize][pb as usize] = acc as WORD32;
                    acc = m_pre[1 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                        * h_real[0 as core::ffi::c_int
                            as usize][0 as core::ffi::c_int as usize] as WORD64
                        + m_pre[1 as core::ffi::c_int
                            as usize][1 as core::ffi::c_int as usize] as WORD64
                            * h_real[1 as core::ffi::c_int
                                as usize][0 as core::ffi::c_int as usize] as WORD64;
                    acc >>= 15 as core::ffi::c_int;
                    (*m1_param)
                        .m1_param_real[1 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = acc as WORD32;
                    acc = m_pre[1 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                    ...
                    (*m1_param)
                        ...
                        as usize][1 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = acc as WORD32;
                    acc = m_pre[2 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                        * h_real[0 as core::ffi::c_int
                            as usize][0 as core::ffi::c_int as usize] as WORD64
                        + m_pre[2 as core::ffi::c_int
                            as usize][1 as core::ffi::c_int as usize] as WORD64
                            * h_real[1 as core::ffi::c_int
                                as usize][0 as core::ffi::c_int as usize] as WORD64;
                    acc >>= 15 as core::ffi::c_int;
                    (*m1_param)
                        .m1_param_real[2 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = acc as WORD32;
                    acc = m_pre[2 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                    ...
                    acc = m_pre[0 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                        * h_imag[0 as core::ffi::c_int
                            as usize][0 as core::ffi::c_int as usize] as WORD64
                        + m_pre[0 as core::ffi::c_int
                            as usize][1 as core::ffi::c_int as usize] as WORD64
                            * h_imag[1 as core::ffi::c_int
                                as usize][0 as core::ffi::c_int as usize] as WORD64;
                    acc >>= 15 as core::ffi::c_int;
                    (*m1_param)
                        .m1_param_imag[0 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = acc as WORD32;
                    acc = m_pre[0 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                    ...
                    acc >>= 15 as core::ffi::c_int;
                    (*m1_param)
                        .m1_param_imag[1 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = acc as WORD32;
                    acc = m_pre[1 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                    ...
                    acc >>= 15 as core::ffi::c_int;
                    (*m1_param)
                        .m1_param_imag[2 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = acc as WORD32;
                    acc = m_pre[2 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize] as WORD64
                    ...
                    (*m1_param)
                        ...
                        as usize][1 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = acc as WORD32;
                } else if !((*pstr_mps_state)._3d_stereo_inversion != 0) {
                    (*m1_param)
                        .m1_param_real[0 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = m_pre[0 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize];
                    (*m1_param)
                        .m1_param_real[0 as core::ffi::c_int
                        as usize][1 as core::ffi::c_int
                    ...
                    (*m1_param)
                        .m1_param_real[1 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = m_pre[1 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize];
                    (*m1_param)
                        .m1_param_real[1 as core::ffi::c_int
                        as usize][1 as core::ffi::c_int
                    ...
                    (*m1_param)
                        .m1_param_real[2 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int
                        as usize][ps as usize][pb as usize] = m_pre[2 as core::ffi::c_int
                        as usize][0 as core::ffi::c_int as usize];
                    (*m1_param)
                        .m1_param_real[2 as core::ffi::c_int
                        as usize][1 as core::ffi::c_int
                ...
                (*m1_param)
                    ...
                    as usize][ps as usize][pb as usize] = m_pre[0 as core::ffi::c_int
                    as usize][3 as core::ffi::c_int as usize];
                (*m1_param)
                    .m1_param_real[0 as core::ffi::c_int
                    as usize][4 as core::ffi::c_int
                    as usize][ps as usize][pb as usize] = m_pre[0 as core::ffi::c_int
                ...
                (*m1_param)
                    ...
                    as usize][4 as core::ffi::c_int as usize];
                col = 0 as core::ffi::c_int as WORD32;
                while col < (*pstr_mps_state).num_x_channels {
                    (*m1_param)
                        .m1_param_real[3 as core::ffi::c_int
                        as usize][col as usize][ps as usize][pb as usize] = (*m1_param)
                        .m1_param_real[0 as core::ffi::c_int
                        as usize][col as usize][ps as usize][pb as usize];
                    (*m1_param)
                        .m1_param_real[4 as core::ffi::c_int
                        as usize][col as usize][ps as usize][pb as usize] = (*m1_param)
                        .m1_param_real[1 as core::ffi::c_int
                        as usize][col as usize][ps as usize][pb as usize];
                    (*curr_state)
                        .m1_param_present[3 as core::ffi::c_int
                        as usize][col as usize] = 1 as core::ffi::c_int as WORD32;
                    (*curr_state)
                        .m1_param_present[4 as core::ffi::c_int
                        as usize][col as usize] = 1 as core::ffi::c_int as WORD32;
                    if m1_param_imag_present != 0 {
                        (*m1_param)
                            .m1_param_imag[3 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize] = (*m1_param)
                            .m1_param_imag[0 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize];
                        (*m1_param)
                            .m1_param_imag[4 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize] = (*m1_param)
                            .m1_param_imag[1 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize];
                    }
                    ...
                    {
                        (*m1_param)
                            .m1_param_real[5 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize] = (*m1_param)
                            .m1_param_real[2 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize];
                        if m1_param_imag_present != 0 {
                            (*m1_param)
                                .m1_param_imag[5 as core::ffi::c_int
                                as usize][col as usize][ps as usize][pb as usize] = (*m1_param)
                                .m1_param_imag[2 as core::ffi::c_int
                                as usize][col as usize][ps as usize][pb as usize];
                        }
                        ...
                        (*m1_param)
                            .m1_param_real[5 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize] = 0
                    ...
                    (*m1_param)
                        .m1_param_real[6 as core::ffi::c_int
                        as usize][col as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                        *c_f_l.offset(pb as isize) as WORD32,
                        (*m1_param)
                            .m1_param_real[0 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize],
                    );
                    (*m1_param)
                        .m1_param_real[7 as core::ffi::c_int
                        as usize][col as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                        *c_f_r.offset(pb as isize) as WORD32,
                        (*m1_param)
                            .m1_param_real[1 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize],
                    );
                    if m1_param_imag_present != 0 {
                        (*m1_param)
                            .m1_param_imag[6 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            *c_f_l.offset(pb as isize) as WORD32,
                            (*m1_param)
                                .m1_param_imag[0 as core::ffi::c_int
                        ...
                        (*m1_param)
                            .m1_param_imag[7 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            *c_f_r.offset(pb as isize) as WORD32,
                            (*m1_param)
                                .m1_param_imag[1 as core::ffi::c_int
        ...
        while pb < (*p_aux_struct).num_ott_bands[0 as core::ffi::c_int as usize] {
            let mut p_cur_bs: *mut ia_mps_dec_spatial_bs_frame_struct = (*pstr_mps_state)
                .bs_frame;
            *c_l_clfe.offset(pb as isize) = (*(*pstr_mps_state)
                .ia_mps_dec_mps_table
                .m1_m2_table_ptr)
                .r1_matrix_l[((*p_cur_bs)
                .ott_cld_idx[0 as core::ffi::c_int as usize][ps as usize][pb as usize]
                + 15 as core::ffi::c_int) as usize];
            *c_r_clfe.offset(pb as isize) = (*(*pstr_mps_state)
                .ia_mps_dec_mps_table
                .m1_m2_table_ptr)
                .r1_matrix_l[(15 as WORD32
                - (*p_cur_bs)
                    .ott_cld_idx[0 as core::ffi::c_int
                    as usize][ps as usize][pb as usize]) as usize];
            pb += 1;
        }
        pb = (*p_aux_struct).num_ott_bands[0 as core::ffi::c_int as usize];
        while pb < num_parameter_bands {
            *c_l_clfe.offset(pb as isize) = ONE_IN_Q15 as WORD32;
            *c_r_clfe.offset(pb as isize) = 0 as core::ffi::c_int as WORD32;
            pb += 1;
        }
        pb = 0 as core::ffi::c_int as WORD32;
        while pb < num_parameter_bands {
            ...
            let fresh0 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh0 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_lc.offset(pb as isize),
                *h12_l.offset(pb as isize),
            );
            if enable_additionals != 0 {
                let fresh1 = idx;
                idx = idx + 1;
                pos[0 as core::ffi::c_int as usize] = fresh1;
            }
            let fresh2 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh2 as usize][ps as usize][pb as usize] = *h12_lc
                .offset(pb as isize);
            let fresh3 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh3 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_lc.offset(pb as isize),
                *h12_l.offset(pb as isize),
            );
            if enable_additionals != 0 {
                let fresh4 = idx;
                idx = idx + 1;
                pos[1 as core::ffi::c_int as usize] = fresh4;
            }
            let fresh5 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh5 as usize][ps as usize][pb as usize] = *h22_lc
                .offset(pb as isize);
            let fresh6 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh6 as usize][ps as usize][pb as usize] = *h22_l
                .offset(pb as isize);
            let fresh7 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh7 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_rc.offset(pb as isize),
                *h12_r.offset(pb as isize),
            );
            if enable_additionals != 0 {
                let fresh8 = idx;
                idx = idx + 1;
                pos[2 as core::ffi::c_int as usize] = fresh8;
            }
            let fresh9 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh9 as usize][ps as usize][pb as usize] = *h12_rc
                .offset(pb as isize);
            let fresh10 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh10 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_rc.offset(pb as isize),
                *h12_r.offset(pb as isize),
            );
            if enable_additionals != 0 {
                let fresh11 = idx;
                idx = idx + 1;
                pos[3 as core::ffi::c_int as usize] = fresh11;
            }
            let fresh12 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh12 as usize][ps as usize][pb as usize] = *h22_rc
                .offset(pb as isize);
            let fresh13 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh13 as usize][ps as usize][pb as usize] = *h22_r
                .offset(pb as isize);
            if enable_additionals != 0 {
                let fresh14 = idx;
                idx = idx + 1;
                pos[4 as core::ffi::c_int as usize] = fresh14;
            }
            pb += 1;
        }
        pb = 0 as core::ffi::c_int as WORD32;
        while pb < num_parameter_bands {
            idx = 0 as core::ffi::c_int as WORD32;
            (*m2_param).m2_resid_real[idx as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_lc.offset(pb as isize),
                *h11_l.offset(pb as isize),
            );
            let fresh15 = idx;
            idx = idx + 1;
            pos_resid[0 as core::ffi::c_int as usize] = fresh15;
            if residual_coding != 0 {
                let fresh16 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh16 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h11_lc.offset(pb as isize),
                    *h12_res_l.offset(pb as isize),
                );
                let fresh17 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh17 as usize][ps as usize][pb as usize] = *h12_res_lc
                    .offset(pb as isize);
            }
            (*m2_param).m2_resid_real[idx as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_lc.offset(pb as isize),
            ...
            let fresh18 = idx;
            idx = idx + 1;
            pos_resid[1 as core::ffi::c_int as usize] = fresh18;
            if residual_coding != 0 {
                let fresh19 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh19 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h21_lc.offset(pb as isize),
                    *h12_res_l.offset(pb as isize),
                );
                let fresh20 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh20 as usize][ps as usize][pb as usize] = *h22_res_lc
                    .offset(pb as isize);
            }
            let fresh21 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh21 as usize][ps as usize][pb as usize] = *h21_l
                .offset(pb as isize);
            if residual_coding != 0 {
                let fresh22 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh22 as usize][ps as usize][pb as usize] = *h22_res_l
                    .offset(pb as isize);
            }
            (*m2_param).m2_resid_real[idx as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_rc.offset(pb as isize),
                *h11_r.offset(pb as isize),
            );
            let fresh23 = idx;
            idx = idx + 1;
            pos_resid[2 as core::ffi::c_int as usize] = fresh23;
            if residual_coding != 0 {
                let fresh24 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh24 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h11_rc.offset(pb as isize),
                    *h12_res_r.offset(pb as isize),
                );
                let fresh25 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh25 as usize][ps as usize][pb as usize] = *h12_res_rc
                    .offset(pb as isize);
            }
            (*m2_param).m2_resid_real[idx as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_rc.offset(pb as isize),
            ...
            let fresh26 = idx;
            idx = idx + 1;
            pos_resid[3 as core::ffi::c_int as usize] = fresh26;
            if residual_coding != 0 {
                let fresh27 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh27 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h21_rc.offset(pb as isize),
                    *h12_res_r.offset(pb as isize),
                );
                let fresh28 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh28 as usize][ps as usize][pb as usize] = *h22_res_rc
                    .offset(pb as isize);
            }
            let fresh29 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh29 as usize][ps as usize][pb as usize] = *h21_r
                .offset(pb as isize);
            if residual_coding != 0 {
                let fresh30 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh30 as usize][ps as usize][pb as usize] = *h22_res_r
                    .offset(pb as isize);
            }
            (*m2_param).m2_resid_real[idx as usize][ps as usize][pb as usize] = *c_l_clfe
                .offset(pb as isize);
            let fresh31 = idx;
            idx = idx + 1;
            pos_resid[4 as core::ffi::c_int as usize] = fresh31;
            (*m2_param).m2_resid_real[idx as usize][ps as usize][pb as usize] = *c_r_clfe
                .offset(pb as isize);
            pb += 1;
        }
        pb = 0 as core::ffi::c_int as WORD32;
        while pb < num_parameter_bands {
            let mut p_cur_bs_0: *mut ia_mps_dec_spatial_bs_frame_struct = (*pstr_mps_state)
                .bs_frame;
            *kappa.offset(pb as isize) = (*p_aux_struct)
                .ttt_icc[0 as core::ffi::c_int as usize][ps as usize][pb as usize];
            *g_dd.offset(pb as isize) = (*(*pstr_mps_state)
                .ia_mps_dec_mps_table
                .m1_m2_table_ptr)
                .table_kappa[(*p_cur_bs_0)
                .ttt_icc_idx[0 as core::ffi::c_int as usize][ps as usize][pb as usize]
                as usize];
            pb += 1;
        }
        i = 0 as core::ffi::c_int as WORD32;
        while i < 2 as core::ffi::c_int {
                    ...
                    .stop_band
            {
                if (*p_aux_struct)
                    ...
                    && pb >= (*pstr_mps_state).res_bands[5 as core::ffi::c_int as usize]
                {
                    if (*p_aux_struct)
                        .ttt_config[i as usize][0 as core::ffi::c_int as usize]
                        .use_ttt_decorr != 0
                    {
                        temp_1 = ixheaacd_mps_mult32_shr_15(
                            *g_dd.offset(pb as isize),
                            *c_f_l.offset(pb as isize) as WORD32,
                        );
                        (*m2_param)
                            .m2_decor_real[pos[0 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            temp_1,
                            *h11_lc.offset(pb as isize),
                        );
                        temp_1 = ixheaacd_mps_mult32_shr_15(
                        ...
                        (*m2_param)
                            .m2_decor_real[pos[1 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            temp_1,
                            *h21_lc.offset(pb as isize),
                        );
                        ...
                        (*m2_param)
                            .m2_decor_real[pos[2 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            temp_1,
                            *h11_rc.offset(pb as isize),
                        );
                        ...
                        (*m2_param)
                            .m2_decor_real[pos[3 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            temp_1,
                            *h21_rc.offset(pb as isize),
                        );
                        temp_1 = ixheaacd_mps_mult32_shr_15(
                            *g_dd.offset(pb as isize),
                            *c_l_clfe.offset(pb as isize),
                        );
                        temp_2 = MINUS_SQRT_2_Q30 as WORD32;
                        (*m2_param)
                            .m2_decor_real[pos[4 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_30(
                            temp_1,
                            temp_2,
                        );
                        (*pstr_mps_state)
                            .m2_param_present[0 as core::ffi::c_int
                            as usize][5 as core::ffi::c_int as usize] = 1
                            as core::ffi::c_int as WORD32;
                        (*pstr_mps_state)
                        ...
                        (*pstr_mps_state)
                            ...
                            as core::ffi::c_int as WORD32;
                        (*m2_param)
                            .m2_resid_real[pos_resid[0 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            (*m2_param)
                                .m2_resid_real[pos_resid[0 as core::ffi::c_int as usize]
                                as usize][ps as usize][pb as usize],
                            *kappa.offset(pb as isize),
                        );
                        (*m2_param)
                            .m2_resid_real[pos_resid[1 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            (*m2_param)
                                .m2_resid_real[pos_resid[1 as core::ffi::c_int as usize]
                                as usize][ps as usize][pb as usize],
                        ...
                        (*m2_param)
                            .m2_resid_real[pos_resid[2 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            (*m2_param)
                                .m2_resid_real[pos_resid[2 as core::ffi::c_int as usize]
                                as usize][ps as usize][pb as usize],
                        ...
                        (*m2_param)
                            .m2_resid_real[pos_resid[3 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            (*m2_param)
                                .m2_resid_real[pos_resid[3 as core::ffi::c_int as usize]
                                as usize][ps as usize][pb as usize],
                        ...
                        (*m2_param)
                            .m2_resid_real[pos_resid[4 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            (*m2_param)
                                .m2_resid_real[pos_resid[4 as core::ffi::c_int as usize]
                                as usize][ps as usize][pb as usize],
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_calc_m1m2_7272(
    mut pstr_mps_state: *mut ia_heaac_mps_state_struct,
) -> VOID {
    let mut p_aux_struct: *mut ia_mps_dec_auxilary_struct = (*pstr_mps_state).aux_struct;
    let mut m2_param: *mut ia_mps_dec_m2_param_struct = (*p_aux_struct).m2_param;
    ...
    let mut kappa: *mut WORD32 = 0 as *mut WORD32;
    let mut g_dd: *mut WORD32 = 0 as *mut WORD32;
    let mut c_1_L: *mut WORD16 = 0 as *mut WORD16;
    let mut c_1_R: *mut WORD16 = 0 as *mut WORD16;
    let mut c_2_L: *mut WORD16 = 0 as *mut WORD16;
    let mut c_2_R: *mut WORD16 = 0 as *mut WORD16;
    let mut h11_ls: *mut WORD32 = 0 as *mut WORD32;
    let mut h11_rs: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_ls: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_rs: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_ls: *mut WORD32 = 0 as *mut WORD32;
    let mut h21_rs: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_ls: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_rs: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_ls: *mut WORD32 = 0 as *mut WORD32;
    let mut h12_res_rs: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_ls: *mut WORD32 = 0 as *mut WORD32;
    let mut h22_res_rs: *mut WORD32 = 0 as *mut WORD32;
    let mut c_f_ls: *mut WORD16 = 0 as *mut WORD16;
    let mut c_f_rs: *mut WORD16 = 0 as *mut WORD16;
    let mut dummy: *mut WORD16 = 0 as *mut WORD16;
    let mut idx: WORD32 = 0;
    let mut mode_0: WORD32 = (*p_aux_struct)
        .ttt_config[0 as core::ffi::c_int as usize][0 as core::ffi::c_int as usize]
    ...
    let mut enable_additionals: WORD32 = (mode_0 == 0 as core::ffi::c_int
        || mode_1 == 0 as core::ffi::c_int) as core::ffi::c_int;
    let mut pos: [WORD32; 3] = [0 as core::ffi::c_int; 3];
    let mut pos_resid: [WORD32; 3] = [0 as core::ffi::c_int; 3];
    let mut residual_coding: WORD32 = (*pstr_mps_state).residual_coding;
    h11_l = (*pstr_mps_state).mps_scratch_mem_v as *mut WORD32;
    h11_r = h11_l
        .offset(
    ...
    c_1_L = ((*pstr_mps_state).mps_scratch_mem_v as *mut WORD16)
        .offset(
            ((1568 as usize)
                .wrapping_mul(::core::mem::size_of::<WORD16>() as usize)
                .wrapping_add((8 as core::ffi::c_int - 1 as core::ffi::c_int) as usize)
    ...
    while ps < num_parameter_sets {
        ixheaacd_param_2_umx_ps(
            ...
            1 as WORD32,
            ps,
            (*pstr_mps_state).res_bands[1 as core::ffi::c_int as usize],
        );
        ixheaacd_param_2_umx_ps(
            pstr_mps_state,
            h11_r,
            ...
            2 as WORD32,
            ps,
            (*pstr_mps_state).res_bands[2 as core::ffi::c_int as usize],
        );
        ixheaacd_param_2_umx_ps(
            pstr_mps_state,
            h11_ls,
            ...
            3 as WORD32,
            ps,
            (*pstr_mps_state).res_bands[3 as core::ffi::c_int as usize],
        );
        ixheaacd_param_2_umx_ps(
            pstr_mps_state,
            h11_rs,
            ...
            4 as WORD32,
            ps,
            (*pstr_mps_state).res_bands[4 as core::ffi::c_int as usize],
        );
        i = 0 as core::ffi::c_int as WORD32;
        while i < 2 as core::ffi::c_int {
            pb = (*p_aux_struct)
                ...
                while col < (*pstr_mps_state).num_x_channels {
                    ...
                    (*m1_param)
                        ...
                        (*m1_param)
                            .m1_param_real[0 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize],
                        *c_2_L.offset(pb as isize) as WORD32,
                    );
                    (*m1_param)
                        .m1_param_real[7 as core::ffi::c_int
                        as usize][col as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                        (*m1_param)
                            .m1_param_real[1 as core::ffi::c_int
                            as usize][col as usize][ps as usize][pb as usize],
                        *c_2_R.offset(pb as isize) as WORD32,
                    );
                    if m1_param_imag_present != 0 {
                        (*m1_param)
                            .m1_param_imag[6 as core::ffi::c_int
        ...
        while pb < num_parameter_bands {
            ...
            let fresh32 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh32 as usize][ps as usize][pb as usize] = *h12_l
                .offset(pb as isize);
            if enable_additionals != 0 {
                let fresh33 = idx;
                idx = idx + 1;
                pos[0 as core::ffi::c_int as usize] = fresh33;
            }
            let fresh34 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh34 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_ls.offset(pb as isize),
                *h22_l.offset(pb as isize),
            );
            let fresh35 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh35 as usize][ps as usize][pb as usize] = *h12_ls
                .offset(pb as isize);
            let fresh36 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh36 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_ls.offset(pb as isize),
                *h22_l.offset(pb as isize),
            );
            let fresh37 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh37 as usize][ps as usize][pb as usize] = *h22_ls
                .offset(pb as isize);
            let fresh38 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh38 as usize][ps as usize][pb as usize] = *h12_r
                .offset(pb as isize);
            if enable_additionals != 0 {
                let fresh39 = idx;
                idx = idx + 1;
                pos[1 as core::ffi::c_int as usize] = fresh39;
            }
            let fresh40 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh40 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_rs.offset(pb as isize),
                *h22_r.offset(pb as isize),
            );
            let fresh41 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh41 as usize][ps as usize][pb as usize] = *h12_rs
                .offset(pb as isize);
            let fresh42 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh42 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_rs.offset(pb as isize),
                *h22_r.offset(pb as isize),
            );
            let fresh43 = idx;
            idx = idx + 1;
            (*m2_param).m2_decor_real[fresh43 as usize][ps as usize][pb as usize] = *h22_rs
                .offset(pb as isize);
            if enable_additionals != 0 {
                let fresh44 = idx;
                idx = idx + 1;
                pos[2 as core::ffi::c_int as usize] = fresh44;
            }
            pb += 1;
        }
        pb = 0 as core::ffi::c_int as WORD32;
        while pb < num_parameter_bands {
            idx = 0 as core::ffi::c_int as WORD32;
            (*m2_param).m2_resid_real[idx as usize][ps as usize][pb as usize] = *h11_l
                .offset(pb as isize);
            let fresh45 = idx;
            idx = idx + 1;
            pos_resid[0 as core::ffi::c_int as usize] = fresh45;
            if residual_coding != 0 {
                let fresh46 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh46 as usize][ps as usize][pb as usize] = *h12_res_l
                    .offset(pb as isize);
            }
            let fresh47 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh47 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_ls.offset(pb as isize),
                *h21_l.offset(pb as isize),
            );
            if residual_coding != 0 {
                let fresh48 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh48 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h11_ls.offset(pb as isize),
                    *h22_res_l.offset(pb as isize),
                );
                let fresh49 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh49 as usize][ps as usize][pb as usize] = *h12_res_ls
                    .offset(pb as isize);
            }
            let fresh50 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh50 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_ls.offset(pb as isize),
                *h21_l.offset(pb as isize),
            );
            if residual_coding != 0 {
                let fresh51 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh51 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h21_ls.offset(pb as isize),
                    *h22_res_l.offset(pb as isize),
                );
                let fresh52 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh52 as usize][ps as usize][pb as usize] = *h22_res_ls
                    .offset(pb as isize);
            }
            (*m2_param).m2_resid_real[idx as usize][ps as usize][pb as usize] = *h11_r
                .offset(pb as isize);
            let fresh53 = idx;
            idx = idx + 1;
            pos_resid[1 as core::ffi::c_int as usize] = fresh53;
            if residual_coding != 0 {
                let fresh54 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh54 as usize][ps as usize][pb as usize] = *h12_res_r
                    .offset(pb as isize);
            }
            let fresh55 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh55 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h11_rs.offset(pb as isize),
                *h21_r.offset(pb as isize),
            );
            if residual_coding != 0 {
                let fresh56 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh56 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h11_rs.offset(pb as isize),
                    *h22_res_r.offset(pb as isize),
                );
                let fresh57 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh57 as usize][ps as usize][pb as usize] = *h12_res_rs
                    .offset(pb as isize);
            }
            let fresh58 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh58 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                *h21_rs.offset(pb as isize),
                *h21_r.offset(pb as isize),
            );
            if residual_coding != 0 {
                let fresh59 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh59 as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                    *h21_rs.offset(pb as isize),
                    *h22_res_r.offset(pb as isize),
                );
                let fresh60 = idx;
                idx = idx + 1;
                (*m2_param).m2_resid_real[fresh60 as usize][ps as usize][pb as usize] = *h22_res_rs
                    .offset(pb as isize);
            }
            (*m2_param).m2_resid_real[idx as usize][ps as usize][pb as usize] = *c_l_clfe
                .offset(pb as isize);
            let fresh61 = idx;
            idx = idx + 1;
            pos_resid[2 as core::ffi::c_int as usize] = fresh61;
            let fresh62 = idx;
            idx = idx + 1;
            (*m2_param).m2_resid_real[fresh62 as usize][ps as usize][pb as usize] = *c_r_clfe
                .offset(pb as isize);
            pb += 1;
        }
        pb = 0 as core::ffi::c_int as WORD32;
                    ...
                    && pb >= (*pstr_mps_state).res_bands[5 as core::ffi::c_int as usize]
                {
                        ...
                        .use_ttt_decorr != 0
                    {
                        (*m2_param)
                            ...
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            *g_dd.offset(pb as isize),
                            *c_1_L.offset(pb as isize) as WORD32,
                        );
                        (*m2_param)
                            .m2_decor_real[pos[1 as core::ffi::c_int as usize]
                            as usize][ps as usize][pb as usize] = ixheaacd_mps_mult32_shr_15(
                            *g_dd.offset(pb as isize),
                            *c_1_R.offset(pb as isize) as WORD32,
                        );
                        temp_1 = ixheaacd_mps_mult32_shr_15(
                            *g_dd.offset(pb as isize),
                            *c_l_clfe.offset(pb as isize),
