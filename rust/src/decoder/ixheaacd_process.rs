extern "C" {
    ...
    fn ixheaacd_mps_frame_parsing(
        self_0: *mut ia_mps_dec_state_struct,
        independency_flag: WORD32,
        it_bit_buff: *mut ia_bit_buf_struct,
    ) -> IA_ERRORCODE;
    fn ixheaacd_mps_apply(
        self_0: *mut ia_mps_dec_state_struct,
        pointers: *mut *mut *mut FLOAT32,
        out_samples: *mut [FLOAT32; 4096],
    ) -> WORD32;
    fn ixheaacd_core_coder_data(
        id: WORD32,
        usac_data: *mut ia_usac_data_struct,
        elem_idx: WORD32,
        chan_offset: WORD32,
        it_bit_buff: *mut ia_bit_buf_struct,
        nr_core_coder_channels: WORD32,
    ) -> WORD32;
    fn ixheaacd_allocate_sbr_scr(
        sbr_scratch_struct: *mut ia_sbr_scr_struct,
        base_scratch_ptr: *mut core::ffi::c_void,
        output_ptr: *mut core::ffi::c_void,
        total_channels: WORD32,
        p_qshift_arr: *mut WORD8,
        slot_element: UWORD8,
        channel: WORD32,
    ) -> VOID;
}
...
pub const IA_XHEAAC_DEC_EXE_NONFATAL_INSUFFICIENT_INPUT_BYTES: core::ffi::c_int = 0x1804
    as core::ffi::c_int;
pub const ID_USAC_SCE: core::ffi::c_int = 0 as core::ffi::c_int;
pub const ID_USAC_CPE: core::ffi::c_int = 1 as core::ffi::c_int;
pub const ID_USAC_LFE: core::ffi::c_int = 2 as core::ffi::c_int;
pub const ID_USAC_EXT: core::ffi::c_int = 3;
pub const MAX_AUDIO_PREROLLS: core::ffi::c_int = 3 as core::ffi::c_int;
pub const EXT_SBR_DATA: core::ffi::c_int = 13 as core::ffi::c_int;
pub const MAXNRSBRELEMENTS: core::ffi::c_int = 6 as core::ffi::c_int;
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_esbr_process(
    mut usac_data: *mut ia_usac_data_struct,
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut stereo_config_idx: WORD32,
    mut num_channels: WORD16,
    mut audio_object_type: WORD32,
    mut heaac_mps_present: WORD32,
) -> IA_ERRORCODE {
    let mut ch: WORD32 = 0;
    let mut err_code: WORD32 = 0 as WORD32;
    let mut esbr_bit_str: *mut ia_aac_dec_sbr_bitstream_struct = &mut *((*usac_data)
        .esbr_bit_str)
        .as_mut_ptr()
        .offset(0 as core::ffi::c_int as isize) as *mut ia_aac_dec_sbr_bitstream_struct;
    let mut self_0: ia_handle_sbr_dec_inst_struct = (*usac_data).pstr_esbr_dec;
    ...
    ixheaacd_allocate_sbr_scr(
        ...
        (*usac_data).sbr_scratch_mem_base,
    ...
    (*self_0).usac_independency_flag = (*usac_data).usac_independency_flg as FLAG;
    (*self_0).time_sample_buf[0 as core::ffi::c_int as usize] = ((*usac_data)
        .time_sample_vector[0 as core::ffi::c_int as usize])
        .as_mut_ptr();
    (*self_0).time_sample_buf[1 as core::ffi::c_int as usize] = ((*usac_data)
        .time_sample_vector[1 as core::ffi::c_int as usize])
        .as_mut_ptr();
    (*self_0).stereo_config_idx = stereo_config_idx as FLAG;
    (*self_0).sbr_mode = (*usac_data).sbr_mode as FLAG;
    (*self_0).aot_usac_flag = (*usac_data).usac_flag as FLAG;
    (*self_0).esbr_hq = (*usac_data).esbr_hq as FLAG;
    (*self_0).enh_sbr = (*usac_data).enh_sbr as FLAG;
    (*self_0).enh_sbr_ps = (*usac_data).enh_sbr_ps as FLAG;
    (*self_0).ec_flag = (*usac_data).ec_flag as FLAG;
    (*self_0).first_frame = (*usac_data).first_frame as FLAG;
    (*self_0).frame_ok = (*usac_data).frame_ok as FLAG;
    (*self_0).sbr_parse_complete = (*usac_data).sbr_parse_complete as FLAG;
    ch = 0 as core::ffi::c_int as WORD32;
    while ch < num_channels as core::ffi::c_int {
        if ((*(*self_0).pstr_sbr_channel[ch as usize])
            .str_sbr_dec
            .str_synthesis_qmf_bank
            .qmf_filter_state_size as core::ffi::c_int) < QMF_FILTER_STATE_SYN_SIZE
        {
            return IA_FATAL_ERROR as IA_ERRORCODE;
        }
        ch += 1;
    }
    err_code = ixheaacd_applysbr(
        self_0,
        esbr_bit_str,
        0 as *mut WORD16,
        &mut num_channels,
    ...
    (*usac_data).sbr_mode = (*self_0).sbr_mode as WORD32;
    return err_code as IA_ERRORCODE;
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_esbr_parse(
    mut usac_data: *mut ia_usac_data_struct,
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut stereo_config_idx: WORD32,
    mut num_channels: WORD16,
    ...
    (*self_0).time_sample_buf[1 as core::ffi::c_int as usize] = ((*usac_data)
        ...
        .as_mut_ptr();
    (*self_0).stereo_config_idx = stereo_config_idx as FLAG;
    (*(*self_0).pstr_sbr_channel[0 as core::ffi::c_int as usize])
        .str_sbr_dec
        .time_sample_buf = (*self_0).time_sample_buf[0 as core::ffi::c_int as usize];
    (*(*self_0).pstr_sbr_channel[1 as core::ffi::c_int as usize])
        .str_sbr_dec
        .time_sample_buf = (*self_0).time_sample_buf[1 as core::ffi::c_int as usize];
    (*self_0).sbr_mode = (*usac_data).sbr_mode as FLAG;
    (*self_0).aot_usac_flag = (*usac_data).usac_flag as FLAG;
    (*self_0).esbr_hq = (*usac_data).esbr_hq as FLAG;
    (*self_0).enh_sbr = (*usac_data).enh_sbr as FLAG;
    ...
    (*self_0).first_frame = (*usac_data).first_frame as FLAG;
    (*self_0).frame_ok = (*usac_data).frame_ok as FLAG;
    (*self_0).sbr_parse_err_flag = (*usac_data).sbr_parse_err_flag as FLAG;
    ...
    (*usac_data).sbr_mode = (*self_0).sbr_mode as WORD32;
    (*usac_data).sbr_parse_err_flag = (*self_0).sbr_parse_err_flag as WORD32;
    (*usac_data).sbr_parse_complete = (*self_0).sbr_parse_complete as WORD32;
    return err_code as IA_ERRORCODE;
}
unsafe extern "C" fn ixheaacd_sbr_ext_data_read(
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut esbr_bit_str: *mut ia_aac_dec_sbr_bitstream_struct,
) -> VOID {
    let mut count: WORD32 = 0 as WORD32;
    let mut read_bits: WORD32 = 0 as WORD32;
    let mut unaligned_bits: WORD32 = 0 as WORD32;
    let mut cnt_bits_in: WORD32 = 0;
    cnt_bits_in = (*it_bit_buff).cnt_bits;
    count = (*it_bit_buff).cnt_bits >> 3 as core::ffi::c_int;
    if count > 0 as core::ffi::c_int {
        if ((*esbr_bit_str).no_elements as core::ffi::c_int) < MAXNRSBRELEMENTS {
            (*((*esbr_bit_str).str_sbr_ele)
                .as_mut_ptr()
                .offset((*esbr_bit_str).no_elements as isize))
                .extension_type = EXT_SBR_DATA as WORD32;
            (*((*esbr_bit_str).str_sbr_ele)
                .as_mut_ptr()
                .offset((*esbr_bit_str).no_elements as isize))
                .size_payload = count;
            read_bits = count << 3 as core::ffi::c_int;
            unaligned_bits = cnt_bits_in - read_bits;
            if unaligned_bits > 0 as core::ffi::c_int
                && unaligned_bits < 8 as core::ffi::c_int
            {
                count += 1;
                (*((*esbr_bit_str).str_sbr_ele)
                    .as_mut_ptr()
            ...
            (*esbr_bit_str).no_elements = ((*esbr_bit_str).no_elements
                as core::ffi::c_int + 1 as core::ffi::c_int) as WORD16;
        }
    }
}
unsafe extern "C" fn ixheaacd_read_ext_element(
    mut usac_ext_element_default_length: UWORD32,
    mut usac_ext_element_payload_frag: UWORD32,
    mut it_bit_buff: *mut ia_bit_buf_struct,
    mut pstr_usac_dec_config: *mut ia_usac_decoder_config_struct,
    mut elem_idx: WORD32,
    mut frame_ok: *mut WORD32,
) -> WORD32 {
    let mut usac_ext_element_present: UWORD32 = 0;
    let mut usac_ext_element_use_dft_length: UWORD32 = 0;
    let mut pay_load_length: UWORD32 = 0;
    let mut i: WORD32 = 0;
    usac_ext_element_present = ixheaacd_read_bits_buf(it_bit_buff, 1 as WORD) as UWORD32;
    if usac_ext_element_present != 0 {
        usac_ext_element_use_dft_length = ixheaacd_read_bits_buf(it_bit_buff, 1 as WORD)
            as UWORD32;
        if usac_ext_element_use_dft_length != 0 {
            pay_load_length = usac_ext_element_default_length;
        } else {
            pay_load_length = ixheaacd_read_bits_buf(it_bit_buff, 8 as WORD) as UWORD32;
            if pay_load_length == 255 as UWORD32 {
                let mut val_add: WORD32 = 0 as WORD32;
                val_add = ixheaacd_read_bits_buf(it_bit_buff, 16 as WORD);
                pay_load_length = (pay_load_length as core::ffi::c_int
                    + val_add as core::ffi::c_int - 2 as core::ffi::c_int) as UWORD32;
            }
        }
        if ((*it_bit_buff).cnt_bits >> 3 as core::ffi::c_int) < pay_load_length as WORD32
        {
            *frame_ok = 0 as core::ffi::c_int as WORD32;
            longjmp(
                (*(*it_bit_buff).xaac_jmp_buf).as_mut_ptr(),
                IA_XHEAAC_DEC_EXE_NONFATAL_INSUFFICIENT_INPUT_BYTES,
            );
        }
        if pay_load_length > 0 as UWORD32 {
            if usac_ext_element_payload_frag != 0 {
                ixheaacd_read_bits_buf(it_bit_buff, 2 as WORD);
            }
            if (*pstr_usac_dec_config).usac_ext_ele_payload_present[elem_idx as usize]
                != 0
            {
                let mut preroll_counter: WORD32 = (*pstr_usac_dec_config)
                    .preroll_counter;
                let mut payload_buffer_offeset: core::ffi::c_int = 0 as core::ffi::c_int;
                i = 0 as core::ffi::c_int as WORD32;
                while i < preroll_counter {
                ...
                if pay_load_length.wrapping_add(payload_buffer_offeset as UWORD32)
                    > (MAX_AUDIO_PREROLLS * 768 as core::ffi::c_int) as UWORD32
                {
                    return IA_FATAL_ERROR as WORD32;
                }
                i = 0 as core::ffi::c_int as WORD32;
                while i < pay_load_length as WORD32 {
                    (*pstr_usac_dec_config)
                        .usac_ext_gain_payload_buf[(i as core::ffi::c_int
                        + payload_buffer_offeset) as usize] = ixheaacd_read_bits_buf(
                        it_bit_buff,
                        8 as WORD,
                    ) as UWORD8;
                    i += 1;
                ...
                (*pstr_usac_dec_config)
                    .usac_ext_gain_payload_len[preroll_counter as usize] = ((*pstr_usac_dec_config)
                    .usac_ext_gain_payload_len[preroll_counter as usize] as UWORD32)
                    .wrapping_add(pay_load_length) as WORD32 as WORD32;
            } else {
                if (*it_bit_buff).cnt_bits
                    < (pay_load_length << 3 as core::ffi::c_int) as WORD32
                {
                    longjmp(
                        (*(*it_bit_buff).xaac_jmp_buf).as_mut_ptr(),
                        IA_XHEAAC_DEC_EXE_NONFATAL_INSUFFICIENT_INPUT_BYTES,
                ...
                (*it_bit_buff).ptr_read_next = ((*it_bit_buff).ptr_read_next)
                    .offset(pay_load_length as isize);
...
unsafe extern "C" fn ixheaacd_sbr_ele_type_set(
    mut esbr_bit_str0: *mut ia_aac_dec_sbr_bitstream_struct,
    mut esbr_bit_str1: *mut ia_aac_dec_sbr_bitstream_struct,
    mut ele_id: WORD32,
    mut st_config_idx: WORD32,
) -> VOID {
    if ele_id == ID_USAC_SCE {
        (*((*esbr_bit_str0).str_sbr_ele)
            .as_mut_ptr()
            .offset((*esbr_bit_str0).no_elements as isize))
            .sbr_ele_id = SBR_ID_SCE as core::ffi::c_int as WORD32;
        (*((*esbr_bit_str1).str_sbr_ele)
            .as_mut_ptr()
            .offset((*esbr_bit_str1).no_elements as isize))
            .sbr_ele_id = SBR_ID_SCE as core::ffi::c_int as WORD32;
    }
    if ele_id == ID_USAC_CPE {
        if st_config_idx == 0 as core::ffi::c_int
            || st_config_idx == 3 as core::ffi::c_int
        {
            (*((*esbr_bit_str0).str_sbr_ele)
                .as_mut_ptr()
                .offset((*esbr_bit_str0).no_elements as isize))
                .sbr_ele_id = SBR_ID_CPE as core::ffi::c_int as WORD32;
            (*((*esbr_bit_str1).str_sbr_ele)
                .as_mut_ptr()
                .offset((*esbr_bit_str1).no_elements as isize))
                .sbr_ele_id = SBR_ID_CPE as core::ffi::c_int as WORD32;
...
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_ms_processing(
    mut pstr_usac_data: *mut ia_usac_data_struct,
) -> VOID {
    let mut i: WORD32 = 0;
    let mut tmp: FLOAT32 = 0.;
    let mut tmp1: FLOAT32 = 0.;
    let mut ms_factor: FLOAT32 = 0.7071067812f64 as FLOAT32;
    i = 0 as core::ffi::c_int as WORD32;
    while i < (*pstr_usac_data).ccfl {
        tmp = ((*pstr_usac_data)
            .time_sample_vector[0 as core::ffi::c_int as usize][i as usize]
            + (*pstr_usac_data)
                .time_sample_vector[1 as core::ffi::c_int as usize][i as usize])
            * ms_factor;
        tmp1 = ((*pstr_usac_data)
            .time_sample_vector[0 as core::ffi::c_int as usize][i as usize]
            - (*pstr_usac_data)
            ...
            * ms_factor;
        (*pstr_usac_data)
            .time_sample_vector[1 as core::ffi::c_int as usize][i as usize] = tmp1;
        (*pstr_usac_data)
            .time_sample_vector[0 as core::ffi::c_int as usize][i as usize] = tmp;
        i += 1;
    }
}
#[no_mangle]
pub unsafe extern "C" fn ixheaacd_usac_process(
    mut pstr_dec_data: *mut ia_dec_data_struct,
    mut num_out_channels: *mut WORD32,
    mut codec_handle: *mut core::ffi::c_void,
) -> WORD32 {
    let mut current_block: u64;
    let mut ele_id: WORD32 = 0 as WORD32;
    let mut err_code: WORD32 = 0 as WORD32;
    let mut p_state_aac_dec: *mut ia_aac_dec_state_struct = codec_handle
        as *mut ia_aac_dec_state_struct;
    let mut pstr_usac_data: *mut ia_usac_data_struct = &mut (*pstr_dec_data)
        .str_usac_data;
    let mut it_bit_buff: *mut ia_bit_buf_struct = &mut (*pstr_dec_data).dec_bit_buf;
    let mut fd: *mut ia_frame_data_struct = &mut (*pstr_dec_data).str_frame_data;
    let mut pstr_usac_config: *mut ia_usac_config_struct = &mut (*fd)
        .str_audio_specific_config
        .str_usac_config;
    let mut pstr_usac_dec_config: *mut ia_usac_decoder_config_struct = &mut (*fd)
        .str_audio_specific_config
        .str_usac_config
        .str_usac_dec_config;
    let mut err: WORD32 = 0 as WORD32;
    let mut nr_core_coder_channels: WORD16 = 0 as WORD16;
    let mut ch_offset: WORD32 = 0 as WORD32;
    let mut elem_idx: WORD32 = 0 as WORD32;
    let mut num_ch_out: WORD32 = 0 as WORD32;
    let mut num_elements: WORD32 = (*pstr_usac_dec_config).num_elements as WORD32;
    let mut ec_flag: UWORD32 = (*(*p_state_aac_dec).p_config).ui_err_conceal as UWORD32;
    if ec_flag != 0 {
        ...
        if (*pstr_dec_data).str_usac_data.frame_ok == 1 as core::ffi::c_int {
            (*pstr_usac_data).usac_independency_flg = ixheaacd_read_bits_buf(
                it_bit_buff,
                1 as WORD,
            );
        }
    ...
    if (*pstr_usac_data).ec_flag != 0
        && (*pstr_dec_data).str_usac_data.frame_ok == 1 as core::ffi::c_int
    {
        if (*pstr_usac_data).last_frame_ok == 0
            && (*pstr_usac_data).usac_independency_flg == 0
        {
            (*pstr_dec_data).str_usac_data.frame_ok = 0 as core::ffi::c_int as WORD32;
        } else {
    ...
    while elem_idx < num_elements {
        let mut stereo_config_index: WORD32 = (*pstr_usac_config)
            .str_usac_dec_config
            .str_usac_element_config[elem_idx as usize]
            .stereo_config_index as WORD32;
        let mut local: jmp_buf = [__jmp_buf_tag {
            __jmpbuf: [0; 8],
            __mask_was_saved: 0,
            __saved_mask: __sigset_t { __val: [0; 16] },
        ...
        (*pstr_usac_data).esbr_bit_str[0 as core::ffi::c_int as usize].no_elements = 0
            as WORD16;
        (*pstr_usac_data).esbr_bit_str[1 as core::ffi::c_int as usize].no_elements = 0
            as WORD16;
        if err == 0 {
            if ec_flag != 0 {
                (*it_bit_buff).xaac_jmp_buf = &mut local;
            }
            ele_id = (*pstr_usac_dec_config).usac_element_type[elem_idx as usize]
                as WORD32;
            match ele_id {
                ID_USAC_SCE => {
                    nr_core_coder_channels = 1 as WORD16;
                    num_ch_out += 1 as core::ffi::c_int;
                    current_block = 14360635869757541538;
                }
                ID_USAC_CPE => {
                    nr_core_coder_channels = (if stereo_config_index
                        == 1 as core::ffi::c_int
                    {
                        1 as core::ffi::c_int
                    } else {
                    ...
                    if (stereo_config_index > 1 as core::ffi::c_int
                        || stereo_config_index == 0 as core::ffi::c_int)
                        && (*p_state_aac_dec).num_of_output_ch < 2 as core::ffi::c_int
                    {
                        return -(1 as WORD32);
                    }
                    num_ch_out += 2 as core::ffi::c_int;
                    current_block = 14360635869757541538;
                }
                ID_USAC_LFE => {
                    nr_core_coder_channels = 1 as WORD16;
                ...
                ID_USAC_EXT => {
                    let mut pusac_element_config: *mut ia_usac_dec_element_config_struct = &mut *((*pstr_usac_dec_config)
                        .str_usac_element_config)
                        .as_mut_ptr()
                        .offset(elem_idx as isize)
                        as *mut ia_usac_dec_element_config_struct;
                    if (*pstr_usac_data).frame_ok != 0 {
                        err = ixheaacd_read_ext_element(
                            (*pusac_element_config).usac_ext_eleme_def_len as UWORD32,
                            (*pusac_element_config).usac_ext_elem_pld_frag as UWORD32,
                            it_bit_buff,
                            pstr_usac_dec_config,
                            elem_idx,
                            &mut (*pstr_usac_data).frame_ok,
                        );
                        if ec_flag == 0 {
                            ...
                            (*pstr_usac_data).frame_ok = 0 as core::ffi::c_int as WORD32;
                        }
                    }
            ...
            match current_block {
                ...
                _ => {
                    if ec_flag == 0 {
                        ...
                        if num_ch_out > MAX_NUM_CHANNELS_USAC_LVL2 {
                            return -(1 as WORD32);
                        }
                    } else if ch_offset >= MAX_NUM_CHANNELS_USAC_LVL2
                        || num_ch_out > MAX_NUM_CHANNELS_USAC_LVL2
                    {
                        (*pstr_usac_data).frame_ok = 0 as core::ffi::c_int as WORD32;
                    }
                    err = ixheaacd_core_coder_data(
                        ele_id,
                        pstr_usac_data,
                        elem_idx,
                        ch_offset,
                        it_bit_buff,
                        nr_core_coder_channels as WORD32,
                    );
                    if ec_flag == 0 {
                        if err != 0 as core::ffi::c_int {
                            return -(1 as WORD32);
                    ...
                    ixheaacd_sbr_ele_type_set(
                        &mut *((*pstr_usac_data).esbr_bit_str)
                            .as_mut_ptr()
                            .offset(0 as core::ffi::c_int as isize),
                        &mut *((*pstr_usac_data).esbr_bit_str)
                            .as_mut_ptr()
                    ...
                    if (*pstr_usac_data).mps_pseudo_lr[elem_idx as usize] != 0 {
                        ixheaacd_ms_processing(pstr_usac_data);
                    }
                    if ele_id != ID_USAC_LFE {
                        if (*pstr_usac_data).sbr_ratio_idx > 0 as core::ffi::c_int {
                            ixheaacd_sbr_ext_data_read(
                                it_bit_buff,
                                &mut *((*pstr_usac_data).esbr_bit_str)
                                    .as_mut_ptr()
                                    .offset(0 as core::ffi::c_int as isize),
                    ...
                    if (*pstr_usac_data).sbr_ratio_idx > 0 as core::ffi::c_int
                        && (*pstr_usac_data)
                            .esbr_bit_str[0 as core::ffi::c_int as usize]
                            .no_elements as core::ffi::c_int != 0 as core::ffi::c_int
                    {
                        if ec_flag != 0 {
                            (*pstr_usac_data).first_frame = (*p_state_aac_dec)
                                .first_frame;
                        }
                        ...
                        } else if err_code < 0 as core::ffi::c_int {
                            (*pstr_usac_data).frame_ok = 0 as core::ffi::c_int as WORD32;
                        }
                    }
                    if stereo_config_index > 0 as core::ffi::c_int
                        && (*pstr_usac_data).sbr_ratio_idx > 0 as core::ffi::c_int
                    {
                        let mut ptr_inp: [*mut *mut FLOAT32; 4] = [0
                            as *mut *mut FLOAT32; 4];
                        let mut ch: WORD32 = 0;
                        *num_out_channels = (*p_state_aac_dec)
                            .mps_dec_handle
                            .out_ch_count;
                        if ec_flag == 0
                            && (*pstr_usac_data).frame_ok == 1 as core::ffi::c_int
                        {
                            ...
                            err = ixheaacd_mps_frame_parsing(
                                &mut (*p_state_aac_dec).mps_dec_handle,
                        ...
                        (*p_state_aac_dec)
                            .mps_dec_handle
                            .band_count[0 as core::ffi::c_int as usize] = (*(*(*pstr_usac_data)
                            .pstr_esbr_dec)
                        ...
                        (*p_state_aac_dec)
                            .mps_dec_handle
                            .band_count[1 as core::ffi::c_int as usize] = (*(*(*pstr_usac_data)
                            .pstr_esbr_dec)
                            .pstr_sbr_channel[1 as core::ffi::c_int as usize])
                            .str_sbr_dec
                            .band_count;
                        ch = 0 as core::ffi::c_int as WORD32;
                        while ch < nr_core_coder_channels as core::ffi::c_int {
                            ptr_inp[(2 as WORD32 * ch) as usize] = (*(*(*pstr_usac_data)
                                .pstr_esbr_dec)
                                .pstr_sbr_channel[ch as usize])
                                .str_sbr_dec
                                .pp_qmf_buf_real;
                            ptr_inp[(2 as core::ffi::c_int * ch as core::ffi::c_int
                                + 1 as core::ffi::c_int) as usize] = (*(*(*pstr_usac_data)
                                .pstr_esbr_dec)
                                .pstr_sbr_channel[ch as usize])
                                .str_sbr_dec
                                .pp_qmf_buf_imag;
                            (*p_state_aac_dec).mps_dec_handle.p_sbr_dec[ch as usize] = &mut (**((*(*pstr_usac_data)
                                .pstr_esbr_dec)
                                .pstr_sbr_channel)
                                .as_mut_ptr()
                                .offset(ch as isize))
                            ...
                            (*p_state_aac_dec)
                                .mps_dec_handle
                                .p_sbr_header[ch as usize] = (*(*pstr_usac_data)
                                .pstr_esbr_dec)
                                .pstr_sbr_header[ch as usize] as *mut core::ffi::c_void;
                            (*p_state_aac_dec).mps_dec_handle.p_sbr_frame[ch as usize] = (*(*pstr_usac_data)
                                .pstr_esbr_dec)
                                .frame_buffer[ch as usize];
                            ch += 1;
                        }
                        if nr_core_coder_channels as core::ffi::c_int
                            == 1 as core::ffi::c_int
                        {
                            if (*p_state_aac_dec).mps_dec_handle.res_ch_count
                                != 0 as core::ffi::c_int
                            {
                                ptr_inp[2 as core::ffi::c_int as usize] = (*(*(*pstr_usac_data)
                                    .pstr_esbr_dec)
                                    .pstr_sbr_channel[1 as core::ffi::c_int as usize])
                                    .str_sbr_dec
                                    .pp_qmf_buf_real;
                                ptr_inp[(2 as core::ffi::c_int + 1 as core::ffi::c_int)
                                    as usize] = (*(*(*pstr_usac_data).pstr_esbr_dec)
                                    .pstr_sbr_channel[1 as core::ffi::c_int as usize])
                                    .str_sbr_dec
                                    .pp_qmf_buf_imag;
                            }
                            (*p_state_aac_dec)
                                .mps_dec_handle
                                .p_sbr_dec[1 as core::ffi::c_int as usize] = &mut (**((*(*pstr_usac_data)
                                .pstr_esbr_dec)
                                .pstr_sbr_channel)
                                .as_mut_ptr()
                                .offset(1 as core::ffi::c_int as isize))
                            ...
                            (*p_state_aac_dec)
                                .mps_dec_handle
                                .p_sbr_header[1 as core::ffi::c_int as usize] = (*(*pstr_usac_data)
                                .pstr_esbr_dec)
                                .pstr_sbr_header[1 as core::ffi::c_int as usize]
                                as *mut core::ffi::c_void;
                            (*p_state_aac_dec)
                                .mps_dec_handle
                                .p_sbr_frame[1 as core::ffi::c_int as usize] = (*(*pstr_usac_data)
                                .pstr_esbr_dec)
                                .frame_buffer[1 as core::ffi::c_int as usize];
                        }
                        if (ec_flag == 0 || (*p_state_aac_dec).first_frame == 0)
                            && (*p_state_aac_dec).mps_dec_handle.mps_init_done
                                == 1 as core::ffi::c_int
                        {
                            err = ixheaacd_mps_apply(
                                &mut (*p_state_aac_dec).mps_dec_handle,
                                ptr_inp.as_mut_ptr(),
                                ((*pstr_usac_data).time_sample_vector).as_mut_ptr()
                                    as *mut [FLOAT32; 4096],
                            );
                            if ec_flag == 0 {
                                if err != 0 {
                                ...
                                (*pstr_usac_data).frame_ok = 0 as core::ffi::c_int
                                    as WORD32;
                            }
                        }
                        if ec_flag != 0 {
                                ...
                                && (*pstr_usac_data).frame_ok == 1 as core::ffi::c_int
                            {
                                ...
                                (*pstr_usac_data).frame_ok = 0 as core::ffi::c_int
                                    as WORD32;
                                if (*p_state_aac_dec).mps_dec_handle.num_parameter_sets_prev
                                    < 1 as core::ffi::c_int
                                {
                    ...
                    } else if (*pstr_usac_data).sbr_ratio_idx > 0 as core::ffi::c_int
                        && (*pstr_usac_data)
                            .esbr_bit_str[0 as core::ffi::c_int as usize]
                            .no_elements as core::ffi::c_int != 0 as core::ffi::c_int
                        && ec_flag != 0
                    ...
                    if ec_flag != 0 {
                        (*p_state_aac_dec).first_frame = 0 as core::ffi::c_int as WORD32;
                    }
                    ch_offset += nr_core_coder_channels as core::ffi::c_int;
                }
            }
        }
        elem_idx += 1;
